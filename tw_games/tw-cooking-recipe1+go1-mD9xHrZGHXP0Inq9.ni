...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can make out an oven. Wow, isn't TextWorld just the best?[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Wow, isn't TextWorld just the best?[end if]".
...
The printed name of f_1 is "chicken breast".
Understand "chicken breast" as f_1.
Understand "chicken" as f_1.
Understand "breast" as f_1.
The f_1 is cookable.
...
Test quest3_0 with "inventory / examine cookbook / drop chicken breast / prepare meal"
...
Test quest4_0 with "inventory / examine cookbook / drop chicken breast / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest3 completed is true and quest4 completed is true:
