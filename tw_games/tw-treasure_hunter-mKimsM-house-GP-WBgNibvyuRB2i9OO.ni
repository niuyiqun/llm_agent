...
The office part 0 is some text that varies. The office part 0 is "Guess what, you are in the place we're calling the office. I guess you better just go and list everything you see here.
...
Test quest0_0 with "go east / go south / go west / go west / take paper towel"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Here is how to play! First step, make an attempt to take a trip east. And then, make an effort to move south. After that, try to head west. With that d".
The objective part 1 is some text that varies. The objective part 1 is "one, make an attempt to travel west. And then, pick up the paper towel from the floor of the laundromat. That's it!".
