...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An usual one. I guess you better just go and list everything you see here.
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You make out a counter. The counter is standard.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Look out! It's a- oh, never mind, it's just a stove. The stove is standard.[if there is something on the s_2] On the stove you can see [a list of things on the s_2].[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 You can see a chest drawer. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]![end if]".
...
The bedroom part 4 is some text that varies. The bedroom part 4 is " You can make out a king-size bed. [if there is something on the s_0]On the king-size bed you can see [a list of things on the s_0]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You are in a backyard. A normal kind of place. I guess you better just go and list everything you see here.
...
The backyard part 2 is some text that varies. The backyard part 2 is " You scan the room for a bbq, and you find a bbq. [if there is something on the s_8]You see [a list of things on the s_8] on the bbq.[end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8]But the thing is empty. Hm. Oh well[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You are in a living room. A standard one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.

 You smell an awful smell, and follow it to a couch. You wonder idly who left that here. The couch is ordinary.[if there is something on the s_5] On the couch you see [a list of things on the s_5].[end if]".
The living room part 1 is some text that varies. The living room part 1 is "[if there is nothing on the s_5] But the thing is empty. You move on, clearly infuriated by TextWorld.[end if]".
The living room part 2 is some text that varies. The living room part 2 is " If you haven't noticed it already, there seems to be something there by the wall, it's a low table. [if there is something on the s_6]You see [a list of things on the s_6] on the low table. It doesn't get more TextWorld than this![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You have come into the most ordinary of all possible bathrooms. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. Hmmm... what else, what else?[end if]".
...
The bathroom part 6 is some text that varies. The bathroom part 6 is " Oh wow! Is that what I think it is? It is! It's a sink. You shudder, but continue examining the sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. There's something strange about this being here, but you can't put your finger on it.[end if]".
The bathroom part 7 is some text that varies. The bathroom part 7 is "[if there is nothing on the s_4]However, the sink, like an empty sink, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You make a grand eccentric entrance into a garden. The room is well lit.
...
The f_4 is in r_5.
The f_4 is edible.
The description of f_5 is "The half of a bag of chips looks appetizing.".
...
The description of f_2 is "that's a normal lettuce!".
