...
The kitchen part 1 is some text that varies. The kitchen part 1 is " refrigerator, which looks ordinary, here.[if c_2 is open and there is something in the c_2] The refrigerator contains [a list of things in the c_2]. Make a note of this, you might have to put stuff on or in it later on.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But there isn't a thing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. The stove is ordinary.[if there is something on the s_2] On the stove you see [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] But oh no! there's nothing on this piece of junk. Oh! Why couldn't there just be stuff on it?[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You see a kitchen island. The kitchen island is standard.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3].[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3] The kitchen island appears to be empty. You move on, clearly depressed by TextWorld.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is " You can make out a king-size bed. The king-size bed is standard.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. A standard kind of place.
 ...
 Were you looking for a set of chairs? Because look over there, it's a set of chairs. You shudder, but continue examining the set of chairs. The set of chairs is ordinary.[if there is something on the s_10] On the set of chairs you make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can make out a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8]. It doesn't get more TextWorld than this![end if]".
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But there isn't a thing on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A standard one. You start to take note of what's in the room.
 ...
 You see a couch. [if there is something on the s_5]You see [a list of things on the s_5] on the couch. Now that's what I call TextWorld![end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Hey, want to see a low table? Look over there, a low table. Now why would someone leave that there? The low table is usual.[if there is something on the s_6] On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 5 is some text that varies. The living room part 5 is "[if there is nothing on the s_7] However, the tv, like an empty tv, has nothing on it. You make a mental note to not get your hopes up the next time you see a tv in a room.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can make out a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a gleam over in a corner, where you can see a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink. Now that's what I call TextWorld![end if]".
