...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You smell a sickening smell, and follow it to a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is "[if there is nothing on the s_1]But oh no! there's nothing on this piece of garbage. You move on, clearly done caring about your TextWorld experience.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is " Look out! It's a- oh, never mind, it's just a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is "[if there is nothing on the s_2] Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can make out a kitchen island. Now why would someone leave that there? The kitchen island is typical.[if there is something on the s_3] On the kitchen island you see [a list of things on the s_3].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " You can see a king-size bed. [if there is something on the s_0]On the king-size bed you see [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]However, the king-size bed, like an empty king-size bed, has nothing on it. It would have been so cool if there was stuff on the king-size bed! oh well.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary one.
 ...
 You can make out a set of chairs. [if there is something on the s_10]On the set of chairs you can see [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You make out a bbq. The bbq is typical.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8]. Classic TextWorld.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You arrive in a living room. A typical one. You begin to take stock of what's in the room.
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. [if there is something on the s_6]On the low table you make out [a list of things on the s_6].[end if]".
...
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. The tv is standard.[if there is something on the s_7] On the tv you can see [a list of things on the s_7].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " You can see a sink. The sink is usual.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4] But the thing is empty. This always happens![end if]".
...
The c_4 is in r_3.
The c_4 is closed.
The description of f_3 is "The apple looks tasty.".
