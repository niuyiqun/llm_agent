...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You smell an awful smell, and follow it to a counter. You shudder, but continue examining the counter. [if there is something on the s_1]On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You see a stove. You shudder, but continue examining the stove. The stove is usual.[if there is something on the s_2] On the stove you make out [a list of things on the s_2].[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You find yourself in a backyard. An ordinary kind of place. You begin to take stock of what's here.
...
The backyard part 2 is some text that varies. The backyard part 2 is " You can see a bbq. The bbq is normal.[if there is something on the s_8] On the bbq you make out [a list of things on the s_8].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A typical kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 You see a gleam over in a corner, where you can see a couch. [if there is something on the s_5]On the couch you make out [a list of things on the s_5]. You can't wait to tell the folks at home about this![end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " Look out! It's a- oh, never mind, it's just a low table. The low table is usual.[if there is something on the s_6] On the low table you make out [a list of things on the s_6]. Classic TextWorld.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Well how about that, you are in the place we're calling the bathroom.
 ...
 You can see a toilet. Classic TextWorld.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3].[end if]".
...
The bathroom part 2 is some text that varies. The bathroom part 2 is " You see a gleam over in a corner, where you can see a bath. You look at the price tag glued to the bath. Ninety big ones?! Where'd they buy this bath, some kind of expensive store?[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 4 is some text that varies. The bathroom part 4 is " What's that over there? It looks like it's a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4].[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_4]However, the sink, like an empty sink, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
