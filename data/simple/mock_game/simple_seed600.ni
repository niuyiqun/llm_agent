...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You make out a stove. The stove is ordinary.[if there is something on the s_2] On the stove you make out [a list of things on the s_2]. You can't wait to tell the folks at home about this![end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " If you haven't noticed it already, there seems to be something there by the wall, it's a kitchen island. [if there is something on the s_3]You see [a list of things on the s_3] on the kitchen island.[end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of trash. It would have been so cool if there was stuff on the kitchen island! oh well.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " wooden door leading west. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unblocked.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom. You try to gain information on your surroundings by using a technique you call 'looking.'
 ...
 Oh wow! Is that what I think it is? It is! It's a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. Now that's what I call TextWorld![end if]".
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " usual looking antique trunk here.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " What's that over there? It looks like it's a king-size bed. The king-size bed is normal.[if there is something on the s_0] On the king-size bed you see [a list of things on the s_0].[end if]".
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0] But the thing is empty. What's the point of an empty king-size bed?[end if]".
...
The backyard part 3 is some text that varies. The backyard part 3 is "[if there is nothing on the s_8] But the thing is empty, unfortunately. You move on, clearly infuriated by TextWorld.[end if]".
The backyard part 4 is some text that varies. The backyard part 4 is " You make out a patio table. The patio table is standard.[if there is something on the s_9] On the patio table you can make out [a list of things on the s_9]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in a living room. You try to gain information on your surroundings by using a technique you call 'looking.'

 You can see a couch. The couch is ordinary.[if there is something on the s_5] On the couch you make out [a list of things on the s_5]. You shudder, but continue examining the room.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You can make out a low table. The low table is standard.[if there is something on the s_6] On the low table you can see [a list of things on the s_6]. You can't wait to tell the folks at home about this![end if]".
The living room part 3 is some text that varies. The living room part 3 is "[if there is nothing on the s_6] But oh no! there's nothing on this piece of trash. It would have been so cool if there was stuff on the low table.[end if]".
The living room part 4 is some text that varies. The living room part 4 is " You make out a tv. You wonder idly who left that here. The tv is normal.[if there is something on the s_7] On the tv you can make out [a list of things on the s_7]. You can't wait to tell the folks at home about this![end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You rest your hand against a wall, but you miss the wall and fall onto a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4].[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You scan the room for a sink, and you find a sink. [if there is something on the s_4]You see [a list of things on the s_4] on the sink.[end if]".
The bathroom part 6 is some text that varies. The bathroom part 6 is "[if there is nothing on the s_4]However, the sink, like an empty sink, has nothing on it. Hm. Oh well[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You have stumbled into the most normal of all possible gardens. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The description of f_1 is "The half of a bag of chips looks delectable.".
