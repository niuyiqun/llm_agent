...
The kitchen part 2 is some text that varies. The kitchen part 2 is " What's that over there? It looks like it's a counter. Now why would someone leave that there? [if there is something on the s_1]You see [a list of things on the s_1] on the counter.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh, great. Here's a stove. Why don't you take a picture of it, it'll last longer! The stove is standard.[if there is something on the s_2] On the stove you see [a list of things on the s_2]. Huh, weird.[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_3] But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A typical kind of place.
 ...
 You see a chest drawer.[if c_0 is open and there is something in the c_0] The chest drawer contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bedroom part 6 is some text that varies. The bedroom part 6 is "[if there is nothing on the s_0]But oh no! there's nothing on this piece of junk. It would have been so cool if there was stuff on the king-size bed.[end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You arrive in a backyard. A normal kind of place.
 ...
 You can make out a set of chairs. I guess it's true what they say, if you're looking for a set of chairs, go to TextWorld. [if there is something on the s_10]On the set of chairs you see [a list of things on the s_10].[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " Oh, great. Here's a patio table. [if there is something on the s_9]On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You find yourself in a living room. A normal one.
 ...
 What's that over there? It looks like it's a couch. The couch is typical.[if there is something on the s_5] On the couch you can see [a list of things on the s_5].[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You hear a noise behind you and spin around, but you can't see anything other than a low table. The low table is typical.[if there is something on the s_6] On the low table you can make out [a list of things on the s_6]. Hmmm... what else, what else?[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet, which looks typical, right there by you.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Is this it? Is this what you came to TextWorld to see? a toilet?[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You bend down to tie your shoe. When you stand up, you notice a sink. The sink is typical.[if there is something on the s_4] On the sink you can see [a list of things on the s_4].[end if]".
...
The s_9 is in r_4.
The description of f_0 is "The apple looks appealing.".
