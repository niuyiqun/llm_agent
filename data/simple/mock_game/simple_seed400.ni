...
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if there is nothing on the s_1]But the thing is empty. It would have been so cool if there was stuff on the counter.[end if]".
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh wow! Is that what I think it is? It is! It's a stove. [if there is something on the s_2]You see [a list of things on the s_2] on the stove. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_2]Looks like someone's already been here and taken everything off it, though. This always happens![end if]".
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can see a kitchen island. The kitchen island is typical.[if there is something on the s_3] On the kitchen island you can make out [a list of things on the s_3]. Hmmm... what else, what else?[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "Fancy seeing you here. Here, by the way, being the bedroom. You begin to take stock of what's in the room.
...
The bedroom part 3 is some text that varies. The bedroom part 3 is " standard looking antique trunk here.[if c_1 is open and there is something in the c_1] The antique trunk contains [a list of things in the c_1].[end if]".
...
The bedroom part 5 is some text that varies. The bedroom part 5 is " Oh wow! Is that what I think it is? It is! It's a king-size bed. The king-size bed is typical.[if there is something on the s_0] On the king-size bed you can make out [a list of things on the s_0]. You can't wait to tell the folks at home about this![end if]".
...
The backyard part 0 is some text that varies. The backyard part 0 is "You've entered a backyard. You decide to just list off a complete list of everything you see in the room, because hey, why not?
 ...
 You bend down to tie your shoe. When you stand up, you notice a set of chairs. [if there is something on the s_10]On the set of chairs you can make out [a list of things on the s_10].[end if]".
...
The backyard part 2 is some text that varies. The backyard part 2 is " You see a bbq. The bbq is ordinary.[if there is something on the s_8] On the bbq you can make out [a list of things on the s_8]. You shudder, but continue examining the room.[end if]".
...
The backyard part 4 is some text that varies. The backyard part 4 is " You can make out a patio table. [if there is something on the s_9]On the patio table you see [a list of things on the s_9].[end if]".
...
The living room part 0 is some text that varies. The living room part 0 is "You're now in the living room. You begin to take stock of what's here.

 You see a couch. [if there is something on the s_5]On the couch you see [a list of things on the s_5]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The living room part 2 is some text that varies. The living room part 2 is " You see a low table. What a coincidence, weren't you just thinking about a low table? [if there is something on the s_6]On the low table you can see [a list of things on the s_6].[end if]".
...
The bathroom part 1 is some text that varies. The bathroom part 1 is " toilet here.[if c_3 is open and there is something in the c_3] The toilet contains [a list of things in the c_3]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " You can see a bath.[if c_4 is open and there is something in the c_4] The bath contains [a list of things in the c_4]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The bathroom part 5 is some text that varies. The bathroom part 5 is " You see a sink. [if there is something on the s_4]On the sink you see [a list of things on the s_4]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The garden part 0 is some text that varies. The garden part 0 is "You arrive in a garden. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
