...
The r_1 and the r_2 and the r_10 and the r_17 and the r_12 and the r_11 and the r_13 and the r_14 and the r_15 and the r_16 and the r_3 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_18 and the r_19 and the r_4 and the r_7 are rooms.
...
The laundromat part 1 is some text that varies. The laundromat part 1 is " drawer.[if c_0 is open and there is something in the c_0] The drawer contains [a list of things in the c_0]. Is this it? Is this what you came to TextWorld to see? a drawer?[end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is "[if c_0 is open and the c_0 contains nothing] The drawer is empty! This is the worst thing that could possibly happen, ever![end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is " You rest your hand against a wall, but you miss the wall and fall onto a trunk. You wonder idly who left that here.[if c_1 is open and there is something in the c_1] The trunk contains [a list of things in the c_1].[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is "[if c_1 is open and the c_1 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
...
The cellar part 0 is some text that varies. The cellar part 0 is "This might come as a shock to you, but you've just walked into a cellar. I guess you better just go and list everything you see here.

 You see [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The cellar part 1 is some text that varies. The cellar part 1 is " cabinet.[if c_2 is open and there is something in the c_2] The cabinet contains [a list of things in the c_2].[end if]".
...
The cellar part 3 is some text that varies. The cellar part 3 is " You see a shelf. [if there is something on the s_0]You see [a list of things on the s_0] on the shelf.[end if]".
The cellar part 4 is some text that varies. The cellar part 4 is "[if there is nothing on the s_0]But there isn't a thing on it.[end if]".
The cellar part 5 is some text that varies. The cellar part 5 is " You can see a counter. The counter is normal.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
The cellar part 6 is some text that varies. The cellar part 6 is "[if there is nothing on the s_1] But there isn't a thing on it. Hm. Oh well[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. Let's see what's in here.

 What's that over there? It looks like it's an armchair. The armchair is usual.[if there is something on the s_2] On the armchair you can see [a list of things on the s_2].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_2] The armchair appears to be empty.[end if]".
...
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if there is nothing on the s_3]But there isn't a thing on it. Hm. Oh well[end if]".
...
The canteen part 1 is some text that varies. The canteen part 1 is " case.[if c_3 is open and there is something in the c_3] The case contains [a list of things in the c_3].[end if]".
The canteen part 2 is some text that varies. The canteen part 2 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The case is empty![end if]".
...
The attic part 0 is some text that varies. The attic part 0 is "You are in an attic. An ordinary kind of place. You can barely contain your excitement.
 ...
 You scan the room for a workbench, and you find a workbench. [if there is something on the s_4]You see [a list of things on the s_4] on the workbench.[end if]".
The attic part 1 is some text that varies. The attic part 1 is "[if there is nothing on the s_4]The workbench appears to be empty.[end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a chamber.
 ...
 You see a couch. The couch is ordinary.[if there is something on the s_5] On the couch you can see [a list of things on the s_5].[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is "[if there is nothing on the s_5] The couch appears to be empty. Aw, here you were, all excited for there to be things on it![end if]".
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Okay, so you're in a steam room, cool, but is it standard? You better believe it is.

 You see a box. Now why would someone leave that there?[if c_4 is open and there is something in the c_4] The box contains [a list of things in the c_4]. Now why would someone leave that there?[end if]".
The steam room part 1 is some text that varies. The steam room part 1 is "[if c_4 is open and the c_4 contains nothing] What a letdown! The box is empty![end if]".
The steam room part 2 is some text that varies. The steam room part 2 is " You can see [if c_5 is locked]a locked[else if c_5 is open]an opened[otherwise]a closed[end if]".
The steam room part 3 is some text that varies. The steam room part 3 is " basket.[if c_5 is open and there is something in the c_5] The basket contains [a list of things in the c_5].[end if]".
The steam room part 4 is some text that varies. The steam room part 4 is "[if c_5 is open and the c_5 contains nothing] The basket is empty! What a waste of a day![end if]".
...
The description of r_16 is "[steam room part 0][steam room part 1][steam room part 2][steam room part 3][steam room part 4][steam room part 5]".
...
The scullery part 1 is some text that varies. The scullery part 1 is " fridge.[if c_6 is open and there is something in the c_6] The fridge contains [a list of things in the c_6].[end if]".
The scullery part 2 is some text that varies. The scullery part 2 is "[if c_6 is open and the c_6 contains nothing] The fridge is empty! What a waste of a day![end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You are in a shower. An ordinary one.
 ...
 Look over there! a bench. [if there is something on the s_6]On the bench you can make out [a list of things on the s_6].[end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if there is nothing on the s_6]The bench appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "Fancy seeing you here. Here, by the way, being the workshop. You begin to take stock of what's here.

 You see a safe.[if c_7 is open and there is something in the c_7] The safe contains [a list of things in the c_7]. You can't really describe the safe besides that it's ordinary.[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_7 is open and the c_7 contains nothing] What a letdown! The safe is empty![end if]".
The workshop part 2 is some text that varies. The workshop part 2 is "

There is an unguarded exit to the east. There is an unguarded exit to the north. There is an unblocked exit to the south. There is an unguarded exit to the west.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "I am excited to announce that you are now in the sauna.

 You make out a mahoganywood dresser.[if c_8 is open and there is something in the c_8] The mahoganywood dresser contains [a list of things in the c_8].[end if]".
The sauna part 1 is some text that varies. The sauna part 1 is "[if c_8 is open and the c_8 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. A standard kind of place. You start to take note of what's in the room.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom.
 ...
 Look over there! a recliner. What a coincidence, weren't you just thinking about a recliner? The recliner is typical.[if there is something on the s_7] On the recliner you make out [a list of things on the s_7].[end if]".
...
The launderette part 1 is some text that varies. The launderette part 1 is " plain safe.[if c_9 is open and there is something in the c_9] The plain safe contains [a list of things in the c_9]. The light flickers for a second, but nothing else happens.[end if]".
The launderette part 2 is some text that varies. The launderette part 2 is "[if c_9 is open and the c_9 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The launderette part 3 is some text that varies. The launderette part 3 is " You see a board. [if there is something on the s_8]You see [a list of things on the s_8] on the board.[end if]".
The launderette part 4 is some text that varies. The launderette part 4 is "[if there is nothing on the s_8]But the thing is empty, unfortunately. Hm. Oh well[end if]".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You've entered a restroom.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a dresser.[if c_10 is open and there is something in the c_10] The dresser contains [a list of things in the c_10]. You check the price tag that's still affixed to the dresser. A hundred dollars?! That's ridiculous! You ever meet my good friend, they work for the post office? I'm sure my friend could get you one of those for 95 bucks![end if]".
The restroom part 1 is some text that varies. The restroom part 1 is "[if c_10 is open and the c_10 contains nothing] The dresser is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The r_1 and the r_2 and the r_10 and the r_17 and the r_12 and the r_11 and the r_13 and the r_14 and the r_15 and the r_16 and the r_3 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_18 and the r_19 and the r_4 and the r_7 are rooms.
The r_1 and the r_2 and the r_10 and the r_17 and the r_12 and the r_11 and the r_13 and the r_14 and the r_15 and the r_16 and the r_3 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_18 and the r_19 and the r_4 and the r_7 are privately-named.
...
The c_7 is in r_9.
The c_7 is locked.
The description of c_8 is "The mahoganywood dresser looks strong, and impossible to break. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_8 is "mahoganywood dresser".
Understand "mahoganywood dresser" as c_8.
Understand "mahoganywood" as c_8.
Understand "dresser" as c_8.
The c_8 is in r_8.
The c_8 is open.
The description of c_9 is "The plain safe looks strong, and impossible to destroy. [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
The printed name of c_9 is "plain safe".
Understand "plain safe" as c_9.
Understand "plain" as c_9.
Understand "safe" as c_9.
The c_9 is in r_19.
The c_9 is closed.
The description of o_0 is "The dvd would seem to be to fit in here".
...
The s_7 is in r_18.
The description of s_8 is "The board is reliable.".
...
Test quest0_0 with "go north / go east / go south / go south / go east / go north / go north / go east / go east / go north / go north / go west / go south / take dvd"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to attempt to head north. After that, travel east. ".
The objective part 1 is some text that varies. The objective part 1 is "Next, venture south. And then, travel south. Once you manage that, move east. That done, travel north. Then, attempt to move north. With that done, go east. Then, attempt to go to the east. With that ".
The objective part 2 is some text that varies. The objective part 2 is "done, make an effort to venture north. After that, make an attempt to move north. And then, attempt to head west. After that, go south. And then, pick-up the dvd from the floor of the bedchamber. And ".
