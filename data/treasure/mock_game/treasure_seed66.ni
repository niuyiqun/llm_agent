...
The r_11 and the r_10 and the r_12 and the r_13 and the r_5 and the r_14 and the r_9 and the r_16 and the r_0 and the r_17 and the r_18 and the r_19 and the r_3 and the r_2 and the r_4 and the r_1 and the r_6 and the r_7 and the r_8 and the r_15 are rooms.
...
The vault part 0 is some text that varies. The vault part 0 is "You've just walked into a vault. The room is well lit.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a rack. The rack is usual.[if there is something on the s_0] On the rack you see [a list of things on the s_0].[end if]".
The vault part 1 is some text that varies. The vault part 1 is "[if there is nothing on the s_0] Unfortunately, there isn't a thing on it. You swear loudly.[end if]".
...
The office part 0 is some text that varies. The office part 0 is "You are in an office. A typical kind of place.
 ...
 You can see a stand. [if there is something on the s_1]You see [a list of things on the s_1] on the stand.[end if]".
...
The office part 2 is some text that varies. The office part 2 is " You see a shelf. The shelf is usual.[if there is something on the s_2] On the shelf you see [a list of things on the s_2].[end if]".
The office part 3 is some text that varies. The office part 3 is "[if there is nothing on the s_2] Looks like someone's already been here and taken everything off it, though. You move on, clearly upset by your TextWorld experience.[end if]".
...
The kitchenette part 1 is some text that varies. The kitchenette part 1 is " freezer.[if c_0 is open and there is something in the c_0] The freezer contains [a list of things in the c_0], so there's that.[end if]".
The kitchenette part 2 is some text that varies. The kitchenette part 2 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The freezer is empty![end if]".
The kitchenette part 3 is some text that varies. The kitchenette part 3 is "

You don't like doors? Why not try going east, that entranceway is unblocked. There is an exit to the north. Don't worry, it is unblocked. You need an unguarded exit? You should try going south. You don't like doors? Why not try going west, that entranceway is unguarded.".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. An ordinary kind of place.

 You can see [if c_1 is locked]a locked[else if c_1 is open]an opened[otherwise]a closed[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is " usual looking drawer in the corner.[if c_1 is open and there is something in the c_1] The drawer contains [a list of things in the c_1].[end if]".
...
The laundromat part 3 is some text that varies. The laundromat part 3 is " You see a board. [if there is something on the s_3]You see [a list of things on the s_3] on the board.[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is "[if there is nothing on the s_3]The board appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "I am sorry to announce that you are now in the chamber.
 ...
 What's that over there? It looks like it's a mantle. [if there is something on the s_4]On the mantle you can make out [a list of things on the s_4]. Hmmm... what else, what else?[end if]".
The chamber part 1 is some text that varies. The chamber part 1 is "[if there is nothing on the s_4]But oh no! there's nothing on this piece of garbage.[end if]".
...
The studio part 1 is some text that varies. The studio part 1 is " safe, which looks normal, close by.[if c_2 is open and there is something in the c_2] The safe contains [a list of things in the c_2].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_2 is open and the c_2 contains nothing] What a letdown! The safe is empty![end if]".
The studio part 3 is some text that varies. The studio part 3 is "

There is an exit to the east. Don't worry, it is unblocked. There is an unguarded exit to the north. You need an unblocked exit? You should try going south. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The r_4 is mapped north of r_16.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You arrive in a steam room. A typical kind of place.
 ...
 You see a counter. [if there is something on the s_5]You see [a list of things on the s_5] on the counter.[end if]".
The steam room part 1 is some text that varies. The steam room part 1 is "[if there is nothing on the s_5]Unfortunately, there isn't a thing on it.[end if]".
...
The canteen part 1 is some text that varies. The canteen part 1 is " usual looking cabinet is in the room.[if c_3 is open and there is something in the c_3] The cabinet contains [a list of things in the c_3].[end if]".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "This is going to sound unbelievable, but you've just entered a cubicle.
 ...
 You scan the room, seeing an armchair. The armchair is usual.[if there is something on the s_6] On the armchair you make out [a list of things on the s_6].[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is "[if there is nothing on the s_6] But the thing is empty, unfortunately. Oh! Why couldn't there just be stuff on it?[end if]".
...
There is an unblocked exit to the east. You don't like doors? Why not try going north, that entranceway is unguarded. You need an unguarded exit? You should try going south. You need an unguarded exit? You should try going west.".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You've just shown up in a cellar. You begin to take stock of what's here.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. An ordinary one.
 ...
 You can see a pan. [if there is something on the s_7]On the pan you can see [a list of things on the s_7].[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is "[if there is nothing on the s_7]Looks like someone's already been here and taken everything off it, though.[end if]".
The kitchen part 2 is some text that varies. The kitchen part 2 is "

You don't like doors? Why not try going east, that entranceway is unblocked. There is an exit to the north. Don't worry, it is unblocked. There is an unblocked exit to the south. You need an unguarded exit? You should try going west.".
The description of r_4 is "[kitchen part 0][kitchen part 1][kitchen part 2]".

The r_1 is mapped west of r_4.
The r_16 is mapped south of r_4.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You've just shown up in a laundry place. Let's see what's in here.

 You smell a pungent smell, and follow it to a table. The table is normal.[if there is something on the s_8] On the table you can make out [a list of things on the s_8].[end if]".
The laundry place part 1 is some text that varies. The laundry place part 1 is "[if there is nothing on the s_8] Unfortunately, there isn't a thing on it.[end if]".
The laundry place part 2 is some text that varies. The laundry place part 2 is "

You need an unguarded exit? You should try going east. You don't like doors? Why not try going north, that entranceway is unblocked. There is an exit to the south. Don't worry, it is unguarded.".
...
The parlor part 1 is some text that varies. The parlor part 1 is "[if c_4 is open and the c_4 contains nothing] The box is empty, what a horrible day![end if]".
The parlor part 2 is some text that varies. The parlor part 2 is " You see a bookshelf. The bookshelf is usual.[if there is something on the s_9] On the bookshelf you can see [a list of things on the s_9].[end if]".
The parlor part 3 is some text that varies. The parlor part 3 is "[if there is nothing on the s_9] But the thing hasn't got anything on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The study part 1 is some text that varies. The study part 1 is " coffer.[if c_5 is open and there is something in the c_5] The coffer contains [a list of things in the c_5].[end if]".
...
The study part 3 is some text that varies. The study part 3 is " [if c_6 is locked]A locked[else if c_6 is open]An open[otherwise]A closed[end if]".
The study part 4 is some text that varies. The study part 4 is " display is nearby.[if c_6 is open and there is something in the c_6] The display contains [a list of things in the c_6].[end if]".
The study part 5 is some text that varies. The study part 5 is "[if c_6 is open and the c_6 contains nothing] The display is empty, what a horrible day![end if]".
...
The launderette part 0 is some text that varies. The launderette part 0 is "You've just sauntered into a launderette. I guess you better just go and list everything you see here.
 ...
 Look over there! a basket.[if c_7 is open and there is something in the c_7] The basket contains [a list of things in the c_7]. Hmmm... what else, what else?[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if c_7 is open and the c_7 contains nothing] The basket is empty! This is the worst thing that could possibly happen, ever![end if]".
The launderette part 2 is some text that varies. The launderette part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bench. [if there is something on the s_10]On the bench you can see [a list of things on the s_10].[end if]".
The launderette part 3 is some text that varies. The launderette part 3 is "[if there is nothing on the s_10]But the thing hasn't got anything on it.[end if]".
...
The description of r_8 is "[launderette part 0][launderette part 1][launderette part 2][launderette part 3][launderette part 4]".
...
The bar part 0 is some text that varies. The bar part 0 is "You have come into a bar. Not the bar you'd expect. No, this is a bar.
 ...
 You make out a bed. [if there is something on the s_11]On the bed you can see [a list of things on the s_11].[end if]".
The bar part 1 is some text that varies. The bar part 1 is "[if there is nothing on the s_11]But the thing is empty, unfortunately.[end if]".
...
The r_11 and the r_10 and the r_12 and the r_13 and the r_5 and the r_14 and the r_9 and the r_16 and the r_0 and the r_17 and the r_18 and the r_19 and the r_3 and the r_2 and the r_4 and the r_1 and the r_6 and the r_7 and the r_8 and the r_15 are rooms.
The r_11 and the r_10 and the r_12 and the r_13 and the r_5 and the r_14 and the r_9 and the r_16 and the r_0 and the r_17 and the r_18 and the r_19 and the r_3 and the r_2 and the r_4 and the r_1 and the r_6 and the r_7 and the r_8 and the r_15 are privately-named.
...
The s_1 is in r_10.
The description of s_10 is "The bench is undependable.".
The printed name of s_10 is "bench".
Understand "bench" as s_10.
The s_10 is in r_8.
The description of s_11 is "The bed is balanced.".
...
The s_6 is in r_19.
The description of s_7 is "The pan is solidly built.".
...
Test quest0_0 with "go north / go west / go north / go east / go east / go east / go north / go east / go north / go west / go west / go west / go south / take passkey"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First, it would be good if you could venture north. And then, go wes".
The objective part 1 is some text that varies. The objective part 1 is "t. Then, go to the north. Following that, try to take a trip east. And then, go to the east. And then, head east. Okay, and then, make an attempt to head north. After that, try to venture east. After ".
The objective part 2 is some text that varies. The objective part 2 is "that, venture north. Then, try to take a trip west. After that, head west. With that accomplished, try to take a trip west. With that accomplished, venture south. Okay, and then, recover the passkey f".
The objective part 3 is some text that varies. The objective part 3 is "rom the floor of the garage. Got that? Good!".
