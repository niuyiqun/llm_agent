...
The r_1 and the r_0 and the r_10 and the r_4 and the r_11 and the r_3 and the r_12 and the r_13 and the r_14 and the r_2 and the r_15 and the r_16 and the r_9 and the r_6 and the r_7 and the r_8 and the r_18 and the r_17 and the r_19 and the r_5 are rooms.
...
The dish-pit part 2 is some text that varies. The dish-pit part 2 is " You make out a platter. [if there is something on the s_0]On the platter you can make out [a list of things on the s_0].[end if]".
The dish-pit part 3 is some text that varies. The dish-pit part 3 is "[if there is nothing on the s_0]Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
The dish-pit part 4 is some text that varies. The dish-pit part 4 is "

There is an exit to the east. Don't worry, it is unguarded. You don't like doors? Why not try going north, that entranceway is unblocked. You need an unblocked exit? You should try going west.".
...
The restroom part 0 is some text that varies. The restroom part 0 is "You arrive in a standard kind of place. That is to say, you're in a restroom. You start to take note of what's in the room.

 Were you looking for a basket? Because look over there, it's a basket.[if c_1 is open and there is something in the c_1] The basket contains [a list of things in the c_1].[end if]".
The restroom part 1 is some text that varies. The restroom part 1 is "[if c_1 is open and the c_1 contains nothing] The basket is empty! What a waste of a day![end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. It seems to be pretty ordinary here.
 ...
 Look over there! a rack. [if there is something on the s_1]On the rack you make out [a list of things on the s_1].[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_1]But the thing is empty, unfortunately.[end if]".
...
The shower part 1 is some text that varies. The shower part 1 is "[if there is nothing on the s_2]Unfortunately, there isn't a thing on it.[end if]".
The shower part 2 is some text that varies. The shower part 2 is "

There is an exit to the east. Don't worry, it is unblocked. There is an exit to the north. Don't worry, it is unguarded. There is an exit to the south. Don't worry, it is unguarded. There is an exit to the west. Don't worry, it is unblocked.".
...
The sauna part 0 is some text that varies. The sauna part 0 is "This sauna you have just entered is definitely usual. You can barely contain your excitement.
...
You don't like doors? Why not try going east, that entranceway is unguarded. You don't like doors? Why not try going north, that entranceway is unguarded. There is an unblocked exit to the south. There is an unblocked exit to the west.".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. An usual kind of place.
 ...
 You can see a refrigerator.[if c_3 is open and there is something in the c_3] The refrigerator contains [a list of things in the c_3]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if c_3 is open and the c_3 contains nothing] The refrigerator is empty! What a waste of a day![end if]".
...
There is an exit to the east. Don't worry, it is unguarded. You need an unguarded exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unblocked. There is an unblocked exit to the west.".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is " coffer close by.[if c_4 is open and there is something in the c_4] The coffer contains [a list of things in the c_4].[end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_4 is open and the c_4 contains nothing] The coffer is empty, what a horrible day![end if]".
The cubicle part 3 is some text that varies. The cubicle part 3 is " You can see a stand. The stand is typical.[if there is something on the s_3] On the stand you can see [a list of things on the s_3].[end if]".
The cubicle part 4 is some text that varies. The cubicle part 4 is "[if there is nothing on the s_3] But the thing is empty, unfortunately.[end if]".
...
There is an exit to the east. Don't worry, it is unblocked. There is an unblocked exit to the north. There is an unguarded exit to the south. There is an unblocked exit to the west.".
...
The lounge part 1 is some text that varies. The lounge part 1 is " safe.[if c_5 is open and there is something in the c_5] The safe contains [a list of things in the c_5].[end if]".
...
The description of r_6 is "[lounge part 0][lounge part 1][lounge part 2][lounge part 3]".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've stumbled into a standard room. Your mind races to think of what kind of room would be standard. And then it hits you. Of course. You're in the laundromat.

 You bend down to tie your shoe. When you stand up, you notice a bench. [if there is something on the s_4]On the bench you can see [a list of things on the s_4]. Huh, weird.[end if]".
...
The playroom part 1 is some text that varies. The playroom part 1 is " normal looking portmanteau is close by.[if c_6 is open and there is something in the c_6] The portmanteau contains [a list of things in the c_6].[end if]".
The playroom part 2 is some text that varies. The playroom part 2 is "[if c_6 is open and the c_6 contains nothing] The portmanteau is empty, what a horrible day![end if]".
The playroom part 3 is some text that varies. The playroom part 3 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bar. [if there is something on the s_5]On the bar you can make out [a list of things on the s_5].[end if]".
The playroom part 4 is some text that varies. The playroom part 4 is "[if there is nothing on the s_5]But there isn't a thing on it.[end if]".
The playroom part 5 is some text that varies. The playroom part 5 is " You can make out a desk. The desk is ordinary.[if there is something on the s_6] On the desk you make out [a list of things on the s_6].[end if]".
The playroom part 6 is some text that varies. The playroom part 6 is "[if there is nothing on the s_6] But the thing hasn't got anything on it. You think about smashing the desk to bits, throwing the bits into the garbage, etc, until you get bored.[end if]".
...
The study part 1 is some text that varies. The study part 1 is " display.[if c_7 is open and there is something in the c_7] The display contains [a list of things in the c_7].[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_7 is open and the c_7 contains nothing] What a letdown! The display is empty![end if]".
The study part 3 is some text that varies. The study part 3 is " You scan the room, seeing a chair. The chair is standard.[if there is something on the s_7] On the chair you see [a list of things on the s_7].[end if]".
The study part 4 is some text that varies. The study part 4 is "[if there is nothing on the s_7] But oh no! there's nothing on this piece of trash. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You're now in a bathroom.
 ...
 You can make out a drawer.[if c_8 is open and there is something in the c_8] The drawer contains [a list of things in the c_8].[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if c_8 is open and the c_8 contains nothing] The drawer is empty! What a waste of a day![end if]".
The bathroom part 2 is some text that varies. The bathroom part 2 is " Oh wow! Is that what I think it is? It is! It's a counter. Wow, isn't TextWorld just the best? [if there is something on the s_8]On the counter you make out [a list of things on the s_8].[end if]".
The bathroom part 3 is some text that varies. The bathroom part 3 is "[if there is nothing on the s_8]Looks like someone's already been here and taken everything off it, though.[end if]".
The bathroom part 4 is some text that varies. The bathroom part 4 is " You see a board. [if there is something on the s_9]You see [a list of things on the s_9] on the board.[end if]".
The bathroom part 5 is some text that varies. The bathroom part 5 is "[if there is nothing on the s_9]Unfortunately, there isn't a thing on it.[end if]".
...
The description of r_19 is "[bathroom part 0][bathroom part 1][bathroom part 2][bathroom part 3][bathroom part 4][bathroom part 5][bathroom part 6]".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've entered a kitchen.
 ...
 You see a freezer.[if c_9 is open and there is something in the c_9] The freezer contains [a list of things in the c_9].[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is "[if c_9 is open and the c_9 contains nothing] The freezer is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The r_1 and the r_0 and the r_10 and the r_4 and the r_11 and the r_3 and the r_12 and the r_13 and the r_14 and the r_2 and the r_15 and the r_16 and the r_9 and the r_6 and the r_7 and the r_8 and the r_18 and the r_17 and the r_19 and the r_5 are rooms.
The r_1 and the r_0 and the r_10 and the r_4 and the r_11 and the r_3 and the r_12 and the r_13 and the r_14 and the r_2 and the r_15 and the r_16 and the r_9 and the r_6 and the r_7 and the r_8 and the r_18 and the r_17 and the r_19 and the r_5 are privately-named.
...
The c_8 is in r_19.
The c_8 is open.
The description of c_9 is "The freezer looks strong, and impossible to destroy. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
Test quest0_0 with "go south / go west / go west / go west / go west / go north / go north / go north / go east / go south / go south / go east / go north / take durian"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting round of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to head south. Next, move west. If you can get around to doing that,".
The objective part 1 is some text that varies. The objective part 1 is " make an attempt to head west. Then, go to the west. And then, try to go west. Following that, make an effort to venture north. Once you get around to doing that, venture north. And then, make an atte".
The objective part 2 is some text that varies. The objective part 2 is "mpt to head north. Then, make an effort to take a trip east. If you can succeed at that, go to the south. And then, try to go south. After that, try to go to the east. And then, move north. Okay, and ".
The objective part 3 is some text that varies. The objective part 3 is "then, lift the durian from the floor of the shower. That's it!".
