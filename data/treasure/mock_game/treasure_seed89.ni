...
The study part 1 is some text that varies. The study part 1 is " typical looking toolbox in the room.[if c_0 is open and there is something in the c_0] The toolbox contains [a list of things in the c_0].[end if]".
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Ah, the cubicle. This is some kind of cubicle, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it. You start to take note of what's in the room.

 As if things weren't amazing enough already, you can even see a table. The table is typical.[if there is something on the s_0] On the table you can make out [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
...
The cubicle part 3 is some text that varies. The cubicle part 3 is " portal leading north. There is an exit to the east. Don't worry, it is unguarded. You need an unguarded exit? You should try going south.".
...
The studio part 0 is some text that varies. The studio part 0 is "You have stumbled into the most standard of all possible studios.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. A normal one. You begin to take stock of what's in the room.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "Well, here we are in the dish-pit. Okay, just remember what you're here to do, and everything will go great.

 You can see a cabinet. Wow, check out the price tag that hangs off the cabinet! Three hundred dollars![if c_1 is open and there is something in the c_1] The cabinet contains [a list of things in the c_1].[end if]".
...
The dish-pit part 2 is some text that varies. The dish-pit part 2 is " You can make out a saucepan. [if there is something on the s_1]You see [a list of things on the s_1] on the saucepan.[end if]".
...
The bar part 0 is some text that varies. The bar part 0 is "You make another one of your grand eccentric entrances into a bar.
 ...
 You scan the room for a mantle, and you find a mantle. The mantle is normal.[if there is something on the s_2] On the mantle you can see [a list of things on the s_2].[end if]".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well, here we are in the kitchen.
 ...
 You can make out a freezer.[if c_2 is open and there is something in the c_2] The freezer contains [a list of things in the c_2]. Classic TextWorld.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can see a case.[if c_3 is open and there is something in the c_3] The case contains [a list of things in the c_3]. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The kitchen part 3 is some text that varies. The kitchen part 3 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The case is empty![end if]".
...
The salon part 0 is some text that varies. The salon part 0 is "You're now in a salon. The room is well lit.

 You make out [if c_4 is locked]a locked[else if c_4 is open]an opened[otherwise]a closed[end if]".
The salon part 1 is some text that varies. The salon part 1 is " basket.[if c_4 is open and there is something in the c_4] The basket contains [a list of things in the c_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The salon part 2 is some text that varies. The salon part 2 is "[if c_4 is open and the c_4 contains nothing] What a letdown! The basket is empty![end if]".
The salon part 3 is some text that varies. The salon part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The salon part 4 is some text that varies. The salon part 4 is " hatch leading west. You don't like doors? Why not try going east, that entranceway is unguarded.".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. A standard one.
 ...
 You smell a pungent smell, and follow it to a portmanteau.[if c_5 is open and there is something in the c_5] The portmanteau contains [a list of things in the c_5]. Hmmm... what else, what else?[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_5 is open and the c_5 contains nothing] The portmanteau is empty, what a horrible day![end if]".
The workshop part 2 is some text that varies. The workshop part 2 is " You rest your hand against a wall, but you miss the wall and fall onto a stand. [if there is something on the s_3]On the stand you make out [a list of things on the s_3].[end if]".
The workshop part 3 is some text that varies. The workshop part 3 is "[if there is nothing on the s_3]But oh no! there's nothing on this piece of garbage.[end if]".
The workshop part 4 is some text that varies. The workshop part 4 is " You make out a chair. The chair is standard.[if there is something on the s_4] On the chair you can make out [a list of things on the s_4]. Wow! Just like in the movies![end if]".
...
The workshop part 6 is some text that varies. The workshop part 6 is "
 ...
 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The workshop part 7 is some text that varies. The workshop part 7 is " hatch leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
The workshop part 8 is some text that varies. The workshop part 8 is " portal leading south.".
...
The basement part 1 is some text that varies. The basement part 1 is " safe.[if c_6 is open and there is something in the c_6] The safe contains [a list of things in the c_6].[end if]".
The basement part 2 is some text that varies. The basement part 2 is "[if c_6 is open and the c_6 contains nothing] The safe is empty! What a waste of a day![end if]".
The basement part 3 is some text that varies. The basement part 3 is " You can see a workbench. [if there is something on the s_5]You see [a list of things on the s_5] on the workbench. You can't wait to tell the folks at home about this![end if]".
The basement part 4 is some text that varies. The basement part 4 is "[if there is nothing on the s_5]However, the workbench, like an empty workbench, has nothing on it. What's the point of an empty workbench?[end if]".
The basement part 5 is some text that varies. The basement part 5 is "

There is an unguarded exit to the west.".
The description of r_19 is "[basement part 0][basement part 1][basement part 2][basement part 3][basement part 4][basement part 5]".
...
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if c_7 is open and the c_7 contains nothing] What a letdown! The chest is empty![end if]".
The recreation zone part 2 is some text that varies. The recreation zone part 2 is " You can see a desk. [if there is something on the s_6]You see [a list of things on the s_6] on the desk.[end if]".
The recreation zone part 3 is some text that varies. The recreation zone part 3 is "[if there is nothing on the s_6]Unfortunately, there isn't a thing on it.[end if]".
...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. An usual kind of place.

 You can see [if c_8 is locked]a locked[else if c_8 is open]an opened[otherwise]a closed[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is " drawer in the corner.[if c_8 is open and there is something in the c_8] The drawer contains [a list of things in the c_8].[end if]".
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical kind of place.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a locker. Hmmm... what else, what else?[if c_9 is open and there is something in the c_9] The locker contains [a list of things in the c_9].[end if]".
The office part 1 is some text that varies. The office part 1 is "[if c_9 is open and the c_9 contains nothing] The locker is empty! What a waste of a day![end if]".
The office part 2 is some text that varies. The office part 2 is " You can make out a shelf. [if there is something on the s_7]On the shelf you see [a list of things on the s_7].[end if]".
The office part 3 is some text that varies. The office part 3 is "[if there is nothing on the s_7]But there isn't a thing on it. You swear loudly.[end if]".
...
The canteen part 1 is some text that varies. The canteen part 1 is " refrigerator.[if c_10 is open and there is something in the c_10] The refrigerator contains [a list of things in the c_10].[end if]".
The canteen part 2 is some text that varies. The canteen part 2 is "[if c_10 is open and the c_10 contains nothing] The refrigerator is empty, what a horrible day![end if]".
...
The still cubicle part 0 is some text that varies. The still cubicle part 0 is "If you're wondering why everything seems so still all of a sudden, it's because you've just walked into the still cubicle. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The austere cubicle part 0 is some text that varies. The austere cubicle part 0 is "You are in a cubicle. An austere kind of place. You can barely contain your excitement.

 You make out a bookshelf. The bookshelf is usual.[if there is something on the s_8] On the bookshelf you see [a list of things on the s_8].[end if]".
The austere cubicle part 1 is some text that varies. The austere cubicle part 1 is "[if there is nothing on the s_8] Unfortunately, there isn't a thing on it.[end if]".
...
The description of d_1 is "it's a manageable portal [if open]It is open.[else if closed]It is closed.[otherwise]It is locked.[end if]".
...
The c_8 is in r_3.
The c_8 is closed.
The description of c_9 is "The locker looks strong, and impossible to break. [if open]You can see inside it.[else if closed]You can't see inside it because the lid's in your way.[otherwise]There is a lock on it.[end if]".
...
The f_0 is in r_8.
The description of o_0 is "The printer seems well matched to everything else here".
...
The s_5 is in r_19.
The description of s_6 is "The desk is unstable.".
...
The s_7 is in r_5.
The description of s_8 is "The bookshelf is shaky.".
...
Test quest0_0 with "go west / go north / go east / go north / go north / go east / go east / go east / go south / go west / go south / go east / go south / take printer"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First off, try to go to the west. If you can succeed at that, go to the nort".
The objective part 1 is some text that varies. The objective part 1 is "h. With that over with, try to go to the east. If you can do that, move north. If you can succeed at that, make an effort to travel north. And then, make an effort to take a trip east. And then, trave".
The objective part 2 is some text that varies. The objective part 2 is "l east. And then, try to travel east. After that, make an attempt to travel south. With that accomplished, make an attempt to travel west. Okay, and then, make an attempt to go south. And then, try to".
The objective part 3 is some text that varies. The objective part 3 is " travel east. And then, attempt to travel south. With that over with, retrieve the printer from the floor of the still cubicle. And if you do that, you're the winner!".
