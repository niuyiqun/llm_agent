...
The r_0 and the r_6 and the r_1 and the r_14 and the r_13 and the r_15 and the r_12 and the r_16 and the r_11 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_10 and the r_18 and the r_19 are rooms.
...
The steam room part 1 is some text that varies. The steam room part 1 is "[if there is nothing on the s_0]The table appears to be empty.[end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You make another one of your grand eccentric entrances into a studio. You begin to take stock of what's here.

 You can see a case. Make a note of this, you might have to put stuff on or in it later on.[if c_0 is open and there is something in the c_0] The case contains [a list of things in the c_0].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if c_0 is open and the c_0 contains nothing] What a letdown! The case is empty![end if]".
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You've just sauntered into a dish-pit. You decide to just list off a complete list of everything you see in the room, because hey, why not?

 Look over there! a freezer. You shudder, but continue examining the room.[if c_1 is open and there is something in the c_1] The freezer contains [a list of things in the c_1].[end if]".
The dish-pit part 1 is some text that varies. The dish-pit part 1 is "[if c_1 is open and the c_1 contains nothing] The freezer is empty! What a waste of a day![end if]".
...
The kitchenette part 1 is some text that varies. The kitchenette part 1 is " cabinet close by.[if c_2 is open and there is something in the c_2] The cabinet contains [a list of things in the c_2].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. A standard kind of place.
 ...
 You scan the room for a stand, and you find a stand. The stand is typical.[if there is something on the s_1] On the stand you can see [a list of things on the s_1].[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is "[if there is nothing on the s_1] But oh no! there's nothing on this piece of trash.[end if]".
...
The canteen part 1 is some text that varies. The canteen part 1 is "[if there is nothing on the s_2]But there isn't a thing on it.[end if]".
The canteen part 2 is some text that varies. The canteen part 2 is "

There is an unguarded exit to the east. You don't like doors? Why not try going north, that entranceway is unblocked. You need an unblocked exit? You should try going south.".
...
The office part 1 is some text that varies. The office part 1 is " coffer is right there by you.[if c_3 is open and there is something in the c_3] The coffer contains [a list of things in the c_3].[end if]".
The office part 2 is some text that varies. The office part 2 is "[if c_3 is open and the c_3 contains nothing] What a letdown! The coffer is empty![end if]".
The office part 3 is some text that varies. The office part 3 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The office part 4 is some text that varies. The office part 4 is " door leading east. You need an unblocked exit? You should try going north. You need an unguarded exit? You should try going south. There is an exit to the west. Don't worry, it is unblocked.".
...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in an usual kind of place. That is to say, you're in a cellar. Okay, just remember what you're here to do, and everything will go great.

 As if things weren't amazing enough already, you can even see a rack. Wow, isn't TextWorld just the best? [if there is something on the s_3]You see [a list of things on the s_3] on the rack.[end if]".
...
The cellar part 2 is some text that varies. The cellar part 2 is " You can make out a workbench. [if there is something on the s_4]You see [a list of things on the s_4] on the workbench. It doesn't get more TextWorld than this![end if]".
The cellar part 3 is some text that varies. The cellar part 3 is "[if there is nothing on the s_4]Looks like someone's already been here and taken everything off it, though. Hm. Oh well[end if]".
The cellar part 4 is some text that varies. The cellar part 4 is "

You don't like doors? Why not try going east, that entranceway is unguarded. There is an unblocked exit to the north. There is an unblocked exit to the south.".
The description of r_11 is "[cellar part 0][cellar part 1][cellar part 2][cellar part 3][cellar part 4]".
...
The basement part 0 is some text that varies. The basement part 0 is "You find yourself in a basement. A typical one. You begin to take stock of what's here.
...
The basement part 1 is some text that varies. The basement part 1 is "[if c_4 is open and the c_4 contains nothing] The safe is empty! What a waste of a day![end if]".
The basement part 2 is some text that varies. The basement part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The basement part 3 is some text that varies. The basement part 3 is " door leading west. You don't like doors? Why not try going east, that entranceway is unblocked. You don't like doors? Why not try going north, that entranceway is unguarded.".
...
There is an unguarded exit to the east. You don't like doors? Why not try going north, that entranceway is unguarded. There is an exit to the south. Don't worry, it is unguarded. There is an exit to the west. Don't worry, it is unguarded.".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You've entered a spare room. You can barely contain your excitement.

 You make out [if c_5 is locked]a locked[else if c_5 is open]an opened[otherwise]a closed[end if]".
The spare room part 1 is some text that varies. The spare room part 1 is " suitcase.[if c_5 is open and there is something in the c_5] The suitcase contains [a list of things in the c_5].[end if]".
The spare room part 2 is some text that varies. The spare room part 2 is "[if c_5 is open and the c_5 contains nothing] The suitcase is empty, what a horrible day![end if]".
...
The study part 0 is some text that varies. The study part 0 is "You arrive in a study. An ordinary kind of place.
 ...
 Hey, want to see a bookshelf? Look over there, a bookshelf. The bookshelf is typical.[if there is something on the s_5] On the bookshelf you make out [a list of things on the s_5].[end if]".
The study part 1 is some text that varies. The study part 1 is "[if there is nothing on the s_5] However, the bookshelf, like an empty bookshelf, has nothing on it. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You've just walked into a workshop.
 ...
 Oh wow! Is that what I think it is? It is! It's a locker.[if c_6 is open and there is something in the c_6] The locker contains [a list of things in the c_6].[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if c_6 is open and the c_6 contains nothing] The locker is empty! What a waste of a day![end if]".
The workshop part 2 is some text that varies. The workshop part 2 is " You can make out [if c_7 is locked]a locked[else if c_7 is open]an opened[otherwise]a closed[end if]".
The workshop part 3 is some text that varies. The workshop part 3 is " portmanteau.[if c_7 is open and there is something in the c_7] The portmanteau contains [a list of things in the c_7].[end if]".
...
The workshop part 5 is some text that varies. The workshop part 5 is " You can make out a mantelpiece. The mantelpiece is standard.[if there is something on the s_6] On the mantelpiece you can make out [a list of things on the s_6]. I mean, just wow! Isn't TextWorld just the best?[end if]".
The workshop part 6 is some text that varies. The workshop part 6 is "[if there is nothing on the s_6] But the thing hasn't got anything on it.[end if]".
...
The garage part 0 is some text that varies. The garage part 0 is "Ah, the garage. This is some kind of garage, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it. You start to take note of what's in the room.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You've just sauntered into a cookery.
 ...
 You scan the room for a chest, and you find a chest.[if c_8 is open and there is something in the c_8] The chest contains [a list of things in the c_8]. There's something strange about this thing being here, but you don't have time to worry about that now.[end if]".
...
The cookery part 2 is some text that varies. The cookery part 2 is " Look over there! a platter. [if there is something on the s_7]On the platter you can see [a list of things on the s_7].[end if]".
The cookery part 3 is some text that varies. The cookery part 3 is "[if there is nothing on the s_7]Unfortunately, there isn't a thing on it.[end if]".
The cookery part 4 is some text that varies. The cookery part 4 is " You can make out a saucepan. The saucepan is typical.[if there is something on the s_8] On the saucepan you make out [a list of things on the s_8].[end if]".
The cookery part 5 is some text that varies. The cookery part 5 is "[if there is nothing on the s_8] Looks like someone's already been here and taken everything off it, though.[end if]".
...
The description of r_9 is "[cookery part 0][cookery part 1][cookery part 2][cookery part 3][cookery part 4][cookery part 5][cookery part 6]".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You find yourself in a scullery. A standard one.
 ...
 Hey, want to see a fridge? Look over there, a fridge.[if c_9 is open and there is something in the c_9] The fridge contains [a list of things in the c_9].[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if c_9 is open and the c_9 contains nothing] The fridge is empty, what a horrible day![end if]".
The scullery part 2 is some text that varies. The scullery part 2 is " You can make out a bowl. The bowl is typical.[if there is something on the s_9] On the bowl you make out [a list of things on the s_9]. You shudder, but continue examining the room.[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is "[if there is nothing on the s_9] The bowl appears to be empty. Oh! Why couldn't there just be stuff on it?[end if]".
...
The vault part 0 is some text that varies. The vault part 0 is "You've just sauntered into a vault. You can barely contain your excitement.
...
The r_0 and the r_6 and the r_1 and the r_14 and the r_13 and the r_15 and the r_12 and the r_16 and the r_11 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_10 and the r_18 and the r_19 are rooms.
The r_0 and the r_6 and the r_1 and the r_14 and the r_13 and the r_15 and the r_12 and the r_16 and the r_11 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_10 and the r_18 and the r_19 are privately-named.
...
The s_6 is in r_7.
The description of s_7 is "The platter is undependable.".
...
Test quest0_0 with "go south / go south / go west / go west / go south / go west / go west / go north / go north / go east / go north / go north / go west / take stick of butter"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting episode of TextWorld! Here is your task for today. First thing I need you to do is to try to head south. Next, make an effort to go south. Then, attempt to move west. If yo".
The objective part 1 is some text that varies. The objective part 1 is "u can accomplish that, go to the west. And then, make an effort to take a trip south. And then, take a trip west. With that over with, move west. And then, make an effort to travel north. With that ov".
The objective part 2 is some text that varies. The objective part 2 is "er with, go north. With that over with, go to the east. Then, try to go to the north. Then, head north. And then, try to go west. And then, retrieve the stick of butter from the floor of the kitchenet".
The objective part 3 is some text that varies. The objective part 3 is "te. Alright, thanks!".
