...
The r_0 and the r_2 and the r_1 and the r_3 and the r_10 and the r_14 and the r_11 and the r_12 and the r_13 and the r_15 and the r_18 and the r_16 and the r_17 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_19 are rooms.
...
The spare room part 1 is some text that varies. The spare room part 1 is "[if c_0 is open and the c_0 contains nothing] The cabinet is empty, what a horrible day![end if]".
...
You need an unguarded exit? You should try going east. There is an exit to the north. Don't worry, it is unguarded. You need an unblocked exit? You should try going south. There is an exit to the west. Don't worry, it is unblocked.".
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in a laundry place. A standard one. You start to take note of what's in the room.

 You make out [if c_2 is locked]a locked[else if c_2 is open]an opened[otherwise]a closed[end if]".
The laundry place part 1 is some text that varies. The laundry place part 1 is " dresser.[if c_2 is open and there is something in the c_2] The dresser contains [a list of things in the c_2].[end if]".
The laundry place part 2 is some text that varies. The laundry place part 2 is "[if c_2 is open and the c_2 contains nothing] The dresser is empty! What a waste of a day![end if]".
...
The chamber part 0 is some text that varies. The chamber part 0 is "You're now in the chamber.
 ...
 Were you looking for a trunk? Because look over there, it's a trunk.[if c_3 is open and there is something in the c_3] The trunk contains [a list of things in the c_3]. The light flickers for a second, but nothing else happens.[end if]".
...
The chamber part 2 is some text that varies. The chamber part 2 is " You can see a bed. You shudder, but continue examining the bed. [if there is something on the s_1]You see [a list of things on the s_1] on the bed. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
There is an exit to the east. Don't worry, it is unguarded. There is an exit to the north. Don't worry, it is unblocked. There is an exit to the south. Don't worry, it is unblocked. There is an exit to the west. Don't worry, it is unguarded.".
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well how about that, you are in a place we're calling a kitchen.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a plate. Now why would someone leave that there? [if there is something on the s_2]On the plate you see [a list of things on the s_2].[end if]".
The kitchen part 1 is some text that varies. The kitchen part 1 is "[if there is nothing on the s_2]The plate appears to be empty.[end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You arrive in a shower. A typical one. You try to gain information on your surroundings by using a technique you call 'looking.'

 Oh, great. Here's a bench. [if there is something on the s_3]On the bench you see [a list of things on the s_3].[end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if there is nothing on the s_3]But the thing is empty. Hm. Oh well[end if]".
...
The cellar part 0 is some text that varies. The cellar part 0 is "Well, here we are in the cellar.
 ...
 You smell an awful smell, and follow it to a coffer.[if c_4 is open and there is something in the c_4] The coffer contains [a list of things in the c_4]. Now why would someone leave that there?[end if]".
The cellar part 1 is some text that varies. The cellar part 1 is "[if c_4 is open and the c_4 contains nothing] The coffer is empty! What a waste of a day![end if]".
The cellar part 2 is some text that varies. The cellar part 2 is " You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a counter. The counter is usual.[if there is something on the s_4] On the counter you can make out [a list of things on the s_4].[end if]".
The cellar part 3 is some text that varies. The cellar part 3 is "[if there is nothing on the s_4] But the thing hasn't got anything on it. Hm. Oh well[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. An usual kind of place. You begin looking for stuff.

 You can see a stand. The stand is typical.[if there is something on the s_5] On the stand you see [a list of things on the s_5].[end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is "[if there is nothing on the s_5] Unfortunately, there isn't a thing on it. You move on, clearly depressed by TextWorld.[end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is "

There is an exit to the east. Don't worry, it is unguarded. You need an unblocked exit? You should try going north. You don't like doors? Why not try going south, that entranceway is unblocked. You need an unblocked exit? You should try going west.".
...
The restroom part 0 is some text that varies. The restroom part 0 is "Guess what, you are in the place we're calling the restroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The office part 0 is some text that varies. The office part 0 is "This just in- You, in the office. You start to take note of what's in the room.

 You smell an interesting smell, and follow it to a mantelpiece. The mantelpiece is usual.[if there is something on the s_6] On the mantelpiece you can see [a list of things on the s_6].[end if]".
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You find yourself in a recreation zone. An ordinary kind of place. The room is well lit.

 You bend down to tie your shoe. When you stand up, you notice a safe.[if c_5 is open and there is something in the c_5] The safe contains [a list of things in the c_5]. You wonder idly who left that here.[end if]".
The recreation zone part 1 is some text that varies. The recreation zone part 1 is "[if c_5 is open and the c_5 contains nothing] The safe is empty, what a horrible day![end if]".
The recreation zone part 2 is some text that varies. The recreation zone part 2 is " You see a desk. [if there is something on the s_7]You see [a list of things on the s_7] on the desk.[end if]".
...
The recreation zone part 4 is some text that varies. The recreation zone part 4 is " You make out a couch. The couch is normal.[if there is something on the s_8] On the couch you can see [a list of things on the s_8].[end if]".
The recreation zone part 5 is some text that varies. The recreation zone part 5 is "[if there is nothing on the s_8] Unfortunately, there isn't a thing on it.[end if]".
...
The description of r_17 is "[recreation zone part 0][recreation zone part 1][recreation zone part 2][recreation zone part 3][recreation zone part 4][recreation zone part 5][recreation zone part 6]".
...
There is an exit to the east. Don't worry, it is unblocked. You need an unblocked exit? You should try going north. You need an unblocked exit? You should try going south. There is an exit to the west. Don't worry, it is unguarded.".
...
The vault part 1 is some text that varies. The vault part 1 is " suitcase close by.[if c_6 is open and there is something in the c_6] The suitcase contains [a list of things in the c_6].[end if]".
The vault part 2 is some text that varies. The vault part 2 is "[if c_6 is open and the c_6 contains nothing] The suitcase is empty, what a horrible day![end if]".
The vault part 3 is some text that varies. The vault part 3 is "

You need an unblocked exit? You should try going east. There is an exit to the north. Don't worry, it is unguarded. You need an unblocked exit? You should try going south. There is an unguarded exit to the west.".
...
The launderette part 0 is some text that varies. The launderette part 0 is "You've entered a launderette. You begin looking for stuff.
 ...
 Look over there! a table. [if there is something on the s_10]On the table you see [a list of things on the s_10].[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if there is nothing on the s_10]But there isn't a thing on it.[end if]".
The launderette part 2 is some text that varies. The launderette part 2 is " You smell a great smell, and follow it to a rack. The rack is typical.[if there is something on the s_9] On the rack you can make out [a list of things on the s_9].[end if]".
The launderette part 3 is some text that varies. The launderette part 3 is "[if there is nothing on the s_9] The rack appears to be empty. Hm. Oh well[end if]".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is " locker in the corner.[if c_7 is open and there is something in the c_7] The locker contains [a list of things in the c_7]. Huh, weird.[end if]".
The cubicle part 2 is some text that varies. The cubicle part 2 is "[if c_7 is open and the c_7 contains nothing] The locker is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The studio part 1 is some text that varies. The studio part 1 is " usual looking portmanteau in the room.[if c_8 is open and there is something in the c_8] The portmanteau contains [a list of things in the c_8].[end if]".
The studio part 2 is some text that varies. The studio part 2 is "[if c_8 is open and the c_8 contains nothing] What a letdown! The portmanteau is empty![end if]".
...
The description of r_19 is "[studio part 0][studio part 1][studio part 2][studio part 3]".
...
The r_0 and the r_2 and the r_1 and the r_3 and the r_10 and the r_14 and the r_11 and the r_12 and the r_13 and the r_15 and the r_18 and the r_16 and the r_17 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_19 are rooms.
The r_0 and the r_2 and the r_1 and the r_3 and the r_10 and the r_14 and the r_11 and the r_12 and the r_13 and the r_15 and the r_18 and the r_16 and the r_17 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_19 are privately-named.
...
The s_7 is in r_17.
The description of s_8 is "The couch is durable.".
The printed name of s_8 is "couch".
Understand "couch" as s_8.
The s_8 is in r_17.
The description of s_9 is "The rack is reliable.".
...
Test quest0_0 with "go west / go west / go north / go west / go north / go east / go east / go south / go east / go north / go east / go south / go south / take candy bar"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to try to take a trip west. That done, move west. That done, make an attempt to ".
The objective part 1 is some text that varies. The objective part 1 is "venture north. And then, try to move west. Then, move north. Then, make an effort to head east. Then, go east. After that, try to move south. With that done, take a trip east. Then, venture north. And".
The objective part 2 is some text that varies. The objective part 2 is " then, travel east. Once you get through with that, take a trip south. With that done, make an attempt to travel south. With that done, pick up the candy bar from the floor of the garage. Alright, tha".
The objective part 3 is some text that varies. The objective part 3 is "nks!".
