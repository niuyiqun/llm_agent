...
The r_0 and the r_1 and the r_14 and the r_11 and the r_12 and the r_2 and the r_15 and the r_18 and the r_17 and the r_13 and the r_3 and the r_6 and the r_4 and the r_8 and the r_7 and the r_10 and the r_16 and the r_19 and the r_5 and the r_9 are rooms.

Understand "launderette" as r_0.
The internal name of r_0 is "launderette".
The printed name of r_0 is "-= Launderette =-".
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. A standard kind of place. The room is well lit.

 You make out a counter. The counter is standard.[if there is something on the s_0] On the counter you can see [a list of things on the s_0].[end if]".
The launderette part 1 is some text that varies. The launderette part 1 is "[if there is nothing on the s_0] But the thing is empty. It would have been so cool if there was stuff on the counter.[end if]".
...
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if c_0 is open and the c_0 contains nothing] The fridge is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The cookhouse part 3 is some text that varies. The cookhouse part 3 is " chest.[if c_1 is open and there is something in the c_1] The chest contains [a list of things in the c_1].[end if]".
...
The cookhouse part 5 is some text that varies. The cookhouse part 5 is " You can make out a chair. [if there is something on the s_1]You see [a list of things on the s_1] on the chair. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The cookhouse part 6 is some text that varies. The cookhouse part 6 is "[if there is nothing on the s_1]Looks like someone's already been here and taken everything off it, though. It would have been so cool if there was stuff on the chair.[end if]".
...
The closet part 0 is some text that varies. The closet part 0 is "Ah, the closet. This is some kind of closet, really great normal vibes in this place, a wonderful normal atmosphere.
 ...
 Hey, want to see a table? Look over there, a table. Now why would someone leave that there? [if there is something on the s_2]You see [a list of things on the s_2] on the table.[end if]".
The closet part 1 is some text that varies. The closet part 1 is "[if there is nothing on the s_2]But oh no! there's nothing on this piece of trash. You move on, clearly infuriated by TextWorld.[end if]".
The closet part 2 is some text that varies. The closet part 2 is "

There is an unguarded exit to the east. There is an exit to the north. Don't worry, it is unblocked. You need an unguarded exit? You should try going west.".
...
The office part 0 is some text that varies. The office part 0 is "You arrive in an office. A typical kind of place. You begin to take stock of what's in the room.

 Look over there! a cabinet. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[if c_2 is open and there is something in the c_2] The cabinet contains [a list of things in the c_2].[end if]".
The office part 1 is some text that varies. The office part 1 is "[if c_2 is open and the c_2 contains nothing] The cabinet is empty! What a waste of a day![end if]".
...
The cookery part 1 is some text that varies. The cookery part 1 is "[if c_3 is open and the c_3 contains nothing] The case is empty, what a horrible day![end if]".
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A normal one.
 ...
 You make out a bowl. The bowl is typical.[if there is something on the s_3] On the bowl you can see [a list of things on the s_3].[end if]".
The canteen part 1 is some text that varies. The canteen part 1 is "[if there is nothing on the s_3] Unfortunately, there isn't a thing on it.[end if]".
The canteen part 2 is some text that varies. The canteen part 2 is "

There is an exit to the east. Don't worry, it is unguarded. There is an exit to the north. Don't worry, it is unblocked. You don't like doors? Why not try going south, that entranceway is unguarded. There is an unguarded exit to the west.".
...
The cubicle part 1 is some text that varies. The cubicle part 1 is " safe in the corner.[if c_4 is open and there is something in the c_4] The safe contains [a list of things in the c_4].[end if]".
...
The description of r_15 is "[cubicle part 0][cubicle part 1][cubicle part 2][cubicle part 3]".
...
The steam room part 0 is some text that varies. The steam room part 0 is "Well, here we are in the steam room.
 ...
 You can see a shelf. [if there is something on the s_4]You see [a list of things on the s_4] on the shelf. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
The steam room part 1 is some text that varies. The steam room part 1 is "[if there is nothing on the s_4]The shelf appears to be empty. This always happens, here in TextWorld![end if]".
...
The workshop part 0 is some text that varies. The workshop part 0 is "You've entered a workshop. You begin to take stock of what's here.
 ...
 Were you looking for a bookshelf? Because look over there, it's a bookshelf. The bookshelf is usual.[if there is something on the s_5] On the bookshelf you see [a list of things on the s_5].[end if]".
The workshop part 1 is some text that varies. The workshop part 1 is "[if there is nothing on the s_5] But oh no! there's nothing on this piece of junk. Hm. Oh well[end if]".
...
The attic part 0 is some text that varies. The attic part 0 is "You've just shown up in an attic. You begin to take stock of what's in the room.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You find yourself in a laundry place. An ordinary one.
 ...
 You see a gleam over in a corner, where you can see a dresser.[if c_5 is open and there is something in the c_5] The dresser contains [a list of things in the c_5].[end if]".
...
The laundry place part 2 is some text that varies. The laundry place part 2 is " You make out [if c_6 is locked]a locked[else if c_6 is open]an opened[otherwise]a closed[end if]".
The laundry place part 3 is some text that varies. The laundry place part 3 is " basket right there by you.[if c_6 is open and there is something in the c_6] The basket contains [a list of things in the c_6].[end if]".
The laundry place part 4 is some text that varies. The laundry place part 4 is "[if c_6 is open and the c_6 contains nothing] The basket is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The spare room part 0 is some text that varies. The spare room part 0 is "You have come into a spare room. Not the spare room you'd expect. No, this is a spare room.
...
The shower part 0 is some text that varies. The shower part 0 is "You've entered a shower.
 ...
 You scan the room for a trunk, and you find a trunk.[if c_7 is open and there is something in the c_7] The trunk contains [a list of things in the c_7].[end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if c_7 is open and the c_7 contains nothing] The trunk is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've just shown up in a pantry. I guess you better just go and list everything you see here.

 You can make out [if c_8 is locked]a locked[else if c_8 is open]an opened[otherwise]a closed[end if]".
The pantry part 1 is some text that varies. The pantry part 1 is " coffer in the room.[if c_8 is open and there is something in the c_8] The coffer contains [a list of things in the c_8].[end if]".
...
The pantry part 3 is some text that varies. The pantry part 3 is " You see a stand. [if there is something on the s_6]You see [a list of things on the s_6] on the stand. It doesn't get more TextWorld than this![end if]".
The pantry part 4 is some text that varies. The pantry part 4 is "[if there is nothing on the s_6]But the thing hasn't got anything on it. Hm. Oh well[end if]".
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've entered a laundromat. The room is well lit.
 ...
 You see a bench. [if there is something on the s_10]On the bench you make out [a list of things on the s_10].[end if]".
The laundromat part 1 is some text that varies. The laundromat part 1 is "[if there is nothing on the s_10]However, the bench, like an empty bench, has nothing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The laundromat part 2 is some text that varies. The laundromat part 2 is " What's that over there? It looks like it's a rack. The rack is ordinary.[if there is something on the s_7] On the rack you see [a list of things on the s_7].[end if]".
The laundromat part 3 is some text that varies. The laundromat part 3 is "[if there is nothing on the s_7] But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
The laundromat part 4 is some text that varies. The laundromat part 4 is " You can see a board. The board is standard.[if there is something on the s_8] On the board you can see [a list of things on the s_8].[end if]".
The laundromat part 5 is some text that varies. The laundromat part 5 is "[if there is nothing on the s_8] But oh no! there's nothing on this piece of trash.[end if]".
The laundromat part 6 is some text that varies. The laundromat part 6 is " You see a counter. The counter is shiny.[if there is something on the s_9] On the shiny counter you see [a list of things on the s_9].[end if]".
The laundromat part 7 is some text that varies. The laundromat part 7 is "[if there is nothing on the s_9] However, the counter, like an empty counter, has nothing on it. It would have been so cool if there was stuff on the counter.[end if]".
...
The description of r_9 is "[laundromat part 0][laundromat part 1][laundromat part 2][laundromat part 3][laundromat part 4][laundromat part 5][laundromat part 6][laundromat part 7][laundromat part 8]".
...
The r_0 and the r_1 and the r_14 and the r_11 and the r_12 and the r_2 and the r_15 and the r_18 and the r_17 and the r_13 and the r_3 and the r_6 and the r_4 and the r_8 and the r_7 and the r_10 and the r_16 and the r_19 and the r_5 and the r_9 are rooms.
The r_0 and the r_1 and the r_14 and the r_11 and the r_12 and the r_2 and the r_15 and the r_18 and the r_17 and the r_13 and the r_3 and the r_6 and the r_4 and the r_8 and the r_7 and the r_10 and the r_16 and the r_19 and the r_5 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go south / go south / go south / go west / go west / go south / go west / go west / go north / go north / go east / go east / take hat"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, go east. Then, make an attempt to go to the south. After that, try to head south. With tha".
The objective part 1 is some text that varies. The objective part 1 is "t over with, travel south. With that done, make an effort to travel west. Then, make an effort to venture west. Okay, and then, go south. Then, head west. And then, try to go west. After that, make an".
The objective part 2 is some text that varies. The objective part 2 is " attempt to move north. And then, try to take a trip north. With that done, go to the east. And then, attempt to go to the east. Okay, and then, retrieve the hat from the floor of the attic. That's it".
