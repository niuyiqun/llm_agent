...
The r_0 and the r_10 and the r_1 and the r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_18 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_9 and the r_6 and the r_7 and the r_8 and the r_16 and the r_19 are rooms.

Understand "cubicle" as r_0.
The internal name of r_0 is "cubicle".
The printed name of r_0 is "-= Cubicle =-".
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. An usual kind of place. You begin to take stock of what's in the room.

 You can see [if c_0 is locked]a locked[else if c_0 is open]an opened[otherwise]a closed[end if]".
The cubicle part 1 is some text that varies. The cubicle part 1 is " safe.[if c_0 is open and there is something in the c_0] The safe contains [a list of things in the c_0]. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The cubicle part 3 is some text that varies. The cubicle part 3 is " You can see a stand. [if there is something on the s_0]On the stand you can see [a list of things on the s_0].[end if]".
The cubicle part 4 is some text that varies. The cubicle part 4 is "[if there is nothing on the s_0]The stand appears to be empty.[end if]".
...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. A standard kind of place.
 ...
 You can make out a table. What a coincidence, weren't you just thinking about a table? [if there is something on the s_1]On the table you see [a list of things on the s_1].[end if]".
The cookery part 1 is some text that varies. The cookery part 1 is "[if there is nothing on the s_1]But the thing is empty. It would have been so cool if there was stuff on the table.[end if]".
The cookery part 2 is some text that varies. The cookery part 2 is "

There is an exit to the east. Don't worry, it is unblocked. There is an unguarded exit to the north. There is an exit to the south. Don't worry, it is unguarded. You don't like doors? Why not try going west, that entranceway is unblocked.".
...
The kitchen part 1 is some text that varies. The kitchen part 1 is " fridge nearby.[if c_1 is open and there is something in the c_1] The fridge contains [a list of things in the c_1].[end if]".
...
The salon part 0 is some text that varies. The salon part 0 is "Well, here we are in the salon. Let's see what's in here.



 There is [if d_2 is open]an open[otherwise]a closed[end if]".
The salon part 1 is some text that varies. The salon part 1 is " gate leading north. You don't like doors? Why not try going east, that entranceway is unguarded. You don't like doors? Why not try going south, that entranceway is unguarded.".
...
The washroom part 0 is some text that varies. The washroom part 0 is "Fancy seeing you here. Here, by the way, being the washroom. You can barely contain your excitement.

 You can see a rack. [if there is something on the s_2]You see [a list of things on the s_2] on the rack. Something scurries by right in the corner of your eye. Probably nothing.[end if]".
The washroom part 1 is some text that varies. The washroom part 1 is "[if there is nothing on the s_2]However, the rack, like an empty rack, has nothing on it. Oh! Why couldn't there just be stuff on it?[end if]".
The washroom part 2 is some text that varies. The washroom part 2 is " Look out! It's a- oh, never mind, it's just a board. [if there is something on the s_3]On the board you can make out [a list of things on the s_3].[end if]".
The washroom part 3 is some text that varies. The washroom part 3 is "[if there is nothing on the s_3]But the thing is empty. You swear loudly.[end if]".
...
The study part 1 is some text that varies. The study part 1 is " portmanteau in the room.[if c_2 is open and there is something in the c_2] The portmanteau contains [a list of things in the c_2].[end if]".
The study part 2 is some text that varies. The study part 2 is "[if c_2 is open and the c_2 contains nothing] The portmanteau is empty! What a waste of a day![end if]".
...
The description of r_15 is "[study part 0][study part 1][study part 2][study part 3]".
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well how about that, you are in the place we're calling the cookhouse.
 ...
 Oh, great. Here's a saucepan. I guess it's true what they say, if you're looking for a saucepan, go to TextWorld. [if there is something on the s_4]On the saucepan you can make out [a list of things on the s_4]. Hmmm... what else, what else?[end if]".
The cookhouse part 1 is some text that varies. The cookhouse part 1 is "[if there is nothing on the s_4]But there isn't a thing on it.[end if]".
The cookhouse part 2 is some text that varies. The cookhouse part 2 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The cookhouse part 3 is some text that varies. The cookhouse part 3 is " door leading west. You need an unguarded exit? You should try going north.".
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. A standard one.
 ...
 You see a bowl. You wonder idly who left that here. [if there is something on the s_5]You see [a list of things on the s_5] on the bowl.[end if]".
The scullery part 1 is some text that varies. The scullery part 1 is "[if there is nothing on the s_5]But the thing hasn't got anything on it. Aw, here you were, all excited for there to be things on it![end if]".
The scullery part 2 is some text that varies. The scullery part 2 is " You can see a platter. You shudder, but continue examining the platter. [if there is something on the s_6]You see [a list of things on the s_6] on the platter.[end if]".
The scullery part 3 is some text that varies. The scullery part 3 is "[if there is nothing on the s_6]However, the platter, like an empty platter, has nothing on it.[end if]".
The scullery part 4 is some text that varies. The scullery part 4 is "

 There is [if d_0 is open]an open[otherwise]a closed[end if]".
The scullery part 5 is some text that varies. The scullery part 5 is " door leading east. There is [if d_1 is open]an open[otherwise]a closed[end if]".
...
The dish-pit part 1 is some text that varies. The dish-pit part 1 is " chest.[if c_3 is open and there is something in the c_3] The chest contains [a list of things in the c_3].[end if]".
...
The dish-pit part 3 is some text that varies. The dish-pit part 3 is " Oh, great. Here's a freezer.[if c_4 is open and there is something in the c_4] The freezer contains [a list of things in the c_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
The dish-pit part 4 is some text that varies. The dish-pit part 4 is "[if c_4 is open and the c_4 contains nothing] What a letdown! The freezer is empty![end if]".
...
The studio part 0 is some text that varies. The studio part 0 is "You've entered a studio. You start to take note of what's in the room.

 You can see a mantle. The mantle is typical.[if there is something on the s_7] On the mantle you see [a list of things on the s_7].[end if]".
The studio part 1 is some text that varies. The studio part 1 is "[if there is nothing on the s_7] But there isn't a thing on it.[end if]".
...
The laundromat part 1 is some text that varies. The laundromat part 1 is " drawer.[if c_5 is open and there is something in the c_5] The drawer contains [a list of things in the c_5].[end if]".
...
The sauna part 0 is some text that varies. The sauna part 0 is "You find yourself in a sauna. A normal kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The bar part 1 is some text that varies. The bar part 1 is " trunk.[if c_6 is open and there is something in the c_6] The trunk contains [a list of things in the c_6].[end if]".
The bar part 2 is some text that varies. The bar part 2 is "[if c_6 is open and the c_6 contains nothing] Empty! What kind of nightmare TextWorld is this?[end if]".
The bar part 3 is some text that varies. The bar part 3 is " You make out a bed stand. [if there is something on the s_8]On the bed stand you make out [a list of things on the s_8]. You can't wait to tell the folks at home about this![end if]".
The bar part 4 is some text that varies. The bar part 4 is "[if there is nothing on the s_8]But the thing is empty, unfortunately.[end if]".
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've entered a bedchamber.
 ...
 You can make out a suitcase. Now why would someone leave that there?[if c_7 is open and there is something in the c_7] The suitcase contains [a list of things in the c_7]. Wow, check out the price tag that hangs off the suitcase! Three hundred dollars![end if]".
The bedchamber part 1 is some text that varies. The bedchamber part 1 is "[if c_7 is open and the c_7 contains nothing] The suitcase is empty! This is the worst thing that could possibly happen, ever![end if]".
The bedchamber part 2 is some text that varies. The bedchamber part 2 is " You make out [if c_8 is locked]a locked[else if c_8 is open]an opened[otherwise]a closed[end if]".
The bedchamber part 3 is some text that varies. The bedchamber part 3 is " dresser.[if c_8 is open and there is something in the c_8] The dresser contains [a list of things in the c_8], so there's that.[end if]".
The bedchamber part 4 is some text that varies. The bedchamber part 4 is "[if c_8 is open and the c_8 contains nothing] The dresser is empty! This is the worst thing that could possibly happen, ever![end if]".
...
The shower part 0 is some text that varies. The shower part 0 is "You've entered a shower. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
 ...
 What's that over there? It looks like it's a cabinet.[if c_9 is open and there is something in the c_9] The cabinet contains [a list of things in the c_9]. You can't wait to tell the folks at home about this![end if]".
The shower part 1 is some text that varies. The shower part 1 is "[if c_9 is open and the c_9 contains nothing] What a letdown! The cabinet is empty![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've entered a bathroom.
 ...
 You can see a bench. [if there is something on the s_9]You see [a list of things on the s_9] on the bench.[end if]".
...
The bathroom part 3 is some text that varies. The bathroom part 3 is " hatch leading north. There is [if d_2 is open]an open[otherwise]a closed[end if]".
The bathroom part 4 is some text that varies. The bathroom part 4 is " gate leading south.".
...
The r_0 and the r_10 and the r_1 and the r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_18 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_9 and the r_6 and the r_7 and the r_8 and the r_16 and the r_19 are rooms.
The r_0 and the r_10 and the r_1 and the r_11 and the r_12 and the r_14 and the r_13 and the r_15 and the r_18 and the r_17 and the r_2 and the r_5 and the r_3 and the r_4 and the r_9 and the r_6 and the r_7 and the r_8 and the r_16 and the r_19 are privately-named.
...
The s_4 is in r_18.
The description of s_5 is "The bowl is solid.".
...
The s_8 is in r_6.
The description of s_9 is "The bench is undependable.".
...
Test quest0_0 with "go north / go north / go west / go west / go south / go east / go south / go west / go south / go west / go north / go west / go south / take licorice strip from board"
...
Every turn:
	...
	else if The player is in r_13 and The s_3 is in r_13 and The player carries the f_0:
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First of all, you could, like, make an attempt to head north. Okay, and then, take a trip north. After that, make an e".
The objective part 1 is some text that varies. The objective part 1 is "ffort to venture west. Okay, and then, try to move west. And then, make an effort to move south. Then, attempt to go to the east. And then, move south. And then, move west. With that over with, travel".
The objective part 2 is some text that varies. The objective part 2 is " south. After that, make an attempt to move west. Then, attempt to go to the north. Following that, venture west. After that, make an attempt to go to the south. And then, pick up the licorice strip f".
The objective part 3 is some text that varies. The objective part 3 is "rom the board. Alright, thanks!".
