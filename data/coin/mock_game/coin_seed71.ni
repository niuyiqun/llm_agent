...
The r_0 and the r_1 and the r_12 and the r_11 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_2 are rooms.
...
The salon part 0 is some text that varies. The salon part 0 is "I am pleased to announce that you are now in the salon. You begin looking for stuff.
...
The washroom part 0 is some text that varies. The washroom part 0 is "Well I'll be, you are in the place we're calling the washroom. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The studio part 0 is some text that varies. The studio part 0 is "Guess what, you are in a place we're calling a studio. The room is well lit.
...
The scullery part 0 is some text that varies. The scullery part 0 is "This might come as a shock to you, but you've just walked into a scullery.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just shown up in the laundry place. You begin to take stock of what's in the room.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You make another one of your grand eccentric entrances into a workshop. You can barely contain your excitement.
...
The r_0 and the r_1 and the r_12 and the r_11 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_2 are rooms.
The r_0 and the r_1 and the r_12 and the r_11 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_2 are privately-named.
...
Test quest0_0 with "go west / go south / go south / go east / go south / go east / go south / go west / go north / go west / go north / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, move west. After that, venture south. With that accomplished, try to go south. And then, go ".
The objective part 1 is some text that varies. The objective part 1 is "east. Okay, and then, make an effort to move south. If you can get around to doing that, attempt to move east. And then, attempt to go to the south. Then, travel west. If you can succeed at that, atte".
The objective part 2 is some text that varies. The objective part 2 is "mpt to head north. Then, move west. Then, head north. Okay, and then, attempt to go east. Then, go to the south. That done, go to the east. With that over with, recover the coin from the floor of the ".
The objective part 3 is some text that varies. The objective part 3 is "cookhouse. Once that's all handled, you can stop!".
