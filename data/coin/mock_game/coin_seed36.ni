...
The r_1 and the r_0 and the r_10 and the r_9 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_12 and the r_6 are rooms.
...
The r_1 and the r_0 and the r_10 and the r_9 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_12 and the r_6 are rooms.
The r_1 and the r_0 and the r_10 and the r_9 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_12 and the r_6 are privately-named.
...
Test quest0_0 with "go east / go south / go east / go north / go west / go south / go south / go east / go east / go east / go east / go north / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to attempt to move east. That done, head south. Once you manage that, make".
The objective part 1 is some text that varies. The objective part 1 is " an attempt to travel east. And then, venture north. Then, make an attempt to go west. Then, go to the south. Then, go south. And then, go to the east. After that, travel east. And then, go east. Afte".
The objective part 2 is some text that varies. The objective part 2 is "r that, travel east. With that done, make an effort to travel north. And then, attempt to take a trip north. That done, make an attempt to go east. And then, pick up the coin from the floor of the ste".
The objective part 3 is some text that varies. The objective part 3 is "am room. Alright, thanks!".
