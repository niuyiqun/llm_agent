...
The r_1 and the r_0 and the r_12 and the r_11 and the r_3 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_8 and the r_10 and the r_13 and the r_14 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. An ordinary one. The room is well lit.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just walked into a scullery. You begin to take stock of what's here.
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. An usual one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The r_1 and the r_0 and the r_12 and the r_11 and the r_3 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_8 and the r_10 and the r_13 and the r_14 are rooms.
The r_1 and the r_0 and the r_12 and the r_11 and the r_3 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_9 and the r_8 and the r_10 and the r_13 and the r_14 are privately-named.
...
Test quest0_0 with "go east / go south / go east / go east / go east / go north / go east / go south / go east / go south / go south / go east / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First thing I need you to do is to try to venture east. Next, make an effort to travel south. Then, make an atte".
The objective part 1 is some text that varies. The objective part 1 is "mpt to travel east. Once you get through with that, take a trip east. And then, move east. With that done, travel north. Okay, and then, make an attempt to head east. Once you do that, make an effort ".
The objective part 2 is some text that varies. The objective part 2 is "to travel south. Next, go to the east. And then, try to go south. Following that, make an effort to move south. With that accomplished, move east. With that done, head north. Then, make an attempt to ".
The objective part 3 is some text that varies. The objective part 3 is "venture north. Then, retrieve the coin from the floor of the office. Once that's all handled, you can stop!".
