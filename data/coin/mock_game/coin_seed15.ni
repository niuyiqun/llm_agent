...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are rooms.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You make a grand eccentric entrance into a bedchamber. Okay, just remember what you're here to do, and everything will go great.
...
The lounge part 0 is some text that varies. The lounge part 0 is "Well, here we are in the lounge. I guess you better just go and list everything you see here.
...
The pantry part 0 is some text that varies. The pantry part 0 is "Of every pantry you could have walked into, you had to walk into an ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The playroom part 0 is some text that varies. The playroom part 0 is "You've just sauntered into a playroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in a laundromat. A typical kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A normal kind of place. You begin to take stock of what's in the room.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_6 and the r_7 and the r_8 and the r_9 and the r_4 and the r_5 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go north / go north / go north / go west / go west / go west / go north / go west / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! First step, head west. Then, make an attempt to take a trip north. And then, make an attempt to head east. Then, make an effort to travel nort".
The objective part 1 is some text that varies. The objective part 1 is "h. And then, go north. If you can get through with that, make an effort to venture north. Then, move west. With that done, go west. After that, go west. Following that, try to move north. Okay, and th".
The objective part 2 is some text that varies. The objective part 2 is "en, venture west. And then, head west. That done, try to head west. And then, travel west. With that done, lift the coin from the floor of the pantry. And if you do that, you're the winner!".
