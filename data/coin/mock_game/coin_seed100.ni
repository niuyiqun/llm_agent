...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_6 are rooms.
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You are in a steam room. A normal kind of place. Let's see what's in here.
...
The vault part 0 is some text that varies. The vault part 0 is "You are in a vault. An ordinary kind of place. You start to take note of what's in the room.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You arrive in a cookery. A standard kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A typical one. You begin looking for stuff.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_6 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_6 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go south / go west / go north / go north / go east / go north / go west / go west / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First, it would be fantastic if you could attempt to take a trip west. And then, venture north. Once you do that, move east. T".
The objective part 1 is some text that varies. The objective part 1 is "hen, head south. And then, attempt to go west. And then, attempt to move north. Then, travel north. Okay, and then, attempt to go to the east. That done, try to take a trip north. Next, go west. If yo".
The objective part 2 is some text that varies. The objective part 2 is "u can succeed at that, make an attempt to travel west. With that over with, move west. And then, move west. After that, travel west. That done, retrieve the coin from the floor of the dish-pit. Alrigh".
