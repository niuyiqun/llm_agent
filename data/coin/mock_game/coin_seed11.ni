...
The r_10 and the r_11 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_13 and the r_14 and the r_6 and the r_9 are rooms.

Understand "sauna" as r_10.
The internal name of r_10 is "sauna".
The printed name of r_10 is "-= Sauna =-".
The sauna part 0 is some text that varies. The sauna part 0 is "You arrive in a sauna. A standard kind of place. You begin to take stock of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. An ordinary kind of place. I guess you better just go and list everything you see here.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You find yourself in a steam room. A standard kind of place. You start to take note of what's in the room.
...
The r_10 and the r_11 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_13 and the r_14 and the r_6 and the r_9 are rooms.
The r_10 and the r_11 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_0 and the r_13 and the r_14 and the r_6 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go west / go west / go north / go north / go east / go south / go south / go west / go west / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First off, if it's not too much trouble, I need you to attempt to move south. With that done, attempt to go east. And then, take a trip north. Once".
The objective part 1 is some text that varies. The objective part 1 is " you do that, make an effort to travel west. With that accomplished, take a trip west. Okay, and then, go to the north. And then, make an effort to move north. Then, try to travel east. After that, ve".
The objective part 2 is some text that varies. The objective part 2 is "nture south. If you can get around to doing that, travel south. And then, go west. And then, attempt to travel west. And then, venture north. With that done, go north. Next, retrieve the coin from the".
The objective part 3 is some text that varies. The objective part 3 is " floor of the bedroom. That's it!".
