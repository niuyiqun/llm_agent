...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_14 are rooms.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You find yourself in a normal kind of place. That is to say, you're in a recreation zone.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "Wow! You're in a laundry place.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You find yourself in a scullery. An usual kind of place. You begin to take stock of what's in the room.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_14 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_14 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go east / go south / go east / go north / go west / go west / go north / go west / go south / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, venture west. Then, try to travel north. After that, make an attempt to head east. Once yo".
The objective part 1 is some text that varies. The objective part 1 is "u finish that, make an effort to venture east. Then, venture south. After that, go to the east. If you can manage that, go to the north. After that, try to move west. With that done, make an attempt t".
The objective part 2 is some text that varies. The objective part 2 is "o take a trip west. Then, venture north. With that accomplished, go west. Then, take a trip south. And then, travel east. With that done, travel south. That done, recover the coin from the floor of th".
The objective part 3 is some text that varies. The objective part 3 is "e scullery. Once that's all handled, you can stop!".
