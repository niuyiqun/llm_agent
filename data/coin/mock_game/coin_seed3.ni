...
The r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "You have walked into the most typical of all possible basements.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You are in a laundromat. A standard one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The bar part 0 is some text that varies. The bar part 0 is "You've just sauntered into a bar. You begin looking for stuff.
...
The playroom part 0 is some text that varies. The playroom part 0 is "Well I'll be, you are in a place we're calling a playroom. The room is well lit.
...
The studio part 0 is some text that varies. The studio part 0 is "You have stumbled into the most typical of all possible studios.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Wow! You're in a steam room. Let's see what's in here.
...
The r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are rooms.
The r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go south / go west / go west / go south / go south / go south / go west / go south / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First step, venture north. And then, take a trip east. Then, move east. Afte".
The objective part 1 is some text that varies. The objective part 1 is "r that, make an effort to take a trip south. Okay, and then, take a trip west. And then, make an attempt to take a trip west. And then, make an effort to head south. With that done, make an attempt to".
The objective part 2 is some text that varies. The objective part 2 is " go to the south. If you can succeed at that, attempt to head south. With that done, make an attempt to venture west. After that, move south. Okay, and then, travel east. Then, travel south. And then,".
The objective part 3 is some text that varies. The objective part 3 is " move east. With that done, lift the coin from the floor of the kitchenette. And once you've done that, you win!".
