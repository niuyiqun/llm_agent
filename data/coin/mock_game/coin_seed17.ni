...
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are rooms.
...
The scullery part 0 is some text that varies. The scullery part 0 is "If you're wondering why everything seems so ordinary all of a sudden, it's because you've just shown up in the scullery. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are rooms.
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_2 and the r_3 are privately-named.
...
Test quest0_0 with "go east / go south / go south / go south / go east / go south / go west / go south / go east / go north / go east / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to make an attempt to head east. Following that, make an attempt to venture south. Then, make an ".
The objective part 1 is some text that varies. The objective part 1 is "effort to take a trip south. And then, make an effort to travel south. If you can manage that, attempt to go east. Then, go to the south. Following that, attempt to take a trip west. And then, attempt".
The objective part 2 is some text that varies. The objective part 2 is " to venture south. Next, travel east. And then, make an effort to move north. If you can finish that, venture east. And then, venture east. Then, make an attempt to take a trip north. Then, travel wes".
The objective part 3 is some text that varies. The objective part 3 is "t. And then, lift the coin from the floor of the cookery. Alright, thanks!".
