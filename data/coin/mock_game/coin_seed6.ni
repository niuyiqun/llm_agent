...
The r_12 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_10 and the r_11 and the r_14 and the r_8 and the r_9 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well, here we are in the cookhouse. You begin to take stock of what's in the room.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You are in a recreation zone. An ordinary one. You start to take note of what's in the room.
...
The office part 0 is some text that varies. The office part 0 is "Look around you. Take it all in. It's not every day someone gets to be in an office. You begin to take stock of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in an usual kind of place. That is to say, you're in a study. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The cookery part 0 is some text that varies. The cookery part 0 is "Look at that notice! What does it say? It says Welcome to the cookery? Well that's cool.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "Wow! You're in a dish-pit.
...
The garage part 0 is some text that varies. The garage part 0 is "You arrive in a typical kind of place. That is to say, you're in a garage.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You arrive in a playroom. A typical one. You start to take note of what's in the room.
...
The r_12 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_10 and the r_11 and the r_14 and the r_8 and the r_9 are rooms.
The r_12 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_5 and the r_7 and the r_0 and the r_10 and the r_11 and the r_14 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go south / go east / go north / go east / go east / go north / go north / go north / go north / go north / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another exciting game of TextWorld! Here is how to play! First, it would be good if you could make an attempt to take a trip south. With that done, make an effort to venture east. Once you ".
The objective part 1 is some text that varies. The objective part 1 is "get around to doing that, go south. And then, go to the east. Then, make an effort to head north. And then, head east. And then, venture east. That done, take a trip north. Next, attempt to venture no".
The objective part 2 is some text that varies. The objective part 2 is "rth. After that, attempt to go north. After that, go north. If you can get around to doing that, move north. Next, venture west. If you can finish that, make an attempt to head north. And then, lift t".
The objective part 3 is some text that varies. The objective part 3 is "he coin from the floor of the dish-pit. That's it!".
