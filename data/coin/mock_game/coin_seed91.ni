...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 are rooms.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You are in a kitchenette. A normal one. The room is well lit.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You find yourself in a restroom. A normal kind of place. You begin looking for stuff.
...
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 are rooms.
The r_1 and the r_0 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 are privately-named.
...
Test quest0_0 with "go east / go east / go south / go west / go south / go west / go north / go east / go east / go north / go north / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your first objective is to venture east. If you can manage that, make an effort to go to the east".
The objective part 1 is some text that varies. The objective part 1 is ". With that over with, try to venture south. And then, go to the west. And then, make an effort to go south. Then, make an attempt to venture west. And then, travel north. If you can accomplish that, ".
The objective part 2 is some text that varies. The objective part 2 is "attempt to venture east. Okay, and then, move east. With that done, go north. Okay, and then, go to the north. With that accomplished, try to move north. And then, try to go to the north. And then, he".
The objective part 3 is some text that varies. The objective part 3 is "ad north. Following that, pick up the coin from the floor of the study. And if you do that, you're the winner!".
