...
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_4 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "Well, here we are in a launderette. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The office part 0 is some text that varies. The office part 0 is "Okay, so you're in an office, cool, but is it typical? You better believe it is. You start to take note of what's in the room.
...
The cellar part 0 is some text that varies. The cellar part 0 is "A laminated notice tells you that you are now in the cellar.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in a canteen. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The scullery part 0 is some text that varies. The scullery part 0 is "Well, here we are in a scullery. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_4 are rooms.
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_4 are privately-named.
...
Test quest0_0 with "go east / go south / go west / go north / go north / go east / go east / go south / go west / go south / go west / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, attempt to move east. Okay, and then, go south. And then, move west. Then, make an effort ".
The objective part 1 is some text that varies. The objective part 1 is "to go to the north. If you can do that, take a trip north. Once you accomplish that, attempt to go to the east. After that, take a trip east. With that accomplished, make an attempt to go south. If yo".
The objective part 2 is some text that varies. The objective part 2 is "u can get through with that, try to move west. Okay, and then, go south. Then, move west. That done, go south. With that done, head south. Once you do that, make an effort to head south. Next, pick-up".
The objective part 3 is some text that varies. The objective part 3 is " the coin from the floor of the study. That's it!".
