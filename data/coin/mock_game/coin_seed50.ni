...
The r_11 and the r_10 and the r_13 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_14 and the r_9 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "I am honoured to announce that you are now in the launderette.
...
The workshop part 0 is some text that varies. The workshop part 0 is "I am honoured to announce that you are now in the workshop. You can barely contain your excitement.
...
The washroom part 0 is some text that varies. The washroom part 0 is "This washroom you have just entered is definitely ordinary.
...
The r_11 and the r_10 and the r_13 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_14 and the r_9 are rooms.
The r_11 and the r_10 and the r_13 and the r_12 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_14 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go north / go west / go west / go south / go west / go south / go south / go east / go south / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, try to move north. Once you finish that, make an effort to venture east. And then, make an e".
The objective part 1 is some text that varies. The objective part 1 is "ffort to head east. And then, try to head north. Okay, and then, attempt to go west. Once you finish that, make an effort to move west. And then, go to the south. And then, make an attempt to move wes".
The objective part 2 is some text that varies. The objective part 2 is "t. Then, take a trip south. And then, make an attempt to go south. And then, go east. That done, travel south. And then, make an effort to go east. Next, travel north. And then, lift the coin from the".
The objective part 3 is some text that varies. The objective part 3 is " floor of the study. And once you've done that, you win!".
