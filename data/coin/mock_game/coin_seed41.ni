...
The r_1 and the r_2 and the r_11 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You have stumbled into a bedroom. Not the bedroom you'd expect. No, this is a bedroom. Okay, just remember what you're here to do, and everything will go great.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. A normal one. You can barely contain your excitement.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Well, here we are in a steam room. I guess you better just go and list everything you see here.
...
The bar part 0 is some text that varies. The bar part 0 is "You've just shown up in a bar. You can barely contain your excitement.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A normal one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The cookery part 0 is some text that varies. The cookery part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cookery. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_1 and the r_2 and the r_11 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are rooms.
The r_1 and the r_2 and the r_11 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_0 and the r_7 and the r_8 are privately-named.
...
Test quest0_0 with "go south / go west / go south / go west / go south / go east / go south / go south / go south / go west / go north / go west / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First stop, try to take a trip south. Okay, and then, take a trip west. That done, make an effort to head south. And t".
The objective part 1 is some text that varies. The objective part 1 is "hen, try to go west. Once you finish that, venture south. Okay, and then, go to the east. Then, go south. Next, take a trip south. Okay, and then, try to travel south. After that, go west. Okay, and t".
The objective part 2 is some text that varies. The objective part 2 is "hen, go to the north. With that done, make an effort to head west. Then, move south. With that over with, make an effort to travel east. Then, retrieve the coin from the floor of the basement. Alright".
The objective part 3 is some text that varies. The objective part 3 is ", thanks!".
