...
The r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_1 and the r_2 and the r_7 and the r_8 and the r_9 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You're now in the laundromat. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You find yourself in a laundry place. A normal one. You can barely contain your excitement.
...
The r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_1 and the r_2 and the r_7 and the r_8 and the r_9 are rooms.
The r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_1 and the r_2 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go north / go north / go west / go south / go west / go north / go north / go north / go north / go east / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is your task for today. First, it would be good if you could try to venture north. With that done,".
The objective part 1 is some text that varies. The objective part 1 is " make an effort to go to the north. Okay, and then, move north. And then, make an attempt to head west. With that done, head south. Then, move west. If you can succeed at that, go to the north. After ".
The objective part 2 is some text that varies. The objective part 2 is "that, head north. That done, attempt to travel north. Then, make an effort to go north. After that, make an attempt to head east. And then, make an effort to move east. Then, go south. Once you finish".
The objective part 3 is some text that varies. The objective part 3 is " that, move east. And then, retrieve the coin from the floor of the laundromat. And once you've done that, you win!".
