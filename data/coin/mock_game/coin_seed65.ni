...
The r_10 and the r_9 and the r_12 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_0 and the r_1 and the r_4 and the r_7 are rooms.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You make a grand eccentric entrance into a dish-pit. You start to take note of what's in the room.
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. A normal one. I guess you better just go and list everything you see here.
...
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. An ordinary kind of place. The room is well lit.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. An ordinary kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just walked into a laundromat. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_10 and the r_9 and the r_12 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_0 and the r_1 and the r_4 and the r_7 are rooms.
The r_10 and the r_9 and the r_12 and the r_11 and the r_14 and the r_13 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_0 and the r_1 and the r_4 and the r_7 are privately-named.
...
Test quest0_0 with "go north / go north / go east / go south / go south / go west / go north / go north / go east / go east / go south / go east / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to move north. Then, attempt to travel north. Then, take a trip east. Then".
The objective part 1 is some text that varies. The objective part 1 is ", take a trip south. With that done, take a trip south. And then, head west. Okay, and then, take a trip north. With that over with, make an attempt to head north. Then, go to the east. After that, at".
The objective part 2 is some text that varies. The objective part 2 is "tempt to venture east. Then, make an attempt to move south. After that, make an effort to move east. Once you finish that, go to the north. Then, make an effort to head east. Then, retrieve the coin f".
The objective part 3 is some text that varies. The objective part 3 is "rom the floor of the dish-pit. And if you do that, you're the winner!".
