...
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_14 and the r_2 and the r_9 are rooms.
...
The closet part 0 is some text that varies. The closet part 0 is "Welcome to the closet. You start to take note of what's in the room.
...
The sauna part 0 is some text that varies. The sauna part 0 is "Of every sauna you could have walked into, you had to saunter into a standard one.
...
The shower part 0 is some text that varies. The shower part 0 is "Ah, the shower. This is some kind of shower, really great standard vibes in this place, a wonderful standard atmosphere. You start to take note of what's in the room.
...
The study part 0 is some text that varies. The study part 0 is "Guess what, you are in the place we're calling the study. Let's see what's in here.
...
The salon part 0 is some text that varies. The salon part 0 is "You have moved into a salon. Not the salon you'd expect. No, this is a salon. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You find yourself in a cookhouse. A typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You are in a chamber. A normal kind of place. I guess you better just go and list everything you see here.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You've entered a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the scullery.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You are in a launderette. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bar part 0 is some text that varies. The bar part 0 is "You've just shown up in a bar. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_14 and the r_2 and the r_9 are rooms.
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_14 and the r_2 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go north / go north / go west / go north / go east / go south / go west / go south / go south / go east / go south / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another profound round of TextWorld! First stop, travel east. Okay, and then, travel north. And then, go north. Once you accomplish that, make an effort to go west. And then, attempt to ven".
The objective part 1 is some text that varies. The objective part 1 is "ture north. With that done, attempt to go east. Following that, go to the south. Then, venture west. If you can do that, venture south. And then, go south. That done, attempt to head east. Following t".
The objective part 2 is some text that varies. The objective part 2 is "hat, go south. And then, move east. Then, head south. And then, lift the coin from the floor of the spare room. That's it!".
