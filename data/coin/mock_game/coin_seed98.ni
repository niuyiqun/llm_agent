...
The r_1 and the r_2 and the r_11 and the r_12 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You arrive in a lounge. A normal kind of place. Let's see what's in here.
...
The study part 0 is some text that varies. The study part 0 is "Guess what, you are in a place we're calling a study. You begin to take stock of what's in the room.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You find yourself in a launderette. An usual kind of place. You begin to take stock of what's here.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You are in a restroom. It seems to be pretty normal here.
...
The studio part 0 is some text that varies. The studio part 0 is "You've just shown up in a studio. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_1 and the r_2 and the r_11 and the r_12 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
The r_1 and the r_2 and the r_11 and the r_12 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go west / go south / go west / go south / go south / go south / go south / go south / go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, try to travel north. Following that, try to take a trip west. Following that, try to move north. And then, go to".
The objective part 1 is some text that varies. The objective part 1 is " the west. Next, go to the south. With that over with, move west. Next, attempt to venture south. Okay, and then, make an effort to venture south. That done, go south. If you can manage that, make an ".
The objective part 2 is some text that varies. The objective part 2 is "attempt to head south. And then, go south. After that, take a trip west. And then, make an attempt to travel south. Then, go south. Then, pick up the coin from the floor of the restroom. Alright, than".
