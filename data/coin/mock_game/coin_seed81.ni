...
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_10 and the r_14 and the r_7 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You're now in a launderette. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You've just walked into a dish-pit. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The shower part 0 is some text that varies. The shower part 0 is "Guess what, you are in a place we're calling a shower. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You've just walked into a laundromat. You start to take note of what's in the room.
...
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_10 and the r_14 and the r_7 are rooms.
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_9 and the r_8 and the r_0 and the r_10 and the r_14 and the r_7 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go west / go north / go west / go north / go north / go east / go south / go south / go east / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! Here is how to play! First off, attempt to move south. After that, try to take a trip east. With that done, head north. Then, try to go to the west. O".
The objective part 1 is some text that varies. The objective part 1 is "nce you accomplish that, head north. That done, make an effort to take a trip west. With that over with, head north. If you can get around to doing that, move north. After that, travel east. Once you ".
The objective part 2 is some text that varies. The objective part 2 is "finish that, make an effort to go to the south. Then, head south. Then, take a trip east. Then, take a trip east. With that done, make an attempt to move north. And then, lift the coin from the floor ".
The objective part 3 is some text that varies. The objective part 3 is "of the laundromat. That's it!".
