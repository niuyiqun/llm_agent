...
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_11 and the r_14 and the r_2 and the r_7 and the r_8 are rooms.

Understand "garage" as r_0.
The internal name of r_0 is "garage".
The printed name of r_0 is "-= Garage =-".
The garage part 0 is some text that varies. The garage part 0 is "You've just shown up in a garage. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The vault part 0 is some text that varies. The vault part 0 is "Look at that placard! What does it say? It says Welcome to the vault? Well that's cool.
...
The closet part 0 is some text that varies. The closet part 0 is "You are in a closet. An ordinary kind of place. You start to take note of what's in the room.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Of every steam room you could have walked into, you had to come round an usual one.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You make a grand eccentric entrance into a lounge. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_11 and the r_14 and the r_2 and the r_7 and the r_8 are rooms.
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_9 and the r_10 and the r_11 and the r_14 and the r_2 and the r_7 and the r_8 are privately-named.
...
Test quest0_0 with "go west / go south / go south / go west / go south / go east / go north / go north / go north / go west / go south / go south / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to take a trip west. Then, go to the south. Once you manage that, attemp".
The objective part 1 is some text that varies. The objective part 1 is "t to head south. Then, make an effort to take a trip west. Once you do that, go south. Then, make an effort to venture east. After that, head north. And then, make an attempt to head north. If you can".
The objective part 2 is some text that varies. The objective part 2 is " succeed at that, go to the north. And then, attempt to head west. Then, go south. Next, move south. With that over with, go east. After that, go to the north. After that, retrieve the coin from the f".
The objective part 3 is some text that varies. The objective part 3 is "loor of the steam room. Got that? Good!".
