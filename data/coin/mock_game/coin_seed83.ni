...
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_14 and the r_7 are rooms.

Understand "spare room" as r_1.
The internal name of r_1 is "spare room".
The printed name of r_1 is "-= Spare Room =-".
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. An ordinary kind of place. I guess you better just go and list everything you see here.
...
The study part 0 is some text that varies. The study part 0 is "You arrive in a study. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The cookery part 0 is some text that varies. The cookery part 0 is "Ah, the cookery. This is some kind of cookery, really great normal vibes in this place, a wonderful normal atmosphere. And now, well, you're in it. You begin to take stock of what's here.
...
The basement part 0 is some text that varies. The basement part 0 is "You find yourself in a basement. You can barely contain your excitement.
...
The garage part 0 is some text that varies. The garage part 0 is "I just think it's awesome that you're in a garage now. Let's see what's in here.
...
The office part 0 is some text that varies. The office part 0 is "You find yourself in an office. A typical kind of place. You start to take note of what's in the room.
...
The pantry part 0 is some text that varies. The pantry part 0 is "Okay, so you're in a pantry, cool, but is it usual? You better believe it is. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The cellar part 0 is some text that varies. The cellar part 0 is "You arrive in a typical kind of place. That is to say, you're in a cellar. You begin to take stock of what's here.
...
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_14 and the r_7 are rooms.
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_6 and the r_5 and the r_8 and the r_9 and the r_0 and the r_14 and the r_7 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go west / go north / go east / go north / go north / go west / go north / go east / go south / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing episode of TextWorld! Here is your task for today. First stop, go to the north. Then, make an attempt to travel west. With that accomplished, head north. That done,".
The objective part 1 is some text that varies. The objective part 1 is " make an attempt to move west. With that accomplished, attempt to go to the north. Then, make an attempt to travel east. Once you do that, head north. Then, take a trip north. Next, head west. Then, t".
The objective part 2 is some text that varies. The objective part 2 is "ake a trip north. With that done, attempt to move east. Following that, make an attempt to travel south. And then, make an effort to go to the east. After that, make an attempt to venture north. And t".
The objective part 3 is some text that varies. The objective part 3 is "hen, lift the coin from the floor of the cubicle. Once that's all handled, you can stop!".
