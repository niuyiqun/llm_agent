...
The r_10 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 and the r_5 and the r_6 are rooms.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You have entered a spare room. Not the spare room you'd expect. No, this is a spare room.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a bedchamber. An usual kind of place. I guess you better just go and list everything you see here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "Well, here we are in a launderette. You begin to take stock of what's here.
...
The r_10 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 and the r_5 and the r_6 are rooms.
The r_10 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 and the r_5 and the r_6 are privately-named.
...
Test quest0_0 with "go north / go east / go south / go west / go south / go south / go south / go west / go north / go west / go west / go north / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting session of TextWorld! Here is your task for today. First thing I need you to do is to venture north. Then, venture east. After that, make an attempt to go south. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, make an attempt to move west. Then, travel south. After that, make an effort to go south. And then, head south. With that accomplished, go to the west. After that, attempt to venture north. Then,".
The objective part 2 is some text that varies. The objective part 2 is " make an effort to travel west. If you can get through with that, head west. With that accomplished, go to the north. After that, attempt to take a trip north. With that done, make an attempt to ventu".
The objective part 3 is some text that varies. The objective part 3 is "re west. Then, pick-up the coin from the floor of the bedchamber. Once that's all handled, you can stop!".
