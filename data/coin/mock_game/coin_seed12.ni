...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_12 and the r_6 are rooms.
...
The closet part 0 is some text that varies. The closet part 0 is "Okay, so you're in a closet, cool, but is it typical? You better believe it is. Let's see what's in here.
...
The office part 0 is some text that varies. The office part 0 is "You are in an office. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
Understand "still cubicle" as r_9.
The internal name of r_9 is "still cubicle".
The printed name of r_9 is "-= Still Cubicle =-".
The still cubicle part 0 is some text that varies. The still cubicle part 0 is "You are in a cubicle. A still one. You begin to take stock of what's in the room.



There is an unguarded exit to the north. You need an unguarded exit? You should try going west.".
The description of r_9 is "[still cubicle part 0]".

The r_10 is mapped west of r_9.
The r_8 is mapped north of r_9.
Understand "serious cubicle" as r_12.
The internal name of r_12 is "serious cubicle".
The printed name of r_12 is "-= Serious Cubicle =-".
The serious cubicle part 0 is some text that varies. The serious cubicle part 0 is "You've just shown up in a serious cubicle. You begin to take stock of what's in the room.
...
The description of r_12 is "[serious cubicle part 0]".
...
The austere workshop part 0 is some text that varies. The austere workshop part 0 is "You're now in an austere workshop. You decide to start listing off everything you see in the room, as if you were in a text adventure.



There is an exit to the north. Don't worry, it is unguarded. You need an unguarded exit? You should try going south.".
The description of r_6 is "[austere workshop part 0]".
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_12 and the r_6 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_8 and the r_7 and the r_9 and the r_12 and the r_6 are privately-named.
...
Test quest0_0 with "go west / go west / go west / go north / go west / go south / go south / go east / go south / go west / go west / go south / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, go to the west. Then, make an attempt to move west. Next, venture west. And then, venture no".
The objective part 1 is some text that varies. The objective part 1 is "rth. If you can finish that, attempt to go west. And then, venture south. And then, travel south. Then, attempt to venture east. Next, make an attempt to go south. And then, venture west. After that, ".
The objective part 2 is some text that varies. The objective part 2 is "attempt to go to the west. Then, make an effort to venture south. And then, make an effort to travel south. Then, try to go to the west. And then, pick up the coin from the floor of the cubicle. That'".
