...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A standard one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The spare room part 0 is some text that varies. The spare room part 0 is "You find yourself in a spare room. An ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You make a grand eccentric entrance into a workshop. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go west / go west / go west / go north / go west / go west / go north / go west / go north / go north / go west / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First of all, you could, like, try to take a trip west. Following that, go to the west. And".
The objective part 1 is some text that varies. The objective part 1 is " then, try to head west. Following that, go north. And then, attempt to take a trip west. If you can do that, make an attempt to go to the west. Following that, try to go to the north. With that accom".
The objective part 2 is some text that varies. The objective part 2 is "plished, go to the west. After that, head north. That done, head north. With that done, make an effort to travel west. If you can finish that, attempt to travel west. Then, attempt to head south. And ".
The objective part 3 is some text that varies. The objective part 3 is "then, make an effort to head west. Next, lift the coin from the floor of the kitchen. And once you've done that, you win!".
