...
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "Guess what, you are in the place we're calling the basement. You begin to take stock of what's in the room.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a bedroom. A typical kind of place. Let's see what's in here.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Look at you, bigshot, walking into a kitchen like it isn't some huge deal. I guess you better just go and list everything you see here.
...
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.
The r_1 and the r_0 and the r_10 and the r_11 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_12 and the r_13 and the r_14 and the r_3 are privately-named.
...
Test quest0_0 with "go east / go east / go south / go south / go west / go south / go east / go east / go south / go west / go west / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Here is your task for today. First of all, you could, like, go east. After that, attempt to take a trip east. And then, move south. With that accomplis".
The objective part 1 is some text that varies. The objective part 1 is "hed, try to venture south. And then, make an effort to take a trip west. Then, go south. With that over with, attempt to take a trip east. With that done, try to travel east. Then, try to take a trip ".
The objective part 2 is some text that varies. The objective part 2 is "south. Next, attempt to go west. And then, attempt to go to the west. And then, attempt to move north. With that over with, make an attempt to go north. Following that, take a trip north. After that, ".
The objective part 3 is some text that varies. The objective part 3 is "pick-up the coin from the floor of the kitchen. That's it!".
