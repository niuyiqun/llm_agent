...
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are rooms.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You've just sauntered into a washroom. You begin to take stock of what's in the room.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You are in an usual kind of place. That is to say, you're in a canteen.
...
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are rooms.
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go east / go east / go east / go east / go north / go east / go south / go west / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First thing I need you to do is to move north. And then, try to go w".
The objective part 1 is some text that varies. The objective part 1 is "est. And then, head north. With that over with, take a trip east. Then, make an effort to take a trip east. Then, make an attempt to venture east. Then, move east. Following that, make an attempt to g".
The objective part 2 is some text that varies. The objective part 2 is "o north. Okay, and then, make an attempt to go to the east. If you can manage that, take a trip south. And then, make an attempt to go west. With that accomplished, head west. Then, venture south. And".
The objective part 3 is some text that varies. The objective part 3 is " then, go to the west. With that over with, lift the coin from the floor of the studio. Got that? Good!".
