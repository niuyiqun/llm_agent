...
The r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are rooms.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You find yourself in a laundry place. A normal one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You've entered a cubicle. You can barely contain your excitement.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "This might come as a shock to you, but you've just fallen into a dish-pit.
...
The spare room part 0 is some text that varies. The spare room part 0 is "I just think it's awesome that you're in a spare room now. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've entered a chamber. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The salon part 0 is some text that varies. The salon part 0 is "You've just shown up in a salon. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The restroom part 0 is some text that varies. The restroom part 0 is "You've just walked into a restroom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are rooms.
The r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go north / go north / go north / go west / go west / go west / go south / go south / go south / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make an effort to head north. With that over with, make an effort to go east. And then, go t".
The objective part 1 is some text that varies. The objective part 1 is "o the east. Okay, and then, attempt to travel north. And then, try to head north. And then, make an attempt to head north. If you can get through with that, go to the west. And then, make an effort to".
The objective part 2 is some text that varies. The objective part 2 is " go to the west. That done, make an attempt to go west. With that accomplished, move south. With that done, try to go south. And then, make an attempt to take a trip south. With that accomplished, tak".
The objective part 3 is some text that varies. The objective part 3 is "e a trip west. After that, take a trip north. After that, recover the coin from the floor of the cellar. Once that's all handled, you can stop!".
