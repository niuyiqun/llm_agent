...
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_14 and the r_6 and the r_7 are rooms.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You're now in the spare room. You begin to take stock of what's here.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. A normal kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The chamber part 0 is some text that varies. The chamber part 0 is "Well, here we are in the chamber. I guess you better just go and list everything you see here.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You're now in the canteen. You begin looking for stuff.
...
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_14 and the r_6 and the r_7 are rooms.
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_14 and the r_6 and the r_7 are privately-named.
...
Test quest0_0 with "go east / go east / go north / go west / go west / go south / go south / go south / go west / go west / go west / go north / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, you could, like, try to take a trip east. If you can get aroun".
The objective part 1 is some text that varies. The objective part 1 is "d to doing that, try to move east. And then, make an effort to take a trip north. And then, attempt to go west. Once you accomplish that, take a trip west. Then, make an effort to take a trip south. T".
The objective part 2 is some text that varies. The objective part 2 is "hen, move south. Okay, and then, travel south. Okay, and then, go west. Then, travel west. That done, make an attempt to move west. After that, make an attempt to venture north. Okay, and then, make a".
The objective part 3 is some text that varies. The objective part 3 is "n attempt to take a trip west. With that over with, go to the north. After that, pick up the coin from the floor of the kitchen. Once that's all handled, you can stop!".
