...
The r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_12 and the r_13 and the r_14 and the r_4 are rooms.

Understand "laundry place" as r_10.
The internal name of r_10 is "laundry place".
The printed name of r_10 is "-= Laundry Place =-".
The laundry place part 0 is some text that varies. The laundry place part 0 is "You are in a laundry place. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You've just shown up in a steam room. Okay, just remember what you're here to do, and everything will go great.
...
The canteen part 0 is some text that varies. The canteen part 0 is "Well how about that, you are in the place we're calling the canteen. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The lounge part 0 is some text that varies. The lounge part 0 is "You are in a lounge. An usual kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The parlor part 0 is some text that varies. The parlor part 0 is "You're not going to believe this, but you've just entered a parlor.
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. An ordinary one. You begin to take stock of what's in the room.
...
The r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_12 and the r_13 and the r_14 and the r_4 are rooms.
The r_10 and the r_11 and the r_2 and the r_3 and the r_6 and the r_5 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 and the r_12 and the r_13 and the r_14 and the r_4 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go south / go south / go east / go east / go south / go east / go south / go west / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could make an effort to venture south. With that done, go to the south. ".
The objective part 1 is some text that varies. The objective part 1 is "Once you do that, make an attempt to move west. And then, travel south. And then, try to head south. Once you succeed at that, try to travel east. Then, make an attempt to venture east. Then, go to th".
The objective part 2 is some text that varies. The objective part 2 is "e south. Then, travel east. Then, go to the south. Then, venture west. That done, make an attempt to head north. And then, go to the north. And then, take a trip north. After that, lift the coin from ".
The objective part 3 is some text that varies. The objective part 3 is "the floor of the scullery. And once you've done that, you win!".
