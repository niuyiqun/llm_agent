...
The r_1 and the r_0 and the r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 are rooms.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The parlor part 0 is some text that varies. The parlor part 0 is "You are in a parlor. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in an ordinary kind of place. That is to say, you're in a bedroom. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a typical kind of place. That is to say, you're in a laundromat. You begin to take stock of what's here.
...
The r_1 and the r_0 and the r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 are rooms.
The r_1 and the r_0 and the r_12 and the r_11 and the r_14 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 are privately-named.
...
Test quest0_0 with "go east / go east / go north / go east / go north / go west / go south / go west / go west / go north / go north / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, venture east. Then, make an attempt to travel east. With that over with, make an attempt to v".
The objective part 1 is some text that varies. The objective part 1 is "enture north. Then, travel east. Following that, take a trip north. Following that, make an attempt to take a trip west. With that accomplished, venture south. Then, go west. If you can succeed at tha".
The objective part 2 is some text that varies. The objective part 2 is "t, move west. After that, go north. After that, attempt to move north. And then, head east. And then, venture south. And then, travel east. And then, pick up the coin from the floor of the canteen. Th".
