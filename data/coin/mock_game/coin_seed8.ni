...
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_5 are rooms.
...
The attic part 0 is some text that varies. The attic part 0 is "You are in an attic. An ordinary one. You start to take note of what's in the room.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You are in a recreation zone. An usual one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The playroom part 0 is some text that varies. The playroom part 0 is "I am honoured to announce that you are now in the playroom. You can barely contain your excitement.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You arrive in a laundry place. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. A standard one. The room is well lit.
...
The closet part 0 is some text that varies. The closet part 0 is "Ah, the closet. This is some kind of closet, really great standard vibes in this place, a wonderful standard atmosphere. I guess you better just go and list everything you see here.
...
The shower part 0 is some text that varies. The shower part 0 is "This might come as a shock to you, but you've just fallen into a shower. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_5 are rooms.
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_5 are privately-named.
...
Test quest0_0 with "go east / go south / go east / go east / go north / go north / go east / go north / go west / go south / go south / go east / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! First step, go to the east. Following that, attempt to go south. After that, take a trip east. Then, attempt to ".
The objective part 1 is some text that varies. The objective part 1 is "move east. Okay, and then, make an attempt to go north. Once you manage that, make an attempt to go to the north. After that, move east. Then, venture north. Then, take a trip west. With that accompli".
The objective part 2 is some text that varies. The objective part 2 is "shed, make an attempt to head south. That done, take a trip south. Then, try to move east. And then, try to head south. That done, attempt to take a trip west. Then, pick up the coin from the floor of".
The objective part 3 is some text that varies. The objective part 3 is " the bedroom. Once that's all handled, you can stop!".
