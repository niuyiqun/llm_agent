...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_3 and the r_9 are rooms.

Understand "office" as r_12.
The internal name of r_12 is "office".
The printed name of r_12 is "-= Office =-".
The office part 0 is some text that varies. The office part 0 is "Look around you. Take it all in. It's not every day someone gets to be in an office. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The spare room part 0 is some text that varies. The spare room part 0 is "You are in a spare room. The room is well lit.
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You're now in a steam room. You can barely contain your excitement.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A standard one. The room is well lit.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in an ordinary kind of place. That is to say, you're in a laundromat.
...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in the attic. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Of every bathroom you could have shown up in, you had to come round a typical one.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You are in a kitchenette. A normal kind of place. You can barely contain your excitement.
...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_3 and the r_9 are rooms.
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_3 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go north / go west / go south / go west / go west / go south / go south / go south / go east / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! First off, make an effort to take a trip south. That done, go east. After that, attempt to go north. An".
The objective part 1 is some text that varies. The objective part 1 is "d then, make an effort to go north. Following that, move west. And then, make an effort to move south. Next, go west. With that accomplished, go west. That done, move south. And then, head south. Okay".
The objective part 2 is some text that varies. The objective part 2 is ", and then, make an attempt to take a trip south. And then, make an attempt to take a trip east. Then, make an attempt to go south. Then, make an effort to go to the west. If you can finish that, lift".
The objective part 3 is some text that varies. The objective part 3 is " the coin from the floor of the basement. That's it!".
