...
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_11 are rooms.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've moved into a normal room. Your mind races to think of what kind of room would be normal. And then it hits you. Of course. You're in the bedroom. You begin looking for stuff.
...
The scullery part 0 is some text that varies. The scullery part 0 is "Here we are in the scullery.
...
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_11 are rooms.
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_11 are privately-named.
...
Test quest0_0 with "go south / go west / go west / go south / go west / go south / go west / go west / go south / go west / go south / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, make an attempt to take a trip south. With that accomplished, venture west. Next, make an ".
The objective part 1 is some text that varies. The objective part 1 is "attempt to venture west. Following that, venture south. Then, move west. Next, try to travel south. Following that, venture west. That done, go west. Okay, and then, make an effort to move south. If y".
The objective part 2 is some text that varies. The objective part 2 is "ou can get through with that, make an effort to go to the west. And then, take a trip south. After that, make an attempt to go to the south. Okay, and then, attempt to go west. Next, make an effort to".
The objective part 3 is some text that varies. The objective part 3 is " move west. With that accomplished, pick-up the coin from the floor of the vault. Alright, thanks!".
