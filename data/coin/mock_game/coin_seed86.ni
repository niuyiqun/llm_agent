...
The r_12 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_2 are rooms.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You're now in a sauna. Let's see what's in here.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You are in a scullery. An ordinary kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The closet part 0 is some text that varies. The closet part 0 is "You are in a closet. A normal kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A typical kind of place. You begin to take stock of what's here.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've just walked into a cookhouse. You begin looking for stuff.
...
The r_12 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_2 are rooms.
The r_12 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_2 are privately-named.
...
Test quest0_0 with "go north / go north / go north / go east / go east / go north / go west / go west / go south / go west / go south / go south / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, head north. And then, attempt to go north. And then, take a trip north. W".
The objective part 1 is some text that varies. The objective part 1 is "ith that over with, attempt to take a trip east. Once you get through with that, take a trip east. Then, go north. If you can do that, move west. Then, go to the west. And then, try to travel south. A".
The objective part 2 is some text that varies. The objective part 2 is "nd then, travel west. Then, make an effort to head south. And then, take a trip south. Then, take a trip west. Then, venture south. Then, lift the coin from the floor of the lounge. And if you do that".
