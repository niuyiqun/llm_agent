...
The r_10 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 are rooms.
...
The vault part 0 is some text that varies. The vault part 0 is "You're now in the vault. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The basement part 0 is some text that varies. The basement part 0 is "You arrive in a basement. A standard one. You can barely contain your excitement.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. An ordinary kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The playroom part 0 is some text that varies. The playroom part 0 is "You are in a playroom. A standard kind of place. The room is well lit.
...
The r_10 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 are rooms.
The r_10 and the r_11 and the r_14 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_0 and the r_12 are privately-named.
...
Test quest0_0 with "go south / go east / go east / go east / go south / go east / go east / go north / go west / go north / go west / go north / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound session of TextWorld! Here is how to play! First of all, make an effort to travel south. With that done, take a trip east. Once you finish that, make an attempt to go to".
The objective part 1 is some text that varies. The objective part 1 is " the east. Okay, and then, travel east. Then, go south. Then, make an attempt to go to the east. With that accomplished, go to the east. Once you succeed at that, go to the north. Then, attempt to hea".
The objective part 2 is some text that varies. The objective part 2 is "d west. After that, move north. Then, attempt to travel west. With that over with, make an attempt to venture north. That done, head north. With that accomplished, take a trip east. With that over wit".
The objective part 3 is some text that varies. The objective part 3 is "h, recover the coin from the floor of the cellar. And once you've done that, you win!".
