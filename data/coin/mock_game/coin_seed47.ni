...
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_14 are rooms.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "This might come as a shock to you, but you've just walked into a cubicle.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Ah, the kitchenette. This is some kind of kitchenette, really great typical vibes in this place, a wonderful typical atmosphere. Okay, just remember what you're here to do, and everything will go great.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You arrive in a workshop. A normal one. You start to take note of what's in the room.
...
The silent studio part 0 is some text that varies. The silent studio part 0 is "You find yourself in a studio. A silent kind of place.



You need an unblocked exit? You should try going east. You need an unblocked exit? You should try going south.".
The description of r_10 is "[silent studio part 0]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. An ordinary kind of place. I guess you better just go and list everything you see here.
...
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_14 are rooms.
The r_12 and the r_11 and the r_13 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_14 are privately-named.
...
Test quest0_0 with "go north / go east / go north / go east / go south / go west / go west / go south / go west / go west / go south / go east / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. Your first objective is to make an attempt to move north. That done, ".
The objective part 1 is some text that varies. The objective part 1 is "try to travel east. And then, make an attempt to head north. Then, attempt to venture east. With that done, go south. And then, make an attempt to go to the west. That done, attempt to go to the west.".
The objective part 2 is some text that varies. The objective part 2 is " After that, try to travel south. With that done, make an effort to go west. And then, go to the west. Once you accomplish that, go south. Then, attempt to venture east. Then, make an attempt to take ".
The objective part 3 is some text that varies. The objective part 3 is "a trip east. Following that, make an attempt to venture north. Next, lift the coin from the floor of the basement. Alright, thanks!".
