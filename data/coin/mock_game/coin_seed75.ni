...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've entered a canteen. You begin to take stock of what's in the room.
...
The description of r_13 is "[bathroom part 0]".
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You are in a kitchenette. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just shown up in a chamber. You start to take note of what's in the room.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You've seen better dish-pits, but at least this one seems pretty standard. You can barely contain your excitement.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Well, here we are in a cookhouse. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You've fallen into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the kitchen. You begin to take stock of what's here.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You're now in a parlor. You can barely contain your excitement.
...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_0 and the r_8 and the r_9 are rooms.
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_0 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go east / go south / go east / go east / go east / go north / go north / go north / go west / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First of all, you could, like, go to the south. Then, go to the east. And th".
The objective part 1 is some text that varies. The objective part 1 is "en, make an attempt to head east. And then, travel south. Then, try to go east. That done, try to travel east. Next, head east. Following that, travel north. Okay, and then, venture north. Next, attem".
The objective part 2 is some text that varies. The objective part 2 is "pt to travel north. And then, make an attempt to go to the west. Then, take a trip west. Then, attempt to go north. Okay, and then, make an effort to go west. Then, pick up the coin from the floor of ".
The objective part 3 is some text that varies. The objective part 3 is "the bedchamber. Alright, thanks!".
