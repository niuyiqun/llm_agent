...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 are rooms.
...
The shower part 0 is some text that varies. The shower part 0 is "You are in a shower. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The study part 0 is some text that varies. The study part 0 is "You are in a study. A typical one. Let's see what's in here.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "Guess what, you are in a place we're calling a laundry place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The salon part 0 is some text that varies. The salon part 0 is "Look at you, bigshot, walking into a salon like it isn't some huge deal. I guess you better just go and list everything you see here.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Look at that board! What does it say? It says Welcome to the bedchamber? Well that's cool. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 are privately-named.
...
Test quest0_0 with "go west / go north / go east / go east / go east / go north / go west / go south / go east / go east / go south / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First step, make an attempt to go west. If you can succeed at that, take a trip north. And then, t".
The objective part 1 is some text that varies. The objective part 1 is "ravel east. Then, venture east. Okay, and then, attempt to travel east. Following that, make an attempt to venture north. And then, go west. That done, venture south. Next, try to head east. With that".
The objective part 2 is some text that varies. The objective part 2 is " accomplished, travel east. Then, move south. And then, attempt to go west. Next, move west. With that done, travel west. Then, recover the coin from the floor of the canteen. Alright, thanks!".
