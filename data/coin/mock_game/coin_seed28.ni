...
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
...
The basement part 0 is some text that varies. The basement part 0 is "You find yourself in a basement. A typical one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The garage part 0 is some text that varies. The garage part 0 is "You are in a garage. It seems to be pretty ordinary here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You arrive in a launderette. A standard kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. A standard one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go north / go west / go south / go east / go north / go west / go west / go south / go west / go west / go north / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First off, travel east. With that over with, head north. Then, make an effort to travel west. Then, venture south. And then, make an effort to move east. The".
The objective part 1 is some text that varies. The objective part 1 is "n, move north. That done, make an attempt to go west. With that done, travel west. Once you manage that, try to head south. Then, try to take a trip west. Then, attempt to head west. With that over wi".
The objective part 2 is some text that varies. The objective part 2 is "th, try to head north. Next, attempt to take a trip west. After that, make an effort to go west. Once you accomplish that, lift the coin from the floor of the shower. And if you do that, you're the wi".
The objective part 3 is some text that varies. The objective part 3 is "nner!".
