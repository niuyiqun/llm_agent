...
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 are rooms.

Understand "laundromat" as r_0.
The internal name of r_0 is "laundromat".
The printed name of r_0 is "-= Laundromat =-".
The laundromat part 0 is some text that varies. The laundromat part 0 is "Of every laundromat you could have shown up in, you had to walk into an usual one.
...
The closet part 0 is some text that varies. The closet part 0 is "Guess what, you are in the place we're calling the closet. You begin to take stock of what's in the room.
...
The bar part 0 is some text that varies. The bar part 0 is "You have walked into the most ordinary of all possible bars. You begin to take stock of what's here.
...
The scullery part 0 is some text that varies. The scullery part 0 is "Okay, so you're in a scullery, cool, but is it ordinary? You better believe it is.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You arrive in a cookhouse. A standard kind of place. You start to take note of what's in the room.
...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in an attic. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You've just walked into a washroom. You can barely contain your excitement.



You need an unblocked exit? You should try going north. You need an unblocked exit? You should try going south.".
The description of r_11 is "[washroom part 0]".
...
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 are rooms.
The r_0 and the r_1 and the r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 are privately-named.
...
Test quest0_0 with "go west / go south / go east / go east / go east / go east / go north / go west / go south / go west / go south / go south / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First step, make an effort to head west. With that done, move south. And the".
The objective part 1 is some text that varies. The objective part 1 is "n, head east. And then, move east. Next, make an attempt to venture east. Then, make an attempt to go to the east. Next, make an attempt to go north. And then, attempt to venture west. And then, make ".
The objective part 2 is some text that varies. The objective part 2 is "an attempt to move south. With that done, try to travel west. Next, try to head south. If you can get around to doing that, move south. Okay, and then, take a trip east. If you can finish that, go nor".
The objective part 3 is some text that varies. The objective part 3 is "th. That done, pick up the coin from the floor of the restroom. Once that's all handled, you can stop!".
