...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_14 are rooms.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You are in an ordinary kind of place. That is to say, you're in a scullery.
...
The study part 0 is some text that varies. The study part 0 is "Look at you, bigshot, walking into a study like it isn't some huge deal. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The attic part 0 is some text that varies. The attic part 0 is "You are in an attic. It seems to be pretty usual here. The room is well lit.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You find yourself in a cellar. An usual kind of place. The room is well lit.
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_14 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_3 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_14 are privately-named.
...
Test quest0_0 with "go west / go west / go west / go south / go east / go east / go east / go north / go east / go south / go west / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First step, head west. And then, try to take a trip west. With that done, attempt to go west. Once you a".
The objective part 1 is some text that varies. The objective part 1 is "ccomplish that, make an effort to go to the south. Following that, try to take a trip east. After that, take a trip east. With that accomplished, move east. If you can get around to doing that, travel".
The objective part 2 is some text that varies. The objective part 2 is " north. Next, make an attempt to head east. Then, go south. If you can get through with that, make an attempt to venture west. And then, make an effort to venture north. With that accomplished, try to".
The objective part 3 is some text that varies. The objective part 3 is " head west. Okay, and then, try to go south. With that accomplished, recover the coin from the floor of the restroom. And if you do that, you're the winner!".
