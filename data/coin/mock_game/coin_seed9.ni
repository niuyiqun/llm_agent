...
The r_12 and the r_11 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_6 and the r_7 are rooms.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A standard one. You begin looking for stuff.
...
The playroom part 0 is some text that varies. The playroom part 0 is "Okay, so you're in a playroom, cool, but is it typical? You better believe it is.
...
The r_12 and the r_11 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_6 and the r_7 are rooms.
The r_12 and the r_11 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_6 and the r_7 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go south / go west / go south / go south / go south / go west / go west / go south / go east / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced game of TextWorld! Here is how to play! First step, head south. With that accomplished, make an attempt to travel south. And then, attempt to go west. And then, move sout".
The objective part 1 is some text that varies. The objective part 1 is "h. And then, attempt to head west. That done, make an effort to head south. And then, go to the south. Then, take a trip south. Then, make an effort to go to the west. After that, go to the west. Then".
The objective part 2 is some text that varies. The objective part 2 is ", make an attempt to travel south. After that, try to venture east. And then, travel east. Okay, and then, venture north. Then, pick up the coin from the floor of the bedroom. Alright, thanks!".
