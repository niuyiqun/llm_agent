...
The r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_7 are rooms.
...
The serious studio part 0 is some text that varies. The serious studio part 0 is "You are in a studio. A serious one.



There is an unblocked exit to the north.".
The description of r_0 is "[serious studio part 0]".
...
The serious workshop part 0 is some text that varies. The serious workshop part 0 is "You find yourself in a workshop. A serious one. I guess you better just go and list everything you see here.



There is an exit to the north. Don't worry, it is unblocked. There is an unblocked exit to the south.".
The description of r_7 is "[serious workshop part 0]".
...
The r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_7 are rooms.
The r_13 and the r_12 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 and the r_1 and the r_11 and the r_14 and the r_7 are privately-named.
...
Test quest0_0 with "go north / go north / go east / go east / go south / go west / go north / go north / go west / go west / go south / go south / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Your first objective is to venture north. And then, travel north. And then, venture east. Following that, attempt to go to the east. That done, go to the south. And then, attempt".
The objective part 1 is some text that varies. The objective part 1 is " to go west. Next, venture north. Okay, and then, head north. After that, take a trip west. And then, move west. Then, make an effort to move south. With that done, attempt to take a trip south. Then,".
The objective part 2 is some text that varies. The objective part 2 is " go east. With that accomplished, attempt to go to the north. If you can succeed at that, lift the coin from the floor of the salon. That's it!".
