...
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_14 and the r_2 and the r_7 and the r_8 and the r_9 are rooms.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You are in a bedchamber. A standard kind of place. Let's see what's in here.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You are in a typical kind of place. That is to say, you're in a bedroom. You start to take note of what's in the room.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You have walked into a canteen. Not the canteen you'd expect. No, this is a canteen. You begin to take stock of what's here.
...
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_14 and the r_2 and the r_7 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_11 and the r_10 and the r_12 and the r_13 and the r_3 and the r_4 and the r_6 and the r_5 and the r_14 and the r_2 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go south / go south / go west / go north / go east / go south / go south / go south / go south / go east / go south / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound round of TextWorld! First off, if it's not too much trouble, I need you to try to venture east. Then, venture south. After that, try to go to the south. Once you succeed".
The objective part 1 is some text that varies. The objective part 1 is " at that, try to go west. If you can finish that, try to move north. That done, make an effort to take a trip east. After that, try to take a trip south. Okay, and then, try to travel south. Then, tra".
The objective part 2 is some text that varies. The objective part 2 is "vel south. And then, venture south. After that, attempt to go east. Then, venture south. With that done, travel west. And then, attempt to take a trip north. That done, retrieve the coin from the floo".
The objective part 3 is some text that varies. The objective part 3 is "r of the restroom. And once you've done that, you win!".
