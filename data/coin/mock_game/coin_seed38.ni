...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_14 and the r_8 are rooms.

Understand "dish-pit" as r_0.
The internal name of r_0 is "dish-pit".
The printed name of r_0 is "-= Dish-Pit =-".
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. A standard one. You begin to take stock of what's in the room.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You've seen better saunas, but at least this one seems pretty ordinary.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You find yourself in a scullery. The room is well lit.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You are in a cookhouse. A typical kind of place. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_14 and the r_8 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_14 and the r_8 are privately-named.
...
Test quest0_0 with "go west / go north / go west / go south / go west / go south / go west / go south / go south / go east / go east / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an exciting round of TextWorld? You do! Here is how to play! First off, if it's not too much trouble, I need you to make an effort to take a tr".
The objective part 1 is some text that varies. The objective part 1 is "ip west. Next, go to the north. And then, attempt to venture west. After that, move south. With that done, attempt to move west. That done, head south. And then, travel west. Then, make an attempt to ".
The objective part 2 is some text that varies. The objective part 2 is "take a trip south. Then, try to venture south. With that done, go to the east. And then, make an attempt to take a trip east. Following that, travel north. Then, travel west. And then, make an attempt".
The objective part 3 is some text that varies. The objective part 3 is " to head south. Then, pick-up the coin from the floor of the cookhouse. And once you've done that, you win!".
