...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_5 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 and the r_4 and the r_7 are rooms.
...
The lounge part 0 is some text that varies. The lounge part 0 is "I never took you for the sort of person who would show up in a lounge, but I guess I was wrong. Let's see what's in here.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You arrive in a kitchenette. A normal one. You begin to take stock of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. An usual one. You begin to take stock of what's in the room.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've just walked into a bedchamber. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_5 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 and the r_4 and the r_7 are rooms.
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_1 and the r_5 and the r_6 and the r_8 and the r_9 and the r_0 and the r_3 and the r_4 and the r_7 are privately-named.
...
Test quest0_0 with "go north / go east / go north / go north / go north / go west / go north / go north / go west / go south / go west / go west / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, make an attempt to travel north. If you can get through with that, go to ".
The objective part 1 is some text that varies. The objective part 1 is "the east. Then, go north. Following that, take a trip north. With that done, head north. With that accomplished, make an attempt to head west. With that over with, try to venture north. And then, make".
The objective part 2 is some text that varies. The objective part 2 is " an effort to travel north. That done, go west. Okay, and then, venture south. And then, try to go west. And then, head west. And then, make an effort to head west. With that done, make an attempt to ".
The objective part 3 is some text that varies. The objective part 3 is "travel west. Following that, recover the coin from the floor of the shower. And if you do that, you're the winner!".
