...
The r_1 and the r_0 and the r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_11 and the r_3 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "I just think it's awesome that you're in a cookhouse now. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. A normal kind of place. You begin looking for stuff.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You find yourself in a dish-pit. An ordinary one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a kitchenette. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You have moved into the most typical of all possible laundromats.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You arrive in a scullery. An usual kind of place. You can barely contain your excitement.
...
The r_1 and the r_0 and the r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_11 and the r_3 are rooms.
The r_1 and the r_0 and the r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_11 and the r_3 are privately-named.
...
Test quest0_0 with "go east / go east / go north / go north / go west / go north / go east / go east / go south / go east / go south / go south / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! First of all, you could, like, make an effort to go to the east. Then, attempt to go to the east. And then, attempt to travel north. After that, tr".
The objective part 1 is some text that varies. The objective part 1 is "avel north. Then, make an effort to head west. Then, move north. After that, try to go east. And then, attempt to go east. And then, attempt to move south. With that accomplished, venture east. Then, ".
The objective part 2 is some text that varies. The objective part 2 is "try to travel south. Following that, go south. That done, make an effort to travel east. Okay, and then, travel east. And then, lift the coin from the floor of the basement. And once you've done that,".
