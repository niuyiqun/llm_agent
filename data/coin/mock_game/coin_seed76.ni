...
The r_10 and the r_9 and the r_11 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 are rooms.
...
The garage part 0 is some text that varies. The garage part 0 is "You've just walked into a garage. I guess you better just go and list everything you see here.
...
The basement part 0 is some text that varies. The basement part 0 is "Look at you, bigshot, walking into a basement like it isn't some huge deal. Let's see what's in here.
...
The r_10 and the r_9 and the r_11 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 are rooms.
The r_10 and the r_9 and the r_11 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go west / go west / go north / go east / go east / go south / go east / go east / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First stop, make an attempt to go south. With that accomplished, make an effort to take a trip east. With that accompl".
The objective part 1 is some text that varies. The objective part 1 is "ished, venture north. Then, attempt to head west. After that, travel west. Then, go to the north. With that accomplished, make an effort to travel east. Then, head east. After that, attempt to head so".
The objective part 2 is some text that varies. The objective part 2 is "uth. That done, make an attempt to venture east. That done, make an effort to venture east. Once you get through with that, head south. Then, travel south. Then, move south. With that accomplished, re".
The objective part 3 is some text that varies. The objective part 3 is "cover the coin from the floor of the basement. Alright, thanks!".
