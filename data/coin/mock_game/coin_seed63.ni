...
The r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 and the r_10 and the r_2 are rooms.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a standard kind of place. That is to say, you're in a salon. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The sauna part 0 is some text that varies. The sauna part 0 is "A well framed signboard tells you that you are now in the sauna.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You're not going to believe this, but you've just entered a pantry. You begin looking for stuff.
...
The r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 and the r_10 and the r_2 are rooms.
The r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_1 and the r_10 and the r_2 are privately-named.
...
Test quest0_0 with "go south / go south / go south / go east / go north / go west / go south / go east / go east / go north / go north / go west / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to another fast paced round of TextWorld! Your first objective is to travel south. After that, venture south. Then, head south. After that, take a trip east. After that, make an effort to go t".
The objective part 1 is some text that varies. The objective part 1 is "o the north. After that, make an effort to venture west. Following that, attempt to go south. And then, move east. With that accomplished, make an effort to go east. Once you accomplish that, travel n".
The objective part 2 is some text that varies. The objective part 2 is "orth. With that accomplished, take a trip north. Once you get around to doing that, make an effort to take a trip west. Then, make an attempt to move north. Once you succeed at that, venture west. And".
The objective part 3 is some text that varies. The objective part 3 is " then, recover the coin from the floor of the salon. And if you do that, you're the winner!".
