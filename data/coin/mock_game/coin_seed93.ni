...
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 are rooms.

Understand "scullery" as r_1.
The internal name of r_1 is "scullery".
The printed name of r_1 is "-= Scullery =-".
The scullery part 0 is some text that varies. The scullery part 0 is "Of every scullery you could have sauntered into, you had to walk into an usual one.
...
The garage part 0 is some text that varies. The garage part 0 is "This might come as a shock to you, but you've just fallen into a garage. Okay, just remember what you're here to do, and everything will go great.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You arrive in a cubicle. An ordinary kind of place. You begin looking for stuff.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You have fallen into a kitchenette. Not the kitchenette you'd expect. No, this is a kitchenette. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 are rooms.
The r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 are privately-named.
...
Test quest0_0 with "go south / go west / go south / go east / go south / go east / go south / go east / go east / go south / go west / go west / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, take a trip south. Next, take a trip west. After that, make an effort to travel south. Onc".
The objective part 1 is some text that varies. The objective part 1 is "e you succeed at that, go east. Then, try to venture south. With that over with, attempt to go to the east. With that accomplished, head south. And then, try to head east. And then, take a trip east. ".
The objective part 2 is some text that varies. The objective part 2 is "Once you succeed at that, go to the south. That done, go to the west. If you can get through with that, take a trip west. And then, move west. After that, make an attempt to travel north. After that, ".
The objective part 3 is some text that varies. The objective part 3 is "lift the coin from the floor of the sauna. And if you do that, you're the winner!".
