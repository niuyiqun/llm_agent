...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 are rooms.
...
The study part 0 is some text that varies. The study part 0 is "Look at you, bigshot, walking into a study like it isn't some huge deal. You can barely contain your excitement.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You make another one of your grand eccentric entrances into a chamber. You begin to take stock of what's in the room.
...
The office part 0 is some text that varies. The office part 0 is "Look around you. Take it all in. It's not every day someone gets to be in an office. You begin looking for stuff.
...
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 are rooms.
The r_10 and the r_11 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_1 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go north / go west / go west / go west / go north / go east / go south / go west / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound session of TextWorld! Here is your task for today. First off, venture south. Then, try to go south. With that done, make an effort to go to the west. And then, try to ta".
The objective part 1 is some text that varies. The objective part 1 is "ke a trip north. Then, try to move west. And then, attempt to go west. Then, go to the west. With that over with, venture north. Once you accomplish that, head east. With that over with, attempt to tr".
The objective part 2 is some text that varies. The objective part 2 is "avel south. And then, go west. With that over with, go to the west. After that, take a trip south. With that over with, attempt to move west. After that, pick up the coin from the floor of the playroo".
The objective part 3 is some text that varies. The objective part 3 is "m. Alright, thanks!".
