...
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_1 and the r_11 are rooms.

Understand "kitchenette" as r_10.
The internal name of r_10 is "kitchenette".
The printed name of r_10 is "-= Kitchenette =-".
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Ah, the kitchenette. This is some kind of kitchenette, really great typical vibes in this place, a wonderful typical atmosphere.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just sauntered into a chamber. You can barely contain your excitement.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical one. You begin to take stock of what's here.
...
The description of r_14 is "[launderette part 0]".
...
The playroom part 0 is some text that varies. The playroom part 0 is "You arrive in a playroom. A standard one. You begin to take stock of what's in the room.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. The room is well lit.
...
The steam room part 0 is some text that varies. The steam room part 0 is "Well, here we are in a steam room. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You arrive in a laundry place. A normal kind of place. Let's see what's in here.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom. An ordinary kind of place. You begin to take stock of what's here.
...
The bar part 0 is some text that varies. The bar part 0 is "Well I'll be, you are in a place we're calling a bar. You start to take note of what's in the room.
...
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_1 and the r_11 are rooms.
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_1 and the r_11 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go west / go west / go west / go south / go east / go east / go east / go north / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First, it would be a great idea if you could make an effort to head south. That done, move south. ".
The objective part 1 is some text that varies. The objective part 1 is "Next, make an attempt to move west. Following that, try to go west. With that done, travel west. After that, make an effort to move west. With that done, try to travel south. Then, make an attempt to ".
The objective part 2 is some text that varies. The objective part 2 is "take a trip east. Once you finish that, venture east. Then, make an effort to go east. After that, take a trip north. That done, make an effort to go to the north. Then, head east. Next, head east. If".
The objective part 3 is some text that varies. The objective part 3 is " you can get around to doing that, retrieve the coin from the floor of the launderette. Got that? Good!".
