...
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 and the r_3 are rooms.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. A standard one. You begin looking for stuff.
...
The studio part 0 is some text that varies. The studio part 0 is "Okay, so you're in a studio, cool, but is it ordinary? You better believe it is. I guess you better just go and list everything you see here.
...
The salon part 0 is some text that varies. The salon part 0 is "Well how about that, you are in a place we're calling a salon.
...
The parlor part 0 is some text that varies. The parlor part 0 is "Guess what, you are in a place we're calling a parlor. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You arrive in a recreation zone. A normal one. I guess you better just go and list everything you see here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You're now in a launderette. You begin to take stock of what's here.
...
The description of r_8 is "[bathroom part 0]".
...
The playroom part 0 is some text that varies. The playroom part 0 is "Ah, the playroom. This is some kind of playroom, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. You begin to take stock of what's here.
...
The serious study part 0 is some text that varies. The serious study part 0 is "I just think it's great that you've just entered a serious study. I guess you better just go and list everything you see here.
...
The description of r_3 is "[serious study part 0]".
...
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 and the r_3 are rooms.
The r_1 and the r_2 and the r_11 and the r_10 and the r_13 and the r_12 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_0 and the r_14 and the r_3 are privately-named.
...
Test quest0_0 with "go north / go west / go south / go south / go west / go west / go north / go east / go east / go south / go east / go north / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound session of TextWorld! Here is how to play! First off, make an effort to move north. And then, attempt to travel west. With that done, head south. And then, take a trip s".
The objective part 1 is some text that varies. The objective part 1 is "outh. With that over with, attempt to head west. And then, travel west. And then, go north. Okay, and then, make an effort to move east. And then, attempt to venture east. With that over with, try to ".
The objective part 2 is some text that varies. The objective part 2 is "venture south. If you can accomplish that, attempt to venture east. And then, make an effort to travel north. Then, attempt to go east. If you can get around to doing that, go north. And then, retriev".
The objective part 3 is some text that varies. The objective part 3 is "e the coin from the floor of the cubicle. Once that's all handled, you can stop!".
