...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 are rooms.
...
The spare room part 0 is some text that varies. The spare room part 0 is "Fancy seeing you here. Here, by the way, being the spare room.
...
The studio part 0 is some text that varies. The studio part 0 is "You are in a studio. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The scullery part 0 is some text that varies. The scullery part 0 is "Well how about that, you are in a place we're calling a scullery.
...
The salon part 0 is some text that varies. The salon part 0 is "You arrive in a salon. An usual kind of place. The room is well lit.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The study part 0 is some text that varies. The study part 0 is "Guess what, you are in a place we're calling a study. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "This is going to sound unbelievable, but you've just entered a bedchamber.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You arrive in a cookhouse. A standard kind of place. I guess you better just go and list everything you see here.
...
The garage part 0 is some text that varies. The garage part 0 is "You arrive in a garage. An usual kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 are rooms.
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 are privately-named.
...
Test quest0_0 with "go north / go west / go west / go north / go west / go west / go south / go east / go south / go west / go south / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! First of all, you could, like, make an effort to move north. And then, make an attempt to move west. After that, try to head west. And then, travel north. With that done, head we".
The objective part 1 is some text that varies. The objective part 1 is "st. With that over with, try to head west. And then, attempt to go south. And then, make an effort to go to the east. If you can succeed at that, go south. Following that, make an effort to take a tri".
The objective part 2 is some text that varies. The objective part 2 is "p west. After that, try to move south. If you can get around to doing that, head west. After that, make an effort to move south. Okay, and then, attempt to move west. Then, pick-up the coin from the f".
The objective part 3 is some text that varies. The objective part 3 is "loor of the scullery. And once you've done that, you win!".
