...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_0 and the r_10 and the r_8 and the r_9 are rooms.

Understand "cookery" as r_12.
The internal name of r_12 is "cookery".
The printed name of r_12 is "-= Cookery =-".
The cookery part 0 is some text that varies. The cookery part 0 is "You've moved into an ordinary room. Your mind races to think of what kind of room would be ordinary. And then it hits you. Of course. You're in the cookery. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You find yourself in a spare room. An ordinary kind of place. The room is well lit.
...
The garage part 0 is some text that varies. The garage part 0 is "You arrive in a normal kind of place. That is to say, you're in a garage.
...
The basement part 0 is some text that varies. The basement part 0 is "This might come as a shock to you, but you've just walked into a basement. You begin looking for stuff.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The office part 0 is some text that varies. The office part 0 is "Well, here we are in an office. You begin to take stock of what's in the room.
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. A normal kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_0 and the r_10 and the r_8 and the r_9 are rooms.
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_0 and the r_10 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go east / go north / go east / go east / go north / go east / go south / go south / go south / go south / go east / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! Here is how to play! First off, make an attempt to travel north. Okay, and then, take a trip east. Then, head north. With that done, move east. W".
The objective part 1 is some text that varies. The objective part 1 is "ith that accomplished, attempt to head east. With that over with, head north. And then, make an effort to travel east. Next, try to go to the south. With that accomplished, make an attempt to venture ".
The objective part 2 is some text that varies. The objective part 2 is "south. Okay, and then, try to venture south. Following that, head south. That done, head east. With that accomplished, attempt to go to the north. Once you get around to doing that, make an effort to ".
The objective part 3 is some text that varies. The objective part 3 is "take a trip west. Okay, and then, pick up the coin from the floor of the garage. Once that's all handled, you can stop!".
