...
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_3 are rooms.
...
The shower part 0 is some text that varies. The shower part 0 is "You find yourself in a shower. An usual one. You start to take note of what's in the room.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You find yourself in a cookery. An usual kind of place. You begin to take stock of what's here.
...
The basement part 0 is some text that varies. The basement part 0 is "You make a grand eccentric entrance into a basement. You start to take note of what's in the room.
...
The salon part 0 is some text that varies. The salon part 0 is "You are in a salon. A standard kind of place. You can barely contain your excitement.
...
The study part 0 is some text that varies. The study part 0 is "This might come as a shock to you, but you've just walked into a study. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The description of r_3 is "[still study part 0]".
...
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_3 are rooms.
The r_1 and the r_2 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_0 and the r_10 and the r_11 and the r_3 are privately-named.
...
Test quest0_0 with "go north / go west / go south / go south / go west / go north / go east / go south / go west / go north / go north / go north / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a exciting game of TextWorld! First stop, go to the north. If you can get through with that, make an attempt to travel west. And then, make an attempt to go south. After that, atte".
The objective part 1 is some text that varies. The objective part 1 is "mpt to travel south. Once you get through with that, make an attempt to move west. And then, go north. Okay, and then, attempt to move east. And then, try to travel south. After that, make an effort t".
The objective part 2 is some text that varies. The objective part 2 is "o go to the west. And then, go north. After that, make an effort to go to the north. And then, go north. Next, try to head west. And then, attempt to head west. Then, recover the coin from the floor o".
The objective part 3 is some text that varies. The objective part 3 is "f the basement. Once that's all handled, you can stop!".
