...
The r_1 and the r_2 and the r_11 and the r_10 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.

Understand "cubicle" as r_1.
The internal name of r_1 is "cubicle".
The printed name of r_1 is "-= Cubicle =-".
The cubicle part 0 is some text that varies. The cubicle part 0 is "Of every cubicle you could have sauntered into, you had to show up in a typical one. You begin to take stock of what's in the room.
...
The washroom part 0 is some text that varies. The washroom part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a washroom. Okay, just remember what you're here to do, and everything will go great.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You are in a cookhouse. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. You can barely contain your excitement.
...
The r_1 and the r_2 and the r_11 and the r_10 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_3 are rooms.
The r_1 and the r_2 and the r_11 and the r_10 and the r_5 and the r_4 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_3 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go north / go east / go south / go west / go north / go east / go south / go east / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to attempt to take a trip south. And then, go west. That done, make an e".
The objective part 1 is some text that varies. The objective part 1 is "ffort to go to the north. Then, take a trip north. Then, travel east. With that accomplished, go south. And then, attempt to go to the west. After that, make an effort to take a trip north. Then, vent".
The objective part 2 is some text that varies. The objective part 2 is "ure east. With that accomplished, take a trip south. With that done, take a trip east. After that, make an effort to head north. And then, travel north. With that done, move north. If you can do that,".
The objective part 3 is some text that varies. The objective part 3 is " pick-up the coin from the floor of the laundry place. That's it!".
