...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_9 and the r_7 are rooms.

Understand "cookhouse" as r_0.
The internal name of r_0 is "cookhouse".
The printed name of r_0 is "-= Cookhouse =-".
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You find yourself in a cookhouse. A standard kind of place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You're not going to believe this, but you've just entered a kitchenette. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You arrive in a bedchamber. An usual kind of place. You begin to take stock of what's in the room.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. An ordinary kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The scullery part 0 is some text that varies. The scullery part 0 is "You have stumbled into a scullery. Not the scullery you'd expect. No, this is a scullery.
...
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_9 and the r_7 are rooms.
The r_0 and the r_1 and the r_2 and the r_10 and the r_11 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_6 and the r_5 and the r_8 and the r_9 and the r_7 are privately-named.
...
Test quest0_0 with "go west / go west / go south / go east / go north / go east / go north / go north / go west / go south / go west / go west / go north / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make an attempt to move west. Okay, and then, go west. Following that, travel south. After t".
The objective part 1 is some text that varies. The objective part 1 is "hat, head east. That done, make an attempt to go to the north. Okay, and then, make an attempt to go to the east. With that accomplished, venture north. With that over with, take a trip north. And the".
The objective part 2 is some text that varies. The objective part 2 is "n, make an attempt to venture west. After that, take a trip south. That done, head west. Okay, and then, make an attempt to take a trip west. Then, make an effort to take a trip north. Then, make an e".
The objective part 3 is some text that varies. The objective part 3 is "ffort to move east. Then, retrieve the coin from the floor of the parlor. And once you've done that, you win!".
