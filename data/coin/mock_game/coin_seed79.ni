...
The r_1 and the r_0 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_4 and the r_5 and the r_8 are rooms.
...
The shower part 0 is some text that varies. The shower part 0 is "You are in a shower. A normal kind of place. Let's see what's in here.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You're now in a bedchamber. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. A standard kind of place. You begin to take stock of what's in the room.



There is an exit to the west. Don't worry, it is unguarded.".
The description of r_14 is "[bathroom part 0]".
...
The laundry place part 0 is some text that varies. The laundry place part 0 is "You've just walked into a laundry place. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in an attic. You start to take note of what's in the room.
...
The office part 0 is some text that varies. The office part 0 is "You've entered an office. The room is well lit.
...
The r_1 and the r_0 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_4 and the r_5 and the r_8 are rooms.
The r_1 and the r_0 and the r_13 and the r_12 and the r_14 and the r_2 and the r_3 and the r_7 and the r_6 and the r_9 and the r_10 and the r_11 and the r_4 and the r_5 and the r_8 are privately-named.
...
Test quest0_0 with "go east / go north / go west / go south / go south / go south / go east / go south / go south / go west / go south / go south / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an profound round of TextWorld? You do! Here is your task for today. First of all, attempt to venture east. And then, make an attempt to ventur".
The objective part 1 is some text that varies. The objective part 1 is "e north. And then, venture west. And then, try to take a trip south. And then, attempt to venture south. And then, venture south. Then, make an attempt to head east. With that accomplished, go to the ".
The objective part 2 is some text that varies. The objective part 2 is "south. With that over with, make an effort to venture south. With that over with, attempt to head west. Then, go south. Then, head south. And then, go east. Then, attempt to travel east. With that don".
The objective part 3 is some text that varies. The objective part 3 is "e, retrieve the coin from the floor of the bathroom. Alright, thanks!".
