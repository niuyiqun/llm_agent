...
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_7 are rooms.
...
The studio part 0 is some text that varies. The studio part 0 is "You find yourself in a studio. A normal one. Okay, just remember what you're here to do, and everything will go great.
...
The cellar part 0 is some text that varies. The cellar part 0 is "Ah, the cellar. This is some kind of cellar, really great normal vibes in this place, a wonderful normal atmosphere. You begin to take stock of what's in the room.
...
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_7 are rooms.
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_5 and the r_6 and the r_8 and the r_9 and the r_10 and the r_2 and the r_3 and the r_7 are privately-named.
...
Test quest0_0 with "go east / go north / go north / go north / go west / go west / go north / go north / go west / go west / go north / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First off, if it's not too much trouble, I need you to try to head east. With that over with, move north".
The objective part 1 is some text that varies. The objective part 1 is ". And then, go north. And then, go to the north. After that, attempt to move west. And then, head west. With that accomplished, attempt to travel north. And then, venture north. After that, go west. A".
The objective part 2 is some text that varies. The objective part 2 is "nd then, travel west. Next, try to travel north. Then, try to venture west. After that, make an effort to move south. Once you finish that, make an attempt to head west. With that over with, lift the ".
The objective part 3 is some text that varies. The objective part 3 is "coin from the floor of the basement. Got that? Good!".
