...
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_11 are rooms.

Understand "bedchamber" as r_0.
The internal name of r_0 is "bedchamber".
The printed name of r_0 is "-= Bedchamber =-".
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Guess what, you are in the place we're calling the bedchamber. You can barely contain your excitement.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You are in a kitchen. A normal kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The canteen part 0 is some text that varies. The canteen part 0 is "You've seen better canteens, but at least this one seems pretty usual.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You find yourself in a cookery. The room is well lit.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You are in a restroom. An ordinary one. Let's see what's in here.
...
The closet part 0 is some text that varies. The closet part 0 is "You arrive in a closet. An usual one. You begin to take stock of what's here.
...
The attic part 0 is some text that varies. The attic part 0 is "You've just walked into an attic. You start to take note of what's in the room.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a standard kind of place. That is to say, you're in a kitchenette.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_11 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_11 are privately-named.
...
Test quest0_0 with "go west / go north / go west / go south / go west / go west / go north / go east / go east / go east / go south / go south / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First step, go west. After that, try to head north. And then, go west. If you can do that, go to ".
The objective part 1 is some text that varies. The objective part 1 is "the south. Then, try to travel west. And then, venture west. Then, attempt to take a trip north. With that done, go east. And then, go to the east. Then, go to the east. Then, attempt to take a trip s".
The objective part 2 is some text that varies. The objective part 2 is "outh. If you can accomplish that, try to take a trip south. Following that, make an effort to head west. And then, take a trip west. Next, pick-up the coin from the floor of the closet. Once that's al".
The objective part 3 is some text that varies. The objective part 3 is "l handled, you can stop!".
