...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_13 and the r_14 are rooms.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. You can barely contain your excitement.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Of every kitchen you could have walked into, you had to saunter into an ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The washroom part 0 is some text that varies. The washroom part 0 is "Okay, so you're in a washroom, cool, but is it ordinary? You better believe it is.
...
The scullery part 0 is some text that varies. The scullery part 0 is "I am so happy to announce that you are now in the scullery. I guess you better just go and list everything you see here.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_13 and the r_14 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_12 and the r_3 and the r_2 and the r_4 and the r_6 and the r_5 and the r_7 and the r_8 and the r_9 and the r_13 and the r_14 are privately-named.
...
Test quest0_0 with "go west / go south / go east / go east / go south / go east / go north / go west / go west / go south / go west / go west / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! Here is your task for today. First, it would be good if you could take a trip west. With that over".
The objective part 1 is some text that varies. The objective part 1 is " with, try to head south. With that over with, go to the east. With that done, make an effort to go to the east. That done, make an attempt to go south. Next, venture east. Then, take a trip north. If".
The objective part 2 is some text that varies. The objective part 2 is " you can get around to doing that, make an attempt to travel west. And then, go to the west. After that, go to the south. And then, venture west. With that done, try to go to the west. And then, attem".
The objective part 3 is some text that varies. The objective part 3 is "pt to move north. Next, go to the north. With that accomplished, retrieve the coin from the floor of the sauna. That's it!".
