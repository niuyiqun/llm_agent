...
The r_0 and the r_1 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_8 are rooms.

Understand "steam room" as r_0.
The internal name of r_0 is "steam room".
The printed name of r_0 is "-= Steam Room =-".
The steam room part 0 is some text that varies. The steam room part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a steam room. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The studio part 0 is some text that varies. The studio part 0 is "You've just sauntered into a studio. You begin to take stock of what's here.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Look at that board! What does it say? It says Welcome to the kitchenette? Well that's cool.
...
The office part 0 is some text that varies. The office part 0 is "You are in an office. A typical one. You start to take note of what's in the room.
...
The cellar part 0 is some text that varies. The cellar part 0 is "Ah, the cellar. This is some kind of cellar, really great normal vibes in this place, a wonderful normal atmosphere. You can barely contain your excitement.
...
The attic part 0 is some text that varies. The attic part 0 is "You arrive in an attic. An usual one. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You arrive in a kitchen. An ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The r_0 and the r_1 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_8 are rooms.
The r_0 and the r_1 and the r_13 and the r_14 and the r_3 and the r_2 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_11 and the r_12 and the r_8 are privately-named.
...
Test quest0_0 with "go west / go south / go east / go east / go east / go north / go west / go south / go south / go west / go south / go south / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Get ready to pick stuff up and put it in places, because you've just entered TextWorld! Here is how to play! First off, make an attempt to venture west. With that done, head south. And then, go east. ".
The objective part 1 is some text that varies. The objective part 1 is "And then, make an attempt to venture east. If you can do that, attempt to move east. After that, try to go to the north. Okay, and then, head west. Then, attempt to head south. Following that, try to ".
The objective part 2 is some text that varies. The objective part 2 is "venture south. After that, take a trip west. Okay, and then, make an effort to venture south. And then, make an effort to move south. Once you get around to doing that, go to the south. Then, make an ".
The objective part 3 is some text that varies. The objective part 3 is "effort to move west. Next, lift the coin from the floor of the dish-pit. Got that? Good!".
