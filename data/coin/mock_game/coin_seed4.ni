...
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_10 and the r_5 and the r_6 and the r_9 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You are in a cookhouse. A typical one. The room is well lit.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You are in a cellar. A typical kind of place. You can barely contain your excitement.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Guess what, you are in the place we're calling the kitchenette. You can barely contain your excitement.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You're now in the workshop. I guess you better just go and list everything you see here.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You have moved into the most typical of all possible scullerys. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You've seen better bedchambers, but at least this one seems pretty usual. You can barely contain your excitement.
...
The closet part 0 is some text that varies. The closet part 0 is "Of every closet you could have shown up in, you had to saunter into a normal one.
...
The studio part 0 is some text that varies. The studio part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just walked into the studio. You begin looking for stuff.
...
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_10 and the r_5 and the r_6 and the r_9 are rooms.
The r_1 and the r_0 and the r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_3 and the r_4 and the r_8 and the r_7 and the r_10 and the r_5 and the r_6 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go east / go north / go west / go north / go north / go north / go east / go south / go south / go south / go east / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is how to play! First off, travel east. With that over with, venture east. And then, make an".
The objective part 1 is some text that varies. The objective part 1 is " attempt to venture north. That done, take a trip west. With that accomplished, make an attempt to take a trip north. Following that, make an attempt to go to the north. And then, take a trip north. A".
The objective part 2 is some text that varies. The objective part 2 is "nd then, head east. After that, attempt to head south. Then, head south. And then, go to the south. And then, attempt to go to the east. And then, try to travel east. Following that, move east. With t".
The objective part 3 is some text that varies. The objective part 3 is "hat done, pick up the coin from the floor of the cellar. Once that's all handled, you can stop!".
