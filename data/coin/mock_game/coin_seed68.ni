...
The r_1 and the r_2 and the r_11 and the r_10 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_5 are rooms.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You arrive in a cellar. An usual kind of place. You begin looking for stuff.
...
The canteen part 0 is some text that varies. The canteen part 0 is "A well framed sign tells you that you are now in the canteen. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The studio part 0 is some text that varies. The studio part 0 is "A laminated board tells you that you are now in the studio. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "I am obligated to announce that you are now in the laundromat. You begin to take stock of what's in the room.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. A standard kind of place. I guess you better just go and list everything you see here.
...
The r_1 and the r_2 and the r_11 and the r_10 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_5 are rooms.
The r_1 and the r_2 and the r_11 and the r_10 and the r_3 and the r_4 and the r_7 and the r_6 and the r_9 and the r_8 and the r_0 and the r_12 and the r_13 and the r_14 and the r_5 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go west / go north / go north / go east / go south / go east / go south / go east / go south / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to go to the south. Next, try to head west. And then, try to head north.".
The objective part 1 is some text that varies. The objective part 1 is " Then, attempt to travel west. And then, make an effort to take a trip north. And then, make an attempt to venture north. And then, venture east. And then, make an effort to head south. Then, attempt ".
The objective part 2 is some text that varies. The objective part 2 is "to venture east. After that, go south. That done, venture east. With that done, venture south. Then, try to head south. After that, try to venture south. Then, retrieve the coin from the floor of the ".
The objective part 3 is some text that varies. The objective part 3 is "basement. Alright, thanks!".
