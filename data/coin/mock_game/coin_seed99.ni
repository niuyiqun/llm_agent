...
The r_1 and the r_2 and the r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are rooms.
...
The canteen part 0 is some text that varies. The canteen part 0 is "Okay, so you're in a canteen, cool, but is it typical? You better believe it is.
...
The restroom part 0 is some text that varies. The restroom part 0 is "You find yourself in a restroom. You start to take note of what's in the room.
...
The chamber part 0 is some text that varies. The chamber part 0 is "I just think it's great that you've just entered a chamber. Let's see what's in here.
...
The study part 0 is some text that varies. The study part 0 is "You've entered a study. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The r_1 and the r_2 and the r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are rooms.
The r_1 and the r_2 and the r_11 and the r_10 and the r_12 and the r_14 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_9 and the r_8 and the r_0 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go east / go east / go north / go west / go north / go east / go south / go east / go east / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, try to venture north. And then, make an attempt to go west. After that, go to the north. T".
The objective part 1 is some text that varies. The objective part 1 is "hen, take a trip east. Next, try to venture east. Okay, and then, make an attempt to venture north. Following that, go west. Okay, and then, move north. That done, make an effort to go east. Then, mak".
The objective part 2 is some text that varies. The objective part 2 is "e an attempt to go to the south. And then, go east. And then, take a trip east. With that over with, head south. And then, go to the east. Then, pick-up the coin from the floor of the chamber. That's ".
