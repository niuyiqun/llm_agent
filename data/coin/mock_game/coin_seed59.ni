...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_8 and the r_7 and the r_2 and the r_3 and the r_6 are rooms.

Understand "cellar" as r_0.
The internal name of r_0 is "cellar".
The printed name of r_0 is "-= Cellar =-".
The cellar part 0 is some text that varies. The cellar part 0 is "You've come into an usual room. Your mind races to think of what kind of room would be usual. And then it hits you. Of course. You're in the cellar.
...
The office part 0 is some text that varies. The office part 0 is "Look at that board! What does it say? It says Welcome to the office? Well that's cool. I guess you better just go and list everything you see here.
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. A typical one. You start to take note of what's in the room.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. A standard one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The chamber part 0 is some text that varies. The chamber part 0 is "Of every chamber you could have sauntered into, you had to come round an ordinary one.
...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in the attic. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You find yourself in a bedchamber. A typical one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_8 and the r_7 and the r_2 and the r_3 and the r_6 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_11 and the r_12 and the r_13 and the r_14 and the r_5 and the r_4 and the r_8 and the r_7 and the r_2 and the r_3 and the r_6 are privately-named.
...
Test quest0_0 with "go west / go south / go south / go south / go east / go south / go south / go east / go south / go east / go east / go north / go west / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could travel west. Once you get around to doing that, attempt to move so".
The objective part 1 is some text that varies. The objective part 1 is "uth. And then, try to travel south. With that over with, attempt to go to the south. Once you get around to doing that, move east. Then, attempt to head south. Then, attempt to move south. Okay, and t".
The objective part 2 is some text that varies. The objective part 2 is "hen, make an effort to go to the east. And then, try to go to the south. And then, move east. With that done, move east. After that, head north. Okay, and then, move west. Then, take a trip west. Foll".
The objective part 3 is some text that varies. The objective part 3 is "owing that, pick up the coin from the floor of the chamber. And if you do that, you're the winner!".
