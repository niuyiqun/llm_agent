...
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_0 and the r_11 and the r_5 are rooms.

Understand "study" as r_10.
The internal name of r_10 is "study".
The printed name of r_10 is "-= Study =-".
The study part 0 is some text that varies. The study part 0 is "You have entered the most typical of all possible studys.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Look at you, bigshot, walking into a cubicle like it isn't some huge deal. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You are in a washroom. A normal kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The office part 0 is some text that varies. The office part 0 is "You've seen better offices, but at least this one seems pretty usual.
...
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_0 and the r_11 and the r_5 are rooms.
The r_10 and the r_9 and the r_13 and the r_12 and the r_14 and the r_2 and the r_1 and the r_4 and the r_3 and the r_6 and the r_7 and the r_8 and the r_0 and the r_11 and the r_5 are privately-named.
...
Test quest0_0 with "go south / go east / go south / go east / go south / go south / go west / go south / go east / go east / go north / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a profound episode of TextWorld! Here is how to play! First thing I need you to do is to try to go to the south. And then, make an attempt to travel east. That done, make an effort".
The objective part 1 is some text that varies. The objective part 1 is " to travel south. Okay, and then, venture east. And then, venture south. With that over with, make an attempt to take a trip south. Then, take a trip west. And then, go south. And then, travel east. A".
The objective part 2 is some text that varies. The objective part 2 is "fter that, try to venture east. Then, make an effort to head north. Then, attempt to go north. After that, try to travel east. After that, go to the east. Then, lift the coin from the floor of the cha".
The objective part 3 is some text that varies. The objective part 3 is "mber. And if you do that, you're the winner!".
