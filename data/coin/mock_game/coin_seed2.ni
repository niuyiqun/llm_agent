...
The r_11 and the r_10 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_14 are rooms.

Understand "bedchamber" as r_11.
The internal name of r_11 is "bedchamber".
The printed name of r_11 is "-= Bedchamber =-".
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a bedchamber. The room is well lit.
...
The bar part 0 is some text that varies. The bar part 0 is "You are in a bar. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in a sauna. A normal one. You start to take note of what's in the room.
...
The shower part 0 is some text that varies. The shower part 0 is "You find yourself in a shower. A normal kind of place. The room is well lit.
...
The r_11 and the r_10 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_14 are rooms.
The r_11 and the r_10 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_14 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go north / go west / go south / go west / go north / go west / go north / go east / go north / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First thing I need you to do is to try to venture north. After that, head east. That done, go to the eas".
The objective part 1 is some text that varies. The objective part 1 is "t. Next, attempt to travel north. And then, travel west. That done, head south. With that accomplished, make an effort to head west. After that, make an effort to take a trip north. Then, attempt to h".
The objective part 2 is some text that varies. The objective part 2 is "ead west. And then, head north. Then, try to move east. If you can succeed at that, go north. And then, take a trip west. Okay, and then, make an effort to take a trip north. That done, pick up the co".
The objective part 3 is some text that varies. The objective part 3 is "in from the floor of the scullery. Got that? Good!".
