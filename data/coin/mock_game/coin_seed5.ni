...
The r_11 and the r_10 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_12 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Fancy seeing you here. Here, by the way, being the cookhouse.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "You have stumbled into a bedchamber. Not the bedchamber you'd expect. No, this is a bedchamber.
...
The office part 0 is some text that varies. The office part 0 is "You make another one of your grand eccentric entrances into an office.
...
The launderette part 0 is some text that varies. The launderette part 0 is "I just think it's awesome that you're in a launderette now. You begin to take stock of what's in the room.
...
The r_11 and the r_10 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_12 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
The r_11 and the r_10 and the r_2 and the r_1 and the r_4 and the r_3 and the r_5 and the r_6 and the r_0 and the r_12 and the r_13 and the r_14 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go east / go south / go east / go north / go west / go south / go south / go south / go south / go east / go north / go north / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First thing I need you to do is to go to the north. And then, go to the east. With that over with".
The objective part 1 is some text that varies. The objective part 1 is ", try to head south. After that, make an effort to head east. And then, make an attempt to go north. Then, take a trip west. Then, try to venture south. Then, make an attempt to move south. Following ".
The objective part 2 is some text that varies. The objective part 2 is "that, take a trip south. That done, travel south. With that over with, head east. Then, move north. Once you accomplish that, attempt to venture north. After that, head north. Then, pick up the coin f".
The objective part 3 is some text that varies. The objective part 3 is "rom the floor of the bar. That's it!".
