...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_14 and the r_9 are rooms.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You find yourself in a chamber. An ordinary one. You can barely contain your excitement.
...
The attic part 0 is some text that varies. The attic part 0 is "Well, here we are in the attic. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The basement part 0 is some text that varies. The basement part 0 is "You are in a basement. A normal one. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just sauntered into the bathroom. You begin looking for stuff.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. A standard kind of place. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The restroom part 0 is some text that varies. The restroom part 0 is "You arrive in a restroom. An usual one.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Of every bedchamber you could have sauntered into, you had to come round a typical one.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You find yourself in a cubicle. A typical one. You begin to take stock of what's in the room.
...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_14 and the r_9 are rooms.
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_14 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go west / go south / go west / go west / go north / go west / go west / go south / go south / go south / go west / go west / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First thing I need you to do is to try to head north. Then, try to venture west. And then, attempt to move south. Then".
The objective part 1 is some text that varies. The objective part 1 is ", go west. And then, travel west. After that, attempt to move north. Then, attempt to travel west. After that, attempt to travel west. With that accomplished, attempt to move south. Next, move south. ".
The objective part 2 is some text that varies. The objective part 2 is "After that, go to the south. Then, make an effort to travel west. With that done, take a trip west. Okay, and then, venture north. Then, pick-up the coin from the floor of the bedchamber. And if you d".
The objective part 3 is some text that varies. The objective part 3 is "o that, you're the winner!".
