...
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_10 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You arrive in a chamber. An ordinary one. Let's see what's in here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You arrive in a launderette. A standard kind of place. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The canteen part 0 is some text that varies. The canteen part 0 is "I never took you for the sort of person who would show up in a canteen, but I guess I was wrong. Let's see what's in here.
...
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_10 and the r_14 and the r_7 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_11 and the r_12 and the r_13 and the r_2 and the r_4 and the r_3 and the r_5 and the r_6 and the r_10 and the r_14 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go east / go south / go east / go south / go west / go north / go north / go north / go north / go north / go west / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an life changing round of TextWorld? You do! First off, try to venture east. After that, try to venture east. Following that, go to the south. ".
The objective part 1 is some text that varies. The objective part 1 is "Okay, and then, move east. If you can finish that, attempt to venture south. Next, head west. With that over with, take a trip north. With that accomplished, make an effort to venture north. After tha".
The objective part 2 is some text that varies. The objective part 2 is "t, try to take a trip north. Once you accomplish that, go north. Then, go north. Okay, and then, move west. Once you succeed at that, take a trip west. And then, try to go to the south. After that, re".
The objective part 3 is some text that varies. The objective part 3 is "cover the coin from the floor of the garage. Got that? Good!".
