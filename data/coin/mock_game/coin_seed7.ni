...
The r_11 and the r_12 and the r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_13 and the r_14 and the r_3 and the r_6 are rooms.

Understand "dish-pit" as r_11.
The internal name of r_11 is "dish-pit".
The printed name of r_11 is "-= Dish-Pit =-".
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "You are in a dish-pit. A standard kind of place. I guess you better just go and list everything you see here.
...
The lounge part 0 is some text that varies. The lounge part 0 is "You've stumbled into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the lounge.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "Look around you. Take it all in. It's not every day someone gets to be in a cubicle. You can barely contain your excitement.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "You find yourself in a recreation zone. A standard one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Ah, the bathroom. This is some kind of bathroom, really great ordinary vibes in this place, a wonderful ordinary atmosphere. You begin looking for stuff.
...
The cookery part 0 is some text that varies. The cookery part 0 is "You're not going to believe this, but you've just entered a cookery.
...
The r_11 and the r_12 and the r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_13 and the r_14 and the r_3 and the r_6 are rooms.
The r_11 and the r_12 and the r_2 and the r_1 and the r_4 and the r_5 and the r_7 and the r_8 and the r_9 and the r_10 and the r_0 and the r_13 and the r_14 and the r_3 and the r_6 are privately-named.
...
Test quest0_0 with "go south / go east / go north / go north / go west / go south / go south / go west / go west / go west / go south / go west / go south / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a life changing round of TextWorld! Here is how to play! First off, if it's not too much trouble, I need you to go south. Next, make an attempt to venture east. And then, try to go".
The objective part 1 is some text that varies. The objective part 1 is " north. If you can get through with that, attempt to travel north. Then, head west. And then, make an attempt to venture south. With that over with, move south. Then, try to go to the west. With that ".
The objective part 2 is some text that varies. The objective part 2 is "over with, go to the west. And then, try to move west. And then, make an effort to take a trip south. Then, make an attempt to go to the west. Following that, take a trip south. With that done, make a".
The objective part 3 is some text that varies. The objective part 3 is "n effort to take a trip south. And then, pick up the coin from the floor of the kitchenette. And if you do that, you're the winner!".
