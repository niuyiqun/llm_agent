...
The r_10 and the r_9 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_11 and the r_14 and the r_7 and the r_8 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You have come into a laundromat. Not the laundromat you'd expect. No, this is a laundromat.
...
The chamber part 0 is some text that varies. The chamber part 0 is "You've just sauntered into a chamber. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The canteen part 0 is some text that varies. The canteen part 0 is "You arrive in a canteen. A standard one. You begin looking for stuff.
...
The cellar part 0 is some text that varies. The cellar part 0 is "Well, here we are in a cellar. Let's see what's in here.
...
The kitchen part 0 is some text that varies. The kitchen part 0 is "You find yourself in a kitchen. An ordinary kind of place. The room is well lit.
...
The r_10 and the r_9 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_11 and the r_14 and the r_7 and the r_8 are rooms.
The r_10 and the r_9 and the r_12 and the r_13 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_11 and the r_14 and the r_7 and the r_8 are privately-named.
...
Test quest0_0 with "go north / go east / go east / go east / go north / go west / go south / go south / go south / go east / go north / go north / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is your task for today. First thing I need you to do is to take a trip north. Then, try to head ".
The objective part 1 is some text that varies. The objective part 1 is "east. After that, go east. After that, go east. With that accomplished, head north. And then, head west. And then, make an attempt to take a trip south. Then, make an effort to move south. And then, v".
The objective part 2 is some text that varies. The objective part 2 is "enture south. And then, go to the east. Then, try to venture north. And then, make an effort to move north. And then, venture west. Next, make an attempt to go to the south. After that, pick up the co".
The objective part 3 is some text that varies. The objective part 3 is "in from the floor of the garage. Alright, thanks!".
