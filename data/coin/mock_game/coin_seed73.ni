...
The r_1 and the r_2 and the r_13 and the r_12 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_11 and the r_14 and the r_3 and the r_9 are rooms.

Understand "cubicle" as r_1.
The internal name of r_1 is "cubicle".
The printed name of r_1 is "-= Cubicle =-".
The cubicle part 0 is some text that varies. The cubicle part 0 is "Well, here we are in the cubicle. The room is well lit.
...
The study part 0 is some text that varies. The study part 0 is "You've just sauntered into a study. The room is well lit.
...
Understand "still cubicle" as r_14.
The internal name of r_14 is "still cubicle".
The printed name of r_14 is "-= Still Cubicle =-".
The still cubicle part 0 is some text that varies. The still cubicle part 0 is "You have fallen into a cubicle. Not the cubicle you'd expect. No, this is a still cubicle.



You need an unblocked exit? You should try going south.".
The description of r_14 is "[still cubicle part 0]".
...
The r_1 and the r_2 and the r_13 and the r_12 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_11 and the r_14 and the r_3 and the r_9 are rooms.
The r_1 and the r_2 and the r_13 and the r_12 and the r_5 and the r_4 and the r_6 and the r_7 and the r_8 and the r_0 and the r_10 and the r_11 and the r_14 and the r_3 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go north / go east / go east / go north / go west / go north / go north / go north / go north / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First step, go to the south. And then, make an attempt to move west. And then, make an effort to ".
The objective part 1 is some text that varies. The objective part 1 is "go north. Then, go north. And then, make an attempt to go to the east. Then, make an attempt to go east. That done, go to the north. After that, go to the west. Following that, attempt to travel north".
The objective part 2 is some text that varies. The objective part 2 is ". And then, try to go to the north. After that, travel north. Then, move north. After that, travel east. After that, take a trip north. And then, recover the coin from the floor of the still cubicle. ".
