...
The r_0 and the r_1 and the r_13 and the r_12 and the r_2 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are rooms.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You're now in a spare room. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The study part 0 is some text that varies. The study part 0 is "Wow! You're in a study. I guess you better just go and list everything you see here.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a standard kind of place. That is to say, you're in a canteen. I guess you better just go and list everything you see here.
...
The r_0 and the r_1 and the r_13 and the r_12 and the r_2 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are rooms.
The r_0 and the r_1 and the r_13 and the r_12 and the r_2 and the r_3 and the r_6 and the r_7 and the r_8 and the r_9 and the r_10 and the r_11 and the r_14 and the r_4 and the r_5 are privately-named.
...
Test quest0_0 with "go west / go south / go west / go south / go south / go south / go west / go west / go south / go west / go north / go north / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! First of all, you could, like, make an effort to go to the west. If you can get through with that".
The objective part 1 is some text that varies. The objective part 1 is ", venture south. Once you accomplish that, make an effort to head west. With that accomplished, move south. Then, go to the south. And then, make an attempt to go south. With that done, head west. Oka".
The objective part 2 is some text that varies. The objective part 2 is "y, and then, move west. And then, take a trip south. Then, make an effort to go to the west. With that accomplished, take a trip north. With that done, head north. With that done, take a trip east. Af".
The objective part 3 is some text that varies. The objective part 3 is "ter that, make an effort to venture south. After that, pick up the coin from the floor of the cubicle. Once that's all handled, you can stop!".
