...
The r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_12 and the r_9 are rooms.

Understand "cookhouse" as r_1.
The internal name of r_1 is "cookhouse".
The printed name of r_1 is "-= Cookhouse =-".
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "You've moved into a typical room. Your mind races to think of what kind of room would be typical. And then it hits you. Of course. You're in the cookhouse.
...
The vault part 0 is some text that varies. The vault part 0 is "If you're wondering why everything seems so standard all of a sudden, it's because you've just sauntered into the vault. You begin to take stock of what's in the room.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You arrive in a parlor. An usual one. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The playroom part 0 is some text that varies. The playroom part 0 is "This might come as a shock to you, but you've just walked into a playroom.
...
The cubicle part 0 is some text that varies. The cubicle part 0 is "You are in a cubicle. A standard kind of place. You start to take note of what's in the room.
...
The r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_12 and the r_9 are rooms.
The r_1 and the r_2 and the r_10 and the r_11 and the r_13 and the r_14 and the r_3 and the r_4 and the r_5 and the r_6 and the r_8 and the r_7 and the r_0 and the r_12 and the r_9 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go west / go north / go west / go south / go east / go south / go south / go west / go north / go north / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Your first objective is to try to take a trip north. Next, try to move west. Then, try to go to t".
The objective part 1 is some text that varies. The objective part 1 is "he north. And then, take a trip west. With that done, try to head north. After that, make an attempt to travel west. And then, go south. Then, move east. That done, go to the south. With that done, mo".
The objective part 2 is some text that varies. The objective part 2 is "ve south. After that, move west. With that accomplished, attempt to go north. Then, try to head north. Then, head west. Then, recover the coin from the floor of the cellar. And if you do that, you're ".
