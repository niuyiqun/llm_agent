...
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_14 and the r_2 are rooms.

Understand "launderette" as r_0.
The internal name of r_0 is "launderette".
The printed name of r_0 is "-= Launderette =-".
The launderette part 0 is some text that varies. The launderette part 0 is "You've just walked into a launderette. The room is well lit.
...
The office part 0 is some text that varies. The office part 0 is "Well, here we are in an office. You begin to take stock of what's here.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The spare room part 0 is some text that varies. The spare room part 0 is "You have come into the most ordinary of all possible spare rooms. You begin looking for stuff.
...
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_14 and the r_2 are rooms.
The r_0 and the r_1 and the r_10 and the r_9 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_8 and the r_14 and the r_2 are privately-named.
...
Test quest0_0 with "go west / go north / go north / go west / go west / go south / go east / go south / go east / go east / go south / go east / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. Your first objective is to attempt to move west. Okay, and then, try to go to the north. With that done,".
The objective part 1 is some text that varies. The objective part 1 is " make an effort to venture north. That done, go west. If you can get through with that, attempt to head west. After that, make an attempt to travel south. After that, go to the east. After that, go so".
The objective part 2 is some text that varies. The objective part 2 is "uth. And then, attempt to move east. After that, try to travel east. Okay, and then, make an effort to travel south. Then, make an attempt to go east. And then, travel east. That done, make an effort ".
The objective part 3 is some text that varies. The objective part 3 is "to venture south. Then, pick up the coin from the floor of the studio. Once that's all handled, you can stop!".
