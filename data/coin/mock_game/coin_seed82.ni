...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 are rooms.
...
The recreation zone part 0 is some text that varies. The recreation zone part 0 is "Guess what, you are in a place we're calling a recreation zone. You begin looking for stuff.
...
The parlor part 0 is some text that varies. The parlor part 0 is "You arrive in a parlor. An ordinary one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The washroom part 0 is some text that varies. The washroom part 0 is "You find yourself in a washroom. A normal one. You can barely contain your excitement.
...
The sauna part 0 is some text that varies. The sauna part 0 is "Well how about that, you are in a place we're calling a sauna. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The spare room part 0 is some text that varies. The spare room part 0 is "You find yourself in a spare room. A standard one. Let's see what's in here.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You've moved into a standard room. Your mind races to think of what kind of room would be standard. And then it hits you. Of course. You're in the launderette. You start to take note of what's in the room.
...
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 are rooms.
The r_1 and the r_2 and the r_11 and the r_12 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_7 and the r_6 and the r_8 and the r_9 and the r_10 and the r_0 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go east / go east / go south / go east / go east / go south / go west / go south / go west / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Welcome to TextWorld! Here is how to play! First thing I need you to do is to make an effort to head south. And then, make an effort to go to the west. Then, attempt to venture north. After that, atte".
The objective part 1 is some text that varies. The objective part 1 is "mpt to venture east. After that, move east. Then, try to travel south. And then, make an effort to head east. Then, move east. And then, try to venture south. And then, move west. Then, go to the sout".
The objective part 2 is some text that varies. The objective part 2 is "h. Then, go to the west. After that, make an attempt to go to the south. Once you get through with that, travel west. Next, pick up the coin from the floor of the shower. Once that's all handled, you ".
