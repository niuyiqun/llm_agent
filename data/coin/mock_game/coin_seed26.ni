...
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_14 are rooms.

Understand "attic" as r_1.
The internal name of r_1 is "attic".
The printed name of r_1 is "-= Attic =-".
The attic part 0 is some text that varies. The attic part 0 is "I am honoured to announce that you are now in the attic.
...
The canteen part 0 is some text that varies. The canteen part 0 is "You find yourself in a canteen. A typical one. You can barely contain your excitement.
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in an ordinary kind of place. That is to say, you're in a studio. You can barely contain your excitement.
...
The closet part 0 is some text that varies. The closet part 0 is "Of every closet you could have shown up in, you had to saunter into a standard one. You begin to take stock of what's in the room.
...
The dish-pit part 0 is some text that varies. The dish-pit part 0 is "Look at you, bigshot, walking into a dish-pit like it isn't some huge deal. You begin to take stock of what's here.
...
The bedchamber part 0 is some text that varies. The bedchamber part 0 is "Ah, the bedchamber. This is some kind of bedchamber, really great ordinary vibes in this place, a wonderful ordinary atmosphere. And now, well, you're in it.
...
The basement part 0 is some text that varies. The basement part 0 is "I am sorry to announce that you are now in the basement. Okay, just remember what you're here to do, and everything will go great.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You are in an ordinary kind of place. That is to say, you're in a sauna. I guess you better just go and list everything you see here.
...
The playroom part 0 is some text that varies. The playroom part 0 is "You have stumbled into the most normal of all possible playrooms.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You make another one of your grand eccentric entrances into a bedroom. You begin to take stock of what's here.
...
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_14 are rooms.
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_0 and the r_10 and the r_14 are privately-named.
...
Test quest0_0 with "go south / go west / go north / go west / go west / go north / go west / go south / go west / go north / go north / go east / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "I hope you're ready to go into rooms and interact with objects, because you've just entered TextWorld! Here is your task for today. First off, move south. Once you get around to doing that, head west.".
The objective part 1 is some text that varies. The objective part 1 is " And then, make an attempt to take a trip north. And then, head west. And then, attempt to head west. Once you finish that, make an attempt to take a trip north. With that accomplished, venture west. ".
The objective part 2 is some text that varies. The objective part 2 is "And then, attempt to head south. After that, make an attempt to go west. Then, go to the north. And then, try to travel north. Once you finish that, make an effort to go east. With that over with, mov".
The objective part 3 is some text that varies. The objective part 3 is "e east. And then, go south. With that done, lift the coin from the floor of the bedroom. Got that? Good!".
