...
The r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_8 are rooms.
...
The launderette part 0 is some text that varies. The launderette part 0 is "You're now in the launderette. You start to take note of what's in the room.
...
The scullery part 0 is some text that varies. The scullery part 0 is "You've just shown up in a scullery. You begin to take stock of what's in the room.
...
The vault part 0 is some text that varies. The vault part 0 is "Look at that signboard! What does it say? It says Welcome to the vault? Well that's cool.
...
The r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_8 are rooms.
The r_11 and the r_12 and the r_13 and the r_2 and the r_3 and the r_4 and the r_5 and the r_6 and the r_7 and the r_9 and the r_10 and the r_0 and the r_1 and the r_14 and the r_8 are privately-named.
...
Test quest0_0 with "go south / go south / go west / go west / go west / go west / go west / go north / go north / go west / go south / go west / go west / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, you could, like, head south. Then, head south. And then, head west. And then, make an effo".
The objective part 1 is some text that varies. The objective part 1 is "rt to go west. And then, head west. Okay, and then, go to the west. Then, make an attempt to move west. Next, make an effort to go north. Then, travel north. If you can finish that, attempt to head we".
The objective part 2 is some text that varies. The objective part 2 is "st. With that done, travel south. And then, try to travel west. That done, head west. If you can get through with that, try to take a trip south. If you can get through with that, recover the coin fro".
The objective part 3 is some text that varies. The objective part 3 is "m the floor of the shower. Alright, thanks!".
