...
The r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_13 and the r_12 and the r_3 and the r_4 and the r_7 and the r_6 and the r_0 and the r_14 and the r_5 and the r_8 are rooms.

Understand "cubicle" as r_1.
The internal name of r_1 is "cubicle".
The printed name of r_1 is "-= Cubicle =-".
The cubicle part 0 is some text that varies. The cubicle part 0 is "You have stumbled into a cubicle. Not the cubicle you'd expect. No, this is a cubicle. You try to gain information on your surroundings by using a technique you call 'looking.'
...
The cookery part 0 is some text that varies. The cookery part 0 is "You're now in the cookery. You can barely contain your excitement.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You arrive in a laundromat. An ordinary kind of place. Okay, just remember what you're here to do, and everything will go great.
...
The vault part 0 is some text that varies. The vault part 0 is "You arrive in a vault. An ordinary kind of place. You begin looking for stuff.
...
The cellar part 0 is some text that varies. The cellar part 0 is "You arrive in a cellar. A normal kind of place. You begin looking for stuff.
...
The closet part 0 is some text that varies. The closet part 0 is "You find yourself in a closet. An usual kind of place.
...
The r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_13 and the r_12 and the r_3 and the r_4 and the r_7 and the r_6 and the r_0 and the r_14 and the r_5 and the r_8 are rooms.
The r_1 and the r_2 and the r_10 and the r_9 and the r_11 and the r_13 and the r_12 and the r_3 and the r_4 and the r_7 and the r_6 and the r_0 and the r_14 and the r_5 and the r_8 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go west / go south / go south / go east / go south / go south / go east / go east / go south / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First, it would be great if you could make an effort to move north. If you can get around to doing that,".
The objective part 1 is some text that varies. The objective part 1 is " attempt to venture west. And then, try to go north. And then, take a trip west. Then, attempt to go to the south. Okay, and then, venture south. After that, go to the east. And then, venture south. T".
The objective part 2 is some text that varies. The objective part 2 is "hen, travel south. If you can do that, make an effort to take a trip east. Then, make an attempt to move east. Then, make an effort to go to the south. After that, head east. Then, head south. Once yo".
The objective part 3 is some text that varies. The objective part 3 is "u get around to doing that, retrieve the coin from the floor of the closet. And if you do that, you're the winner!".
