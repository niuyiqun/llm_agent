...
The r_0 and the r_1 and the r_12 and the r_11 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_14 and the r_2 are rooms.
...
The sauna part 0 is some text that varies. The sauna part 0 is "You have fallen into a sauna. Not the sauna you'd expect. No, this is a sauna.
...
The spare room part 0 is some text that varies. The spare room part 0 is "You arrive in a spare room. A standard one. Let's see what's in here.
...
The r_0 and the r_1 and the r_12 and the r_11 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_14 and the r_2 are rooms.
The r_0 and the r_1 and the r_12 and the r_11 and the r_13 and the r_4 and the r_3 and the r_5 and the r_6 and the r_8 and the r_7 and the r_9 and the r_10 and the r_14 and the r_2 are privately-named.
...
Test quest0_0 with "go west / go north / go north / go east / go south / go west / go south / go east / go south / go west / go north / go east / go east / go south / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First of all, make an attempt to take a trip west. And then, venture north. Once you get around to doing that, venture north. ".
The objective part 1 is some text that varies. The objective part 1 is "With that done, go to the east. And then, make an effort to travel south. Following that, try to venture west. And then, travel south. With that accomplished, go to the east. Okay, and then, head sout".
The objective part 2 is some text that varies. The objective part 2 is "h. And then, make an attempt to go west. That done, take a trip north. After that, make an attempt to go east. And then, move east. And then, try to move south. If you can get around to doing that, li".
The objective part 3 is some text that varies. The objective part 3 is "ft the coin from the floor of the office. Got that? Good!".
