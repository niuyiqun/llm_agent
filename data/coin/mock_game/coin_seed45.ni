...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_7 and the r_8 and the r_9 are rooms.
...
The sauna part 0 is some text that varies. The sauna part 0 is "I am sorry to announce that you are now in the sauna. I guess you better just go and list everything you see here.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You're now in the kitchenette. You start to take note of what's in the room.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal. The room is well lit.
...
The lounge part 0 is some text that varies. The lounge part 0 is "Of every lounge you could have shown up in, you had to show up in an ordinary one.
...
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_7 and the r_8 and the r_9 are rooms.
The r_12 and the r_11 and the r_13 and the r_14 and the r_2 and the r_1 and the r_3 and the r_4 and the r_5 and the r_6 and the r_0 and the r_10 and the r_7 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go south / go east / go east / go north / go west / go west / go north / go north / go north / go north / go north / go east / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced session of TextWorld! Here is your task for today. First of all, you could, like, make an attempt to venture south. If you can manage that, take a trip east. Then, mak".
The objective part 1 is some text that varies. The objective part 1 is "e an effort to go east. With that done, make an effort to venture north. Next, head west. And then, try to move west. Okay, and then, move north. And then, try to move north. After that, attempt to tr".
The objective part 2 is some text that varies. The objective part 2 is "avel north. Then, venture north. Then, attempt to travel north. And then, attempt to go east. Then, try to go to the south. If you can get through with that, travel west. And then, pick up the coin fr".
The objective part 3 is some text that varies. The objective part 3 is "om the floor of the studio. Got that? Good!".
