...
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 and the r_6 are rooms.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You find yourself in a laundromat. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
The workshop part 0 is some text that varies. The workshop part 0 is "You find yourself in a workshop. An usual kind of place. You can barely contain your excitement.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "If you're wondering why everything seems so normal all of a sudden, it's because you've just walked into the bedroom. You can barely contain your excitement.
...
The studio part 0 is some text that varies. The studio part 0 is "You arrive in a studio. An ordinary kind of place. You start to take note of what's in the room.
...
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 and the r_6 are rooms.
The r_1 and the r_2 and the r_12 and the r_11 and the r_13 and the r_14 and the r_4 and the r_3 and the r_5 and the r_8 and the r_7 and the r_9 and the r_10 and the r_0 and the r_6 are privately-named.
...
Test quest0_0 with "go north / go west / go north / go east / go east / go south / go south / go east / go south / go west / go north / go east / go south / go west / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is how to play! First stop, move north. And then, make an attempt to head west. Then, make an effort to venture north. Then, move east. And th".
The objective part 1 is some text that varies. The objective part 1 is "en, venture east. Okay, and then, attempt to venture south. Then, go south. Once you do that, try to move east. Then, venture south. Okay, and then, travel west. And then, make an attempt to take a tr".
The objective part 2 is some text that varies. The objective part 2 is "ip north. And then, make an attempt to move east. Then, head south. After that, go west. Following that, pick-up the coin from the floor of the office. Got that? Good!".
