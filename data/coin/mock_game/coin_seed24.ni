...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are rooms.

Understand "study" as r_0.
The internal name of r_0 is "study".
The printed name of r_0 is "-= Study =-".
The study part 0 is some text that varies. The study part 0 is "You find yourself in a study. An usual kind of place. You begin to take stock of what's here.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "This just in- You, in the laundromat. Let's see what's in here.
...
The bar part 0 is some text that varies. The bar part 0 is "You find yourself in a bar. A normal one. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The basement part 0 is some text that varies. The basement part 0 is "Well, here we are in the basement. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
The launderette part 0 is some text that varies. The launderette part 0 is "This might come as a shock to you, but you've just walked into a launderette.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "Of every kitchenette you could have shown up in, you had to walk into an ordinary one.
...
The shower part 0 is some text that varies. The shower part 0 is "Well I'll be, you are in the place we're calling the shower. You begin looking for stuff.
...
The salon part 0 is some text that varies. The salon part 0 is "You find yourself in a salon. A normal kind of place. You begin to take stock of what's here.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_14 and the r_4 and the r_3 and the r_5 and the r_6 and the r_7 and the r_8 and the r_9 and the r_2 are privately-named.
...
Test quest0_0 with "go west / go north / go north / go east / go north / go west / go west / go west / go west / go west / go west / go north / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "You are now playing a fast paced episode of TextWorld! First off, if it's not too much trouble, I need you to head west. And then, attempt to travel north. Once you manage that, go north. And then, ma".
The objective part 1 is some text that varies. The objective part 1 is "ke an attempt to venture east. After that, take a trip north. Following that, take a trip west. After that, go to the west. And then, head west. And then, make an attempt to go to the west. After that".
The objective part 2 is some text that varies. The objective part 2 is ", attempt to head west. Then, go west. Okay, and then, venture north. That done, go to the east. And then, go east. Then, pick-up the coin from the floor of the bar. And if you do that, you're the win".
