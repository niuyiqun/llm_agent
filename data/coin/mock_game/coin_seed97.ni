...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_9 and the r_14 and the r_4 and the r_7 are rooms.
...
The cookhouse part 0 is some text that varies. The cookhouse part 0 is "Wow! You're in a cookhouse.
...
The laundromat part 0 is some text that varies. The laundromat part 0 is "You're now in a laundromat. Let's see what's in here.
...
The attic part 0 is some text that varies. The attic part 0 is "You're now in the attic. You decide to just list off a complete list of everything you see in the room, because hey, why not?
...
The workshop part 0 is some text that varies. The workshop part 0 is "Guess what, you are in a place we're calling a workshop. Okay, just remember what you're here to do, and everything will go great.
...
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_9 and the r_14 and the r_4 and the r_7 are rooms.
The r_0 and the r_1 and the r_10 and the r_11 and the r_13 and the r_12 and the r_3 and the r_2 and the r_5 and the r_6 and the r_8 and the r_9 and the r_14 and the r_4 and the r_7 are privately-named.
...
Test quest0_0 with "go west / go south / go east / go north / go north / go west / go south / go south / go west / go south / go west / go north / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First stop, make an effort to take a trip west. And then, go south. If you can get through with that, ma".
The objective part 1 is some text that varies. The objective part 1 is "ke an effort to venture east. After that, go to the north. And then, try to go to the north. That done, make an effort to move west. Then, travel south. After that, take a trip south. If you can succe".
The objective part 2 is some text that varies. The objective part 2 is "ed at that, travel west. And then, head south. Once you get around to doing that, make an effort to travel west. And then, try to go to the north. After that, head east. With that over with, attempt t".
The objective part 3 is some text that varies. The objective part 3 is "o move north. Next, pick up the coin from the floor of the workshop. And if you do that, you're the winner!".
