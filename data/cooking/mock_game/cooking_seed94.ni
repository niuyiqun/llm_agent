...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1]. Now that's what I call TextWorld![end if]".
The kitchen part 7 is some text that varies. The kitchen part 7 is "[if there is nothing on the s_1]But oh no! there's nothing on this piece of junk. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a stove. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove. You idly wonder how they came up with the name TextWorld for this place. It's pretty fitting.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am sorry to announce that you are now in the bathroom.
 ...
 You can make out a toilet. [if there is something on the s_4]On the toilet you can see [a list of things on the s_4]. Classic TextWorld.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You're now in a livingroom. I guess you better just go and list everything you see here.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a sofa. Why don't you take a picture of it, it'll last longer! The sofa is comfy.[if there is something on the s_5] On the sofa you see [a list of things on the s_5]. It doesn't get more TextWorld than this![end if]".
...
Test quest2_0 with "inventory / inventory / go west / examine cookbook / take red bell pepper from fridge / take yellow bell pepper from fridge / take knife from counter / chop banana with knife"
...
Test quest6_0 with "inventory / inventory / go west / examine cookbook / take red bell pepper from fridge / take yellow bell pepper from fridge / take knife from counter / chop banana with knife / drop knife / take knife / slice red bell pepper with knife"
...
Test quest8_0 with "inventory / inventory / go west / examine cookbook / take red bell pepper from fridge / take yellow bell pepper from fridge"
...
Test quest10_0 with "inventory / inventory / go west / examine cookbook / take red bell pepper from fridge / take yellow bell pepper from fridge / take knife from counter / chop banana with knife / drop knife / take knife / slice red bell pepper with knife / drop knife / take knife / dice yellow bell pepper with knife"
