...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A typical one.
 ...
 As if things weren't amazing enough already, you can even see a sofa. You wonder idly who left that here. The sofa is comfy.[if there is something on the s_5] On the sofa you see [a list of things on the s_5].[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You've just sauntered into a bathroom.
 ...
 You can see a toilet. The toilet is white.[if there is something on the s_4] On the toilet you make out [a list of things on the s_4]. Classic TextWorld.[end if]".
The bathroom part 1 is some text that varies. The bathroom part 1 is "[if there is nothing on the s_4] Unfortunately, there isn't a thing on it. Aw, here you were, all excited for there to be things on it![end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You find yourself in a bedroom. A typical kind of place. You begin looking for stuff.
 ...
 You can see a bed. [if there is something on the s_3]You see [a list of things on the s_3] on the bed. Now that's what I call TextWorld![end if]".
...
Test quest3_0 with "inventory / inventory / go north / examine cookbook / drop yellow bell pepper / take cilantro from fridge / take purple potato from counter / take knife from counter / chop cilantro with knife"
...
Test quest5_0 with "inventory / inventory / go north / examine cookbook / drop yellow bell pepper / take cilantro from fridge / take purple potato from counter"
...
Test quest7_0 with "inventory / inventory / go north / examine cookbook / drop yellow bell pepper / take cilantro from fridge / take purple potato from counter / take knife from counter / chop cilantro with knife / drop knife / take knife / chop purple potato with knife"
...
Test quest10_0 with "inventory / inventory / go north / examine cookbook / drop yellow bell pepper / take cilantro from fridge / take purple potato from counter / take knife from counter / chop cilantro with knife / drop knife / take knife / chop purple potato with knife / drop knife / take knife / dice yellow potato with knife"
