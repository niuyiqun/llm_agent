...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1] The counter appears to be empty. You think about smashing the counter to bits, throwing the bits in a fire, etc, until you get bored and decide to move on.[end if]".
The kitchen part 9 is some text that varies. The kitchen part 9 is " You can make out a stove. Now why would someone leave that there? The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "Well, here we are in a livingroom. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 Look over there! a sofa. The sofa is comfy.[if there is something on the s_3] On the sofa you make out [a list of things on the s_3].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. An usual one.
 ...
 You see a shelf. Does this look like anything mentioned in the instructions? [if there is something on the s_2]On the shelf you can see [a list of things on the s_2]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "Look at you, bigshot, walking into a bathroom like it isn't some huge deal.
 ...
 You bend down to tie your shoe. When you stand up, you notice a toilet. [if there is something on the s_4]On the toilet you make out [a list of things on the s_4]. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The f_0 and the f_1 and the f_2 and the f_11 and the f_12 and the f_13 and the f_14 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_10 are foods.
The f_0 and the f_1 and the f_2 and the f_11 and the f_12 and the f_13 and the f_14 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_10 are privately-named.
...
Test quest1_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter"
...
Test quest3_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter / take knife from table / chop red apple with knife"
...
Test quest6_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop yellow apple with knife"
...
Test quest8_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter"
...
Test quest10_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop yellow apple with knife / drop knife / take knife / dice yellow potato with knife"
...
Test quest11_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop yellow apple with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go west / go north / examine cookbook / drop yellow bell pepper / take red apple from counter / take yellow potato from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop yellow apple with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal / eat meal"
