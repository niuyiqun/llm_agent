...
The kitchen part 6 is some text that varies. The kitchen part 6 is " What's that over there? It looks like it's a table. The table is massive.[if there is something on the s_0] On the table you can make out [a list of things on the s_0]. You shudder, but continue examining the room.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " Look out! It's a- oh, never mind, it's just a counter. Now why would someone leave that there? The counter is vast.[if there is something on the s_1] On the counter you can see [a list of things on the s_1].[end if]".
...
The kitchen part 13 is some text that varies. The kitchen part 13 is " plain door leading south. You need an exit without a door? You should try going north.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "I am honoured to announce that you are now in the bathroom.
 ...
 Oh, great. Here's a toilet. The toilet is white.[if there is something on the s_4] On the toilet you make out [a list of things on the s_4]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You're not going to believe this, but you've just entered a livingroom.
 ...
 You hear a noise behind you and spin around, but you can't see anything other than a sofa. The sofa is comfy.[if there is something on the s_5] On the sofa you can make out [a list of things on the s_5].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_5] But oh no! there's nothing on this piece of trash. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "Well, here we are in the pantry.
 ...
 You can make out a shelf. Make a note of this, you might have to put stuff on or in it later on. The shelf is wooden.[if there is something on the s_2] On the shelf you see [a list of things on the s_2].[end if]".
...
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_14 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_13 are foods.
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_14 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_13 are privately-named.
...
Test quest1_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter"
...
Test quest3_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter / take knife from table / chop red apple with knife"
...
Test quest5_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter"
...
Test quest7_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop red hot pepper with knife"
...
Test quest10_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop red hot pepper with knife / drop knife / take knife / chop red potato with knife"
...
Test quest11_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop red hot pepper with knife / drop knife / take knife / chop red potato with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / examine cookbook / drop red tuna / drop yellow potato / take red apple from counter / take red hot pepper from counter / take knife from table / chop red apple with knife / drop knife / take knife / chop red hot pepper with knife / drop knife / take knife / chop red potato with knife / drop knife / prepare meal / eat meal"
