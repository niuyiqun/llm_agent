...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You can make out a stove. There's something about an object in a room that's just so... TextWorld. The stove is conventional.[if there is something on the stove_0] On the stove you can make out [a list of things on the stove_0].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. An usual one. I guess you better just go and list everything you see here.
 ...
 You can make out a shelf. Wow, isn't TextWorld just the best? [if there is something on the s_2]You see [a list of things on the s_2] on the shelf. Classic TextWorld.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. An ordinary kind of place.
 ...
 You can see a toilet. Wow, isn't TextWorld just the best? [if there is something on the s_5]You see [a list of things on the s_5] on the toilet.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You've just sauntered into a livingroom.
 ...
 You scan the room for a sofa, and you find a sofa. [if there is something on the s_4]On the sofa you see [a list of things on the s_4].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just walked into a bedroom.
 ...
 Oh wow! Is that what I think it is? It is! It's a bed. You shudder, but continue examining the bed. The bed is large.[if there is something on the s_3] On the bed you see [a list of things on the s_3].[end if]".
...
Test quest1_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter"
...
Test quest3_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter / take yellow bell pepper from fridge / take knife from table / dice purple potato with knife"
...
Test quest6_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter / take yellow bell pepper from fridge / take knife from table / dice purple potato with knife / drop knife / take knife / slice white onion with knife"
...
Test quest8_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter / take yellow bell pepper from fridge"
...
Test quest11_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter / take yellow bell pepper from fridge / take knife from table / dice purple potato with knife / drop knife / take knife / slice white onion with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go east / go south / go south / examine cookbook / drop white tuna / drop red onion / take purple potato from counter / take yellow bell pepper from fridge / take knife from table / dice purple potato with knife / drop knife / take knife / slice white onion with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / prepare meal / eat meal"
