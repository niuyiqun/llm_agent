...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You make out an oven. Now why would someone leave that there?[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0].[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " What's that over there? It looks like it's a table. [if there is something on the s_0]On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is "[if there is nothing on the s_1] But the thing hasn't got anything on it. You think about smashing the counter to bits, throwing the bits into a pit, etc, until you get bored and decide to move on.[end if]".
...
The kitchen part 12 is some text that varies. The kitchen part 12 is " plain door leading east. You need an exit without a door? You should try going north. You don't like doors? Why not try going west, that entranceway is not blocked by one.".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You've just shown up in a corridor. Okay, just remember what you're here to do, and everything will go great.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A typical one. You begin looking for stuff.

 You scan the room for a bed, and you find a bed. [if there is something on the s_3]You see [a list of things on the s_3] on the bed. Hmmm... what else, what else?[end if]".
...
The f_0 and the f_1 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_5 are foods.
The f_0 and the f_1 and the f_2 and the f_3 and the f_4 and the f_6 and the f_7 and the f_5 are privately-named.
...
Test quest1_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge"
...
Test quest3_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge / take knife from table / slice lettuce with knife"
...
Test quest5_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge"
...
Test quest7_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge / take knife from table / slice lettuce with knife / drop knife / take knife / dice pork chop with knife"
...
Test quest10_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge / take knife from table / slice lettuce with knife / drop knife / take knife / dice pork chop with knife / drop knife / take knife / slice yellow apple with knife"
...
Test quest11_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge / take knife from table / slice lettuce with knife / drop knife / take knife / dice pork chop with knife / drop knife / take knife / slice yellow apple with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go south / go east / examine cookbook / drop yellow bell pepper / drop red apple / take lettuce from fridge / take pork chop from fridge / take knife from table / slice lettuce with knife / drop knife / take knife / dice pork chop with knife / drop knife / take knife / slice yellow apple with knife / drop knife / prepare meal / eat meal"
