...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well how about that, you are in a place we're calling a kitchen.
 ...
 You can make out a fridge. You can't wait to tell the folks at home about this![if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You can see a table! The table is massive.[if there is something on the s_0] On the table you can make out [a list of things on the s_0]. Wow! Just like in the movies![end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You can make out a counter. [if there is something on the s_1]On the counter you can make out [a list of things on the s_1]. It doesn't get more TextWorld than this![end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " As if things weren't amazing enough already, you can even see a stove. [if there is something on the stove_0]On the stove you make out [a list of things on the stove_0].[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " frosted-glass door leading east. You don't like doors? Why not try going south, that entranceway is not blocked by one. You need an exit without a door? You should try going west.".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You are in a bathroom.
 ...
 Oh, great. Here's a toilet. [if there is something on the s_5]On the toilet you see [a list of things on the s_5].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You've entered a pantry. You begin to take stock of what's here.
 ...
 You see a gleam over in a corner, where you can see a shelf. What a coincidence, weren't you just thinking about a shelf? The shelf is wooden.[if there is something on the s_2] On the shelf you make out [a list of things on the s_2]. It doesn't get more TextWorld than this![end if]".
...
Test quest2_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter / take knife from table / dice block of cheese with knife"
...
Test quest4_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge"
...
Test quest6_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter / take knife from table / dice block of cheese with knife / drop knife / take knife / dice cilantro with knife"
...
Test quest8_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter"
...
Test quest10_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter / take knife from table / dice block of cheese with knife / drop knife / take knife / dice cilantro with knife / drop knife / take knife / dice red apple with knife"
...
Test quest11_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter / take knife from table / dice block of cheese with knife / drop knife / take knife / dice cilantro with knife / drop knife / take knife / dice red apple with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / inventory / go west / examine cookbook / take cilantro from fridge / take red apple from counter / take knife from table / dice block of cheese with knife / drop knife / take knife / dice cilantro with knife / drop knife / take knife / dice red apple with knife / drop knife / prepare meal / eat meal"
