...
The kitchen part 3 is some text that varies. The kitchen part 3 is " You see a gleam over in a corner, where you can see an oven.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. Is this what you came to TextWorld for? This... oven?[end if]".
...
The kitchen part 5 is some text that varies. The kitchen part 5 is " You smell a lovely smell, and follow it to a table. The table is massive.[if there is something on the s_0] On the table you can see [a list of things on the s_0].[end if]".
...
The kitchen part 7 is some text that varies. The kitchen part 7 is " You can see a counter. I guess it's true what they say, if you're looking for a counter, go to TextWorld. [if there is something on the s_1]On the counter you see [a list of things on the s_1].[end if]".
...
The kitchen part 10 is some text that varies. The kitchen part 10 is "[if there is nothing on the stove_0]The stove appears to be empty. You move on, clearly upset with TextWorld.[end if]".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_4]But the thing hasn't got anything on it. This always happens, here in TextWorld![end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You are in a corridor. An usual one. Okay, just remember what you're here to do, and everything will go great.
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You find yourself in a bathroom. You decide to start listing off everything you see in the room, as if you were in a text adventure.
 ...
 You scan the room for a toilet, and you find a toilet. The toilet is white.[if there is something on the s_3] On the toilet you can make out [a list of things on the s_3].[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've just shown up in a bedroom.
 ...
 You scan the room, seeing a bed. The bed is large.[if there is something on the s_5] On the bed you can see [a list of things on the s_5].[end if]".
...
The pantry part 0 is some text that varies. The pantry part 0 is "You are in a pantry. An ordinary one. Let's see what's in here.
 ...
 Oh wow! Is that what I think it is? It is! It's a shelf. The shelf is wooden.[if there is something on the s_2] On the shelf you see [a list of things on the s_2]. You shudder, but continue examining the room.[end if]".
...
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_13 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 are foods.
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_12 and the f_13 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 are privately-named.
...
Test quest1_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter"
...
Test quest3_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge / take knife from table / slice banana with knife"
...
Test quest5_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge"
...
Test quest7_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge / take knife from table / slice banana with knife / drop knife / take knife / slice yellow onion with knife"
...
Test quest10_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge / take knife from table / slice banana with knife / drop knife / take knife / slice yellow onion with knife / drop knife / take knife / dice yellow potato with knife"
...
Test quest11_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge / take knife from table / slice banana with knife / drop knife / take knife / slice yellow onion with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go north / go west / examine cookbook / drop yellow bell pepper / drop red potato / take banana from counter / take yellow onion from fridge / take knife from table / slice banana with knife / drop knife / take knife / slice yellow onion with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal / eat meal"
