...
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_0]The table appears to be empty. You move on, clearly furious with TextWorld.[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You see a gleam over in a corner, where you can see a stove. Why don't you take a picture of it, it'll last longer! [if there is something on the stove_0]On the stove you can make out [a list of things on the stove_0].[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " plain door leading east. There is an exit to the south. You need an exit without a door? You should try going west.".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You arrive in a bedroom. A normal kind of place.
 ...
 You see a bed. The bed is large.[if there is something on the s_4] On the bed you see [a list of things on the s_4]. You shudder, but continue examining the room.[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4] But the thing hasn't got anything on it. It would have been so cool if there was stuff on the bed! oh well.[end if]".
...
The f_0 and the f_1 and the f_2 and the f_11 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_10 are foods.
The f_0 and the f_1 and the f_2 and the f_11 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 and the f_10 are privately-named.
...
Test quest1_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge"
...
Test quest3_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter / take knife from counter / slice green bell pepper with knife"
...
Test quest6_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / chop yellow bell pepper with knife"
...
Test quest8_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter"
...
Test quest10_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / take knife / dice yellow potato with knife"
...
Test quest11_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go north / examine cookbook / drop yellow onion / drop orange bell pepper / take green bell pepper from fridge / take yellow potato from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / chop yellow bell pepper with knife / drop knife / take knife / dice yellow potato with knife / drop knife / prepare meal / eat meal"
