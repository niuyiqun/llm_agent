...
The kitchen part 0 is some text that varies. The kitchen part 0 is "Well, here we are in the kitchen.
 ...
 Were you looking for a fridge? Because look over there, it's a fridge.[if c_0 is open and there is something in the c_0] The fridge contains [a list of things in the c_0]. Classic TextWorld.[end if]".
...
The kitchen part 2 is some text that varies. The kitchen part 2 is " You can see an oven.[if oven_0 is open and there is something in the oven_0] The oven contains [a list of things in the oven_0]. There's something strange about this being here, but you can't put your finger on it.[end if]".
...
The kitchen part 11 is some text that varies. The kitchen part 11 is " frosted-glass door leading east. You need an exit without a door? You should try going north. You don't like doors? Why not try going south, that entranceway is not blocked by one.".
...
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_5] The sofa appears to be empty. Sometimes, just sometimes, TextWorld can just be the worst.[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You've entered a bedroom.
 ...
 You make out a bed. [if there is something on the s_3]On the bed you can make out [a list of things on the s_3]. Wow! Just like in the movies![end if]".
...
Test quest1_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge"
...
Test quest3_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter / take knife from counter / slice green bell pepper with knife"
...
Test quest5_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter"
...
Test quest7_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / dice green hot pepper with knife"
...
Test quest10_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / dice green hot pepper with knife / drop knife / take knife / dice white onion with knife"
...
Test quest11_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / dice green hot pepper with knife / drop knife / take knife / dice white onion with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go south / examine cookbook / drop white tuna / drop yellow onion / take green bell pepper from fridge / take green hot pepper from counter / take knife from counter / slice green bell pepper with knife / drop knife / take knife / dice green hot pepper with knife / drop knife / take knife / dice white onion with knife / drop knife / prepare meal / eat meal"
