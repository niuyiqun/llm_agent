...
The kitchen part 5 is some text that varies. The kitchen part 5 is "[if there is nothing on the s_0] But oh no! there's nothing on this piece of junk. What, you think everything in TextWorld should have stuff on it?[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " You smell an intriguing smell, and follow it to a stove. The stove is conventional.[if there is something on the stove_0] On the stove you make out [a list of things on the stove_0].[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "This might come as a shock to you, but you've just walked into a livingroom. You begin to take stock of what's in the room.

 You can see a sofa. The sofa is comfy.[if there is something on the s_3] On the sofa you make out [a list of things on the s_3].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_3] But the thing hasn't got anything on it. Aw, and here you were, all excited for there to be things on it![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom. An ordinary kind of place. You can barely contain your excitement.

 You can see a toilet. The toilet is white.[if there is something on the s_4] On the toilet you can make out [a list of things on the s_4]. Suddenly, you bump your head on the ceiling, but it's not such a bad bump that it's going to prevent you from looking at objects and even things.[end if]".
...
Test quest1_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter"
...
Test quest3_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge / take knife from table / slice banana with knife"
...
Test quest5_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge"
...
Test quest7_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge / take knife from table / slice banana with knife / drop knife / take knife / dice block of cheese with knife"
...
Test quest10_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge / take knife from table / slice banana with knife / drop knife / take knife / dice block of cheese with knife / drop knife / take knife / dice red onion with knife"
...
Test quest11_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge / take knife from table / slice banana with knife / drop knife / take knife / dice block of cheese with knife / drop knife / take knife / dice red onion with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go south / go east / examine cookbook / drop red bell pepper / drop yellow onion / take banana from counter / take block of cheese from fridge / take knife from table / slice banana with knife / drop knife / take knife / dice block of cheese with knife / drop knife / take knife / dice red onion with knife / drop knife / prepare meal / eat meal"
