...
The kitchen part 0 is some text that varies. The kitchen part 0 is "A rusty sign tells you that you are now in the kitchen. Okay, just remember what you're here to do, and everything will go great.
...
The kitchen part 4 is some text that varies. The kitchen part 4 is " You make out a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. You shudder, but continue examining the room.[end if]".
...
The kitchen part 9 is some text that varies. The kitchen part 9 is "[if there is nothing on the stove_0] Looks like someone's already been here and taken everything off it, though. What's the point of an empty stove?[end if]".
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom.
 ...
 Look over there! a bed. Now why would someone leave that there? [if there is something on the s_4]You see [a list of things on the s_4] on the bed.[end if]".
The bedroom part 1 is some text that varies. The bedroom part 1 is "[if there is nothing on the s_4]The bed appears to be empty. This always happens, here in TextWorld![end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "Ah, the corridor. This is some kind of corridor, really great normal vibes in this place, a wonderful normal atmosphere. You can barely contain your excitement.
...
The pantry part 0 is some text that varies. The pantry part 0 is "You arrive in a pantry. An ordinary kind of place. You can barely contain your excitement.
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You find yourself in a livingroom. An ordinary kind of place.
 ...
 Look over there! a sofa. The sofa is comfy.[if there is something on the s_3] On the sofa you can make out [a list of things on the s_3].[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_3] But oh no! there's nothing on this piece of trash. It would have been so cool if there was stuff on the sofa.[end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "This is going to sound unbelievable, but you've just entered a bathroom. You decide to start listing off everything you see in the room, as if you were in a text adventure.
...
Test quest1_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge"
...
Test quest3_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge / take knife from counter / slice cilantro with knife"
...
Test quest6_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge / take knife from counter / slice cilantro with knife / drop knife / take knife / dice red potato with knife"
...
Test quest8_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge"
...
Test quest10_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge / take knife from counter / slice cilantro with knife / drop knife / take knife / dice red potato with knife / drop knife / take knife / dice red tuna with knife"
...
Test quest11_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge / take knife from counter / slice cilantro with knife / drop knife / take knife / dice red potato with knife / drop knife / take knife / dice red tuna with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / inventory / go west / examine cookbook / drop red onion / drop yellow potato / take cilantro from fridge / take red tuna from fridge / take knife from counter / slice cilantro with knife / drop knife / take knife / dice red potato with knife / drop knife / take knife / dice red tuna with knife / drop knife / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest1 completed is true and quest3 completed is true and quest6 completed is true and quest8 completed is true and quest10 completed is true and quest11 completed is true and quest12 completed is true:
