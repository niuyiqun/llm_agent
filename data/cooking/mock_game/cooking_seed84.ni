...
The kitchen part 4 is some text that varies. The kitchen part 4 is " Oh wow! Is that what I think it is? It is! It's a table. [if there is something on the s_0]You see [a list of things on the s_0] on the table. I mean, just wow! Isn't TextWorld just the best?[end if]".
...
The kitchen part 6 is some text that varies. The kitchen part 6 is " You see a gleam over in a corner, where you can see a counter. [if there is something on the s_1]On the counter you make out [a list of things on the s_1].[end if]".
...
The kitchen part 8 is some text that varies. The kitchen part 8 is " If you haven't noticed it already, there seems to be something there by the wall, it's a stove. [if there is something on the stove_0]You see [a list of things on the stove_0] on the stove. Classic TextWorld.[end if]".
...
The corridor part 0 is some text that varies. The corridor part 0 is "You arrive in a corridor. A typical one. You begin to take stock of what's here.
...
The bedroom part 0 is some text that varies. The bedroom part 0 is "You're now in the bedroom.
 ...
 You lean against the wall, inadvertently pressing a secret button. The wall opens up to reveal a bed. What a coincidence, weren't you just thinking about a bed? The bed is large.[if there is something on the s_3] On the bed you can make out [a list of things on the s_3]. Huh, weird.[end if]".
...
The livingroom part 0 is some text that varies. The livingroom part 0 is "You arrive in a livingroom. A normal kind of place. Let's see what's in here.

 You scan the room, seeing a sofa. [if there is something on the s_4]You see [a list of things on the s_4] on the sofa.[end if]".
The livingroom part 1 is some text that varies. The livingroom part 1 is "[if there is nothing on the s_4]But there isn't a thing on it. Hopefully, this discovery doesn't ruin your TextWorld experience![end if]".
...
The bathroom part 0 is some text that varies. The bathroom part 0 is "You arrive in a bathroom.
 ...
 If you haven't noticed it already, there seems to be something there by the wall, it's a toilet. I guess it's true what they say, if you're looking for a toilet, go to TextWorld. The toilet is white.[if there is something on the s_5] On the toilet you can see [a list of things on the s_5]. Classic TextWorld.[end if]".
...
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 are foods.
The f_0 and the f_1 and the f_2 and the f_10 and the f_11 and the f_3 and the f_4 and the f_5 and the f_6 and the f_7 and the f_8 and the f_9 are privately-named.
...
Test quest2_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge / take knife from table / dice red apple with knife"
...
Test quest4_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter"
...
Test quest6_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge / take knife from table / dice red apple with knife / drop knife / take knife / dice red hot pepper with knife"
...
Test quest8_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge"
...
Test quest10_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge / take knife from table / dice red apple with knife / drop knife / take knife / dice red hot pepper with knife / drop knife / take knife / dice white tuna with knife"
...
Test quest11_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge / take knife from table / dice red apple with knife / drop knife / take knife / dice red hot pepper with knife / drop knife / take knife / dice white tuna with knife / drop knife / prepare meal"
...
Test quest12_0 with "inventory / go east / go east / go south / examine cookbook / drop red bell pepper / drop green apple / take red hot pepper from counter / take white tuna from fridge / take knife from table / dice red apple with knife / drop knife / take knife / dice red hot pepper with knife / drop knife / take knife / dice white tuna with knife / drop knife / prepare meal / eat meal"
...
This is the simpler notify score changes rule:
	...
	if quest2 completed is true and quest4 completed is true and quest6 completed is true and quest8 completed is true and quest10 completed is true and quest11 completed is true and quest12 completed is true:
