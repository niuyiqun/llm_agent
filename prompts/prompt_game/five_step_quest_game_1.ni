...
The objective part 0 is some text that varies. The objective part 0 is "It's time to explore the amazing world of TextWorld! Here is your task for today. First off, if it's not too much trouble, I need you to retrieve the American style passkey from the shelf. After you h".
The objective part 1 is some text that varies. The objective part 1 is "ave got the American style passkey, make an attempt to venture south. Then, make an effort to move east. Following that, close the American style chest in the attic. Once you have closed the American ".
The objective part 2 is some text that varies. The objective part 2 is "style chest, look and see that the American style chest is locked with the American style passkey. Alright, thanks!".
